...
# query_params = {'pageSize': 3, 'offset': 0}
...
# path_params = {'id': '601cf93059574fdc990218ba'}
...
# path_params = {"id": "601e559be3b8bc09500d1922"}
# body_params= {"accountCode":"04_ACC_02"}
# resp=account.update_account(path_params,body_params)
# print(resp)

# path_params = {'id': '601ba910809c400900752084'}
...
# path_params = {'id': '601e5c2f35390e6d5b4f7ab5'}
# body_params = {'recipientAccountId': '601ba910809c400900752084','amount': '1'}
...
# body_params = {'name': 'VC_CdsekZK', 'basePair': 'ETH'}
# print(virtual_currency.update_vitual_currency(body_params))




# path_params = {'name': 'VC_CdsekZK'}
...
# body_params= {'accountId': '601f63b8fc31476d454bb95a', 'amount': '5000'}
...
# path_params = {'id': '601ba8f2959d236da895b2bb'}
...
# body_params = {"id": "601f63b8fc31476d454bb95a"}
...
# print(account.create_new_account(body_params))
# body_params = {'senderAccountId': '601f63b8fc31476d454bb95a','recipientAccountId': '601f63b8fc31476d454bb95a','amount': '20'}
# print(transaction.send_payment(body_params))




# path_params = {'id': '601f63b8fc31476d454bb95a'}
# body_params = {'id': '601f63b8fc31476d454bb95a'}
# print(account.get_account_balance(path_params))
# query_params = {'pageSize': 10}
...
# path_params = {'id': '60211ae7192bfb092f10f0d9'}
...
# query_params = {'id': '601f63b8fc31476d454bb95a'}
...
# path_params = {'address': 'narasimha.tatum@gmail.com'}
...
# body_params = {"addresses":[{"accountId":"601ba910809c400900752084","derivationKey":253}]}
