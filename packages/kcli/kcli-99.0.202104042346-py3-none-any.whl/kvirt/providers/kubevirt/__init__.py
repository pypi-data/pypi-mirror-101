...
class Kubevirt(Kubecommon):
    ...
    def copy_image(self, pool, ori, dest, size=1):
        ...
        if self.volume_mode == 'Filesystem':
            ...
            container['volumeDevices'] = [{'devicePath': '/dev/block1', 'name': 'storage1'},
                                          {'devicePath': '/dev/block2', 'name': 'storage2'}]
            command = 'dd if=/dev/block1 of=/dev/block2 ; qemu-img resize /dev/block2 %sG' % size
