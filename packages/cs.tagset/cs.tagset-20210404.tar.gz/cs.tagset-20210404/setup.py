...
setup(
 ...
 'use.'),
  ...
  install_requires = ['cs.cmdutils>=20210404', 'cs.deco', 'cs.edit', 'cs.fileutils', 'cs.lex', 'cs.logutils', 'cs.mappings', 'cs.obj>=20200716', 'cs.pfx', 'cs.py3', 'cs.resources', 'cs.threads', 'icontract', 'typeguard'],
  keywords = ['python3'],
