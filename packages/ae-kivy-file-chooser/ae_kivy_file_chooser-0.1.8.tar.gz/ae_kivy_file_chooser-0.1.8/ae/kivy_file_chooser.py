...
Use the key of the :attr:`~ae.kivy_app.FlowButton.tap_flow_id` property of the :class:`~ae.kivy_app.FlowButton` to
provide a separate i18n help text for each individual button.
