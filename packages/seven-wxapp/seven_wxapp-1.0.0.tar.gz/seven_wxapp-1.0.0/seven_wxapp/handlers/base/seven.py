...
:LastEditTime: 2021-04-08 17:38:39
...
class SevenHelper:
    ...
    def merge_dict_list(self, source_dict_list, source_key, merge_dict_list, merge_key, merge_columns_names):
        ...
        :param source_dict_list：源字典列表
        :param source_key：源key
        :param merge_dict_list：合并字典列表
        :param merge_key：合并key
        :param merge_columns_names：合并字段
        :return: list
