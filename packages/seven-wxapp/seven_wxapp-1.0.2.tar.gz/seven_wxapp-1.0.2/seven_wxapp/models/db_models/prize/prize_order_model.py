...
class PrizeOrder:
    ...
    def get_field_list(self):
        return ['id', 'order_no', 'act_id', 'user_id', 'real_name', 'telephone', 'province', 'city', 'county', 'street', 'adress', 'deliver_date', 'express_no', 'express_company', 'order_status', 'is_auto_deliver', 'freight_price', 'is_free_shipping', 'freight_pay_order_no', 'remarks', 'create_date', 'modify_date']
