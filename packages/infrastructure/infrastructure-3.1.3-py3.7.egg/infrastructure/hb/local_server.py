...
# @Last Modified time: 2021-04-11 18:32:00
...
class LocalServer(object):
	...
	def cpFilePreprocess(self,alreadyRecord):
		...
		command = "cp {jacocoIt} {mergeFile}/{index}.exec".format(jacocoIt=self.jacocoIt.format(
				week=self.alreadyRecord.week,service_name=self.alreadyRecord.service_name,recordID=self.alreadyRecord.id,index=self.alreadyRecord.id),mergeFile=mergeFile,
