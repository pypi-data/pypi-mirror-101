...
class CalculatorBase:
    ...
    def get_stat_result(dates:             pd.core.series.Series,
        ...
        if len(dates) > 2:
            ...
            sr_ret_monthly = CalculatorBase.data_resample_monthly_ret(sr_ret).dropna()
            ...
            if benchmark_values is not None:
                ...
                sr_ret_weekly = CalculatorBase.data_resample_weekly_ret(sr_ret).dropna()
                sr_benchmark_ret_weekly = CalculatorBase.data_resample_weekly_ret(sr_benchmark_ret).dropna()
                sr_benchmark_ret_monthly = CalculatorBase.data_resample_monthly_ret(sr_benchmark_ret).dropna()
