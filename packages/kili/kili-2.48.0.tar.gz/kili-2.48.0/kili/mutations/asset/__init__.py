...
class MutationsAsset:
    ...
    def append_many_to_dataset(self, project_id: str, content_array: List[str] = None, external_id_array: List[str] = None,
        ...
        - json_content_array : List[List[str]], optional (default = None)
            ...
            For FRAME projects, each element is a sequence of frames, i.e. a list of URLs to images of a list of images 
            For TEXT projects, each element is json_content dict, formatted according to documentation on how to import rich-text assets: https://github.com/kili-technology/kili-playground/blob/master/recipes/import_text_assets.ipynb
