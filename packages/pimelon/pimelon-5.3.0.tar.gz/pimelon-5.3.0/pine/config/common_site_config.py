...
def make_ports(pine_path):
	pinees_path = os.path.dirname(os.path.abspath(pine_path))
	...
	existing_ports = {}
	for folder in os.listdir(pinees_path):
		pine_path = os.path.join(pinees_path, folder)
