...
class Handler(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        repository: typing.List[builtins.str],
    ) -> None:
        '''
        :param scope: -
        :param id: -
        ...
        jsii.create(Handler, self, [scope, id, props])
...
class HandlerProps:
    def __init__(self, *, repository: typing.List[builtins.str]) -> None:
...
class TidyUp(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(TidyUp, self, [scope, id, props])
