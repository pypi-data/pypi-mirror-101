...
def descoteaux_eigen_to_measure_image_filter(*args: itkt.ImageLike,  enhance_type: float=..., parameters_input=..., parameters: Sequence[float]=..., mask=...,**kwargs)-> itkt.ImageSourceReturn:
    """Functional interface for DescoteauxEigenToMeasureImageFilter"""
    import itk

    kwarg_typehints = { 'enhance_type':enhance_type,'parameters_input':parameters_input,'parameters':parameters,'mask':mask }
...
def descoteaux_eigen_to_measure_image_filter_init_docstring():
    ...
    filter_class = itk.BoneEnhancement.DescoteauxEigenToMeasureImageFilter
    descoteaux_eigen_to_measure_image_filter.process_object = filter_class
