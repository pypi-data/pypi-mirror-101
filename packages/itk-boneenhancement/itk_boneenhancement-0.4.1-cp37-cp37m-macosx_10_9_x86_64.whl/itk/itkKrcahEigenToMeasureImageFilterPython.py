...
def krcah_eigen_to_measure_image_filter(*args: itkt.ImageLike,  enhance_type: float=..., parameters_input=..., parameters: Sequence[float]=..., mask=...,**kwargs)-> itkt.ImageSourceReturn:
    """Functional interface for KrcahEigenToMeasureImageFilter"""
    import itk
...
def krcah_eigen_to_measure_image_filter_init_docstring():
    ...
    filter_class = itk.BoneEnhancement.KrcahEigenToMeasureImageFilter
    krcah_eigen_to_measure_image_filter.process_object = filter_class
