...
class Functions:
    ...
    def showUsage(self, short=True):
        ...
        {Style.GREEN}awsee {Style.IBLUE}-r role                            {Style.IMAGENTA}Assume a Role inside the current AWS Session
        ...
        {Style.GREEN}awsee {Style.IBLUE}[TOKEN-MFA]{Style.RESET} {Style.IBLUE}[-p profile -r role]   {Style.IMAGENTA}Open AWS Session with the passed profile using your six-digit MFA Token
