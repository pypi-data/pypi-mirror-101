...
setup(
    ...
    url="https://ualter.github.io/awsee/",
    ...
    install_requires=[            
        'botocore>=1.17.63','boto3>=1.14.2','Pygments','arnparse','tinydb','clipboard','pyreadline','pytz','python-dateutil'
    ],
    scripts=[
        'shell_scripts/scrawsee.bat'
    ],
    entry_points={
        "console_scripts": [
