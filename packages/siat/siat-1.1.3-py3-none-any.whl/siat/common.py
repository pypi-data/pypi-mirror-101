...
def ectranslate(eword):
    ...
    ecdict=pd.DataFrame([
        ...
        ['enterpriseToRevenue','市售率'],['EV to Revenue','市售率'],        
        ['beta3Year','3年贝塔系数'],
...
def codetranslate(code):
    ...
    codedict=pd.DataFrame([
        ...
        ['1024.HK','快手港股'],['1166.HK','港股星凯控股'],['0273.HK','港股茂宸集团'],
        ...
        ['UBSG.SW','瑞士股瑞银'],['CDI.PA','法国股迪奥'],
        ['HMI.F','法国股爱马仕'],['DIO.F','法国股迪奥'],
