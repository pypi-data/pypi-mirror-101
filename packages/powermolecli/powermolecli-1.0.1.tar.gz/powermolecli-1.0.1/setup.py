...
setup(
    name='''powermolecli''',
    version=version,
    description='''powermole allows you to connect to a target destination host via one or more intermediaries, offering a variety of modes (FOR and TOR) and options (TRANSFER and COMMAND) to perform a variety of tasks''',
    ...
    license='MIT',
    zip_safe=False,
    keywords='''powermole powermolecli ssh proxyjump forwarding tor''',
    entry_points = {
                   'console_scripts': [
