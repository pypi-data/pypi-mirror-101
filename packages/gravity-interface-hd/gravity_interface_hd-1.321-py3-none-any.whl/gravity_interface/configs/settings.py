...
class Settings:
    ...
    def __init__(self, root, dirpath):
        ...
        self.manual_open_internal_gate_btn = [('open.png',w / 3.17949260042283, h / 1.0477489768076398,
        ...
        self.manual_close_internal_gate_btn = [('close.png', w / 4.547949260042283, h / 1.0477489768076398,
        ...
        self.manual_open_external_gate_btn = [('open.png', w / 1.4342454728370221, h / 1.0477489768076398,
                                               'operator.manual_gate_control.send_gate_comm("entry", "open")',
                                               PhotoImage(file=self.imgsysdir + 'open.png'), 60, 25,
                                               'onGreyBtn.TButton',
                                               PhotoImage(file=self.imgsysdir + 'openZ.png'))]
        self.manual_close_external_gate_btn = [('close.png', w / 1.264245472837022, h / 1.0477489768076398,
