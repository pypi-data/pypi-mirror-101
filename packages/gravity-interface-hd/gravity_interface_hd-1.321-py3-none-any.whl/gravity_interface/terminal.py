...
class Terminal():
    ...
    def indoctrinator(self, event, operator):
        ...
        print("COORDINATEN:", self.w/event.x, self.h/event.y)
    ...
    def getEntry(self, w=30, h=1, bg='#272727', fill='#BABABA'):
        ...
        newEntry = Entry(self.root, bd=0, width=w, textvariable=var, bg=bg,
                         fg=fill, font=self.font, disabledbackground=bg, disabledforeground=fill, highlightthickness=0)
        return newEntry
    ...
    def posExitInt(self, car_num, callback_method, spec_protocols='exit'):
        ...
        self.commEx = self.getText(h=1, w=27, bg=cs.orup_bg_color)
    ...
    def create_orup_comm(self, notes):
        self.comm = self.getText(h=1, w=35, bg=cs.orup_bg_color)
