...
class Pipeline(object):
    ...
    @staticmethod
    def _if_all_items_have_state(content_store: ContentStore):
    ...
    def perform_state_migrations(self, content_store: ContentStore):
        ...
        for state in self.states:
            ...
            if content_store.count(filter_q) != 0:
                ...
                print(f"No document to migrate for pipeline {self.name} state {state}")
