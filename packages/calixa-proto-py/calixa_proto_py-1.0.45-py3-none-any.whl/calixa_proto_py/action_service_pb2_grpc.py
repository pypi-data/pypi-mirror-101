...
class ActionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetActions = channel.unary_stream(
                '/calixa.domain.action.ActionService/GetActions',
                request_serializer=action__service__pb2.GetActionsRequest.SerializeToString,
                response_deserializer=action__service__pb2.GetActionsResponse.FromString,
                )
...
def add_ActionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetActions': grpc.unary_stream_rpc_method_handler(
                    servicer.GetActions,
                    request_deserializer=action__service__pb2.GetActionsRequest.FromString,
                    response_serializer=action__service__pb2.GetActionsResponse.SerializeToString,
            ),
...
class ActionService(object):
    ...
    def GetActions(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/calixa.domain.action.ActionService/GetActions',
            action__service__pb2.GetActionsRequest.SerializeToString,
            action__service__pb2.GetActionsResponse.FromString,
