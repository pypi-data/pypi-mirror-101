...
#  Copyright 2021 Giovanni Squillero and Alberto Tonda
#
...
with open('microgp/README.md', 'r', encoding='utf-8') as fh:
...
setuptools.setup(
    ...
    package_data={'': ['requirements.txt', 'microgp/README.md']},
    data_files=[('.', ['requirements.txt', 'microgp/README.md'])],
    classifiers=[
