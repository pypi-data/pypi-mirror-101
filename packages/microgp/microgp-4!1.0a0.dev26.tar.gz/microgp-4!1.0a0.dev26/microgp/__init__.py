...
version_info = VersionInfo(4, 1, 0, 'a', 0, 'Kiwi', 26)
...
__copyright__ = """Copyright (c) 2021 Giovanni Squillero and Alberto Tonda.
...
def show_banner() -> None:
    ...
    logging.bare("Copyright 2020-2021 by Giovanni Squillero and Alberto Tonda")
    sys.stderr.flush()
