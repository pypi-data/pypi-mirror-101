...
def locate_string(s, json):
    ...
    if isinstance(json, list):
                ...
                for i in l:
                    locations.append(
                        dict(
                            ...
                            value=i['value'],
                            level=i['level'] + 1,
                            wrapped_literal=i['wrapped_literal']
                        )
                    )
                found = True
                ...
                for i in l:
                    locations.append(
                        dict(
                            ...
                            value=i['value'],
                            level=i['level'] + 1,
                            wrapped_literal=True if i['level'] == 0 and k == 'literal' else i['wrapped_literal']
                        )
                    )
                found = True
        ...
        if s in json:
            found = True
            locations.append(dict(location=dict(), value=json, level=0, wrapped_literal=False))
