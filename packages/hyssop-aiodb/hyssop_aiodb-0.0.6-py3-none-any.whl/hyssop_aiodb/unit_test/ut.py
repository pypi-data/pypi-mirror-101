...
Modified By: hsky77
Last Updated: March 27th 2021 22:23:53 pm
'''
...
class AioDBTestCase(UnitTestCase):
    def test(self):
        ...
        # db = AioMySQLDatabase(SW_MODULES, host="192.168.1.20", port=37002, db_name="test", reconnect_seconds=2, connections=1,
        #                       user="root", password="7f6b15b4b2d7b59e7b5ca52dcaeb860685e393505b1ed554665188a39e0c9890")
