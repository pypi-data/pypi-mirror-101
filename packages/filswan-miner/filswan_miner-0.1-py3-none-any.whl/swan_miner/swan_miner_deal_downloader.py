...
from swan_miner.aria2c import Aria2c
from swan_miner.aria2_service import check_download_status, start_downloading
import subprocess
...
def downloader(config_path: str):
    ...
    logger = logging.getLogger('swan_miner_deal_downloader')
