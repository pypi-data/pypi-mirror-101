...
def _should_set_reset_index(automl_run: Optional[Run] = None,
    ...
    if automl_run is not None:
        ...
        if run_algorithm is not None and (constants.SupportedModels.Forecasting.AutoArima in run_algorithm or
            ...
            return True
        elif automl_run.properties.get('ensembled_algorithms') is not None:
            tmp = (constants.SupportedModels.Forecasting.AutoArima in
                   automl_run.properties.get('ensembled_algorithms') or
                   'ProphetModel' in automl_run.properties.get('ensembled_algorithms'))
            return tmp
