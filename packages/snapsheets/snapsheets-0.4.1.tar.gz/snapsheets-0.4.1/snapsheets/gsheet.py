...
@deprecated(
    version="0.3.0",
    reason="Will be removed. Replace with snapsheets.core.Sheet.download",
)
def download(
...
@deprecated(
    version="0.3.0", reason="Will be removed. Replace with snapsheets.core.Sheet.backup"
)
def backup(
    src: Union[str, Path],
...
@deprecated(
    version="0.3.0",
    reason="Will be removed. Replace with snapsheets.core.Sheet.snapshot",
)
def snapshot(
    name: str,
    stem: str = "snapshot",
