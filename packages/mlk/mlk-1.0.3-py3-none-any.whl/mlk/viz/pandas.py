...
try: from definitions_prod import appConfig
...
if __name__ == '__main__':
    ...
    # df_train = Pandas(appConfig.EXCEL_PATH + '/ytvideo.csv')
    # pchannel = Pandas(appConfig.EXCEL_PATH + '/ytchannel.csv')
    # pcategory = Pandas(appConfig.EXCEL_PATH + '/note_category.csv')
    # print(pchannel)
    ...
    p = Pandas(appConfig.EXCEL_PATH + '/ytvideo.csv')
    ...
    # p = Pandas(appConfig.DIST_PATH + '/xlsx/Pandas.xlsx')
    ...
    # p = Pandas(appConfig.DIST_PATH + '/Book1.xlsx')
    # print(p)
    # print(p.get_columns())
