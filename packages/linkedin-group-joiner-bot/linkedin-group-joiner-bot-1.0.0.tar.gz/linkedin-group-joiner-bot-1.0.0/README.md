Linkedin-Group-Joiner-Bot is a python library to join a group on linkedin using browser automation. 
It currently runs only on windows.

### Example
In this example we first import library, then we login with cookies and then joins a group.
```sh
from linkedin_group_joiner_bot import *
...
linkedin.join_group(group_link='https://www.linkedin.com/groups/2066905?lipi=urn%3Ali%3Apage%3Ad_flagship3_search_srp_groups%3BlQ8kHPApRD2Wh11RLFPg9g%3D%3D')
```
...
```sh
pip install linkedin-group-joiner-bot
```
...
### Join Group
```sh
linkedin.join_group(group_link='group_link')
```
