...
from autotrainz.builders_and_generators.packager.docker_packager import DockerPackager
...
class TestDockerPackager(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.__packager = DockerPackager(**configuration)
    ...
    def test_ctor(self):
        ...
        packager = DockerPackager(**configuration)

        self.assertIsInstance(packager, DockerPackager)
