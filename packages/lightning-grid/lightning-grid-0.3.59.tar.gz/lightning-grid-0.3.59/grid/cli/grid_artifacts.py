...
def _download_artifacts(artifacts: List[Artifact], download_dir: str) -> None:
    ...
    for artifact in artifacts:
        files_to_download.append(
            DownloadableObject(url=artifact.url,
...
def artifacts(runs_or_experiments: List[str],
    ...
    with progress:
        for element in runs_or_experiments:
            ...
            if is_experiment(element):
                ...
                experiment.refresh()
                _download_artifacts(experiment.artifacts,
