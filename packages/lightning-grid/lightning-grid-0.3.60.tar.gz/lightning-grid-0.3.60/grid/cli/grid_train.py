...
def _print_submission_message(instance_type: str, provider: str, credential_id: str, entrypoint: str, grid_name: str,
                              datastore_name: str, datastore_version: int, datastore_mount_dir: str):
...
def train(ctx, script: str, entrypoint: str, config: Optional[Dict], name: Optional[str], credential: Optional[str],
          ...
          datastore_version: Optional[str], datastore_mount_dir: Optional[str], framework: Optional[str]) -> None:
    ...
    #  default credentials.
    if not config:
        _grid_config = _generate_default_grid_config(client=client,
