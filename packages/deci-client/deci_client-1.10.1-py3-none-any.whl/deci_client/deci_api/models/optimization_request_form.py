...
class OptimizationRequestForm(object):
    ...
    def __init__(self, target_hardware=None, target_batch_size=None, target_metric=None, optimize_model_size=None, quantization_level=None, optimize_autonac=None, name=None, local_vars_configuration=None):  # noqa: E501
