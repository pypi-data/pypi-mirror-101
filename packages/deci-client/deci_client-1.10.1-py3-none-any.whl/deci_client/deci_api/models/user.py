...
class User(object):
    ...
    def __init__(self, update_time=None, creation_time=None, user_id=None, company_id=None, email=None, first_name=None, last_name=None, job_title=None, state=None, feature_flags=[], local_vars_configuration=None):  # noqa: E501
