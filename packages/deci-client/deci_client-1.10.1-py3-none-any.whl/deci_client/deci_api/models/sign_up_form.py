...
class SignUpForm(object):
    ...
    def __init__(self, company_name=None, email=None, first_name=None, last_name=None, password=None, job_title=None, invite_token=None, local_vars_configuration=None):  # noqa: E501
