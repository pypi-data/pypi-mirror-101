...
class OptimizedModelResponseMetadata(object):
    ...
    def __init__(self, update_time=None, creation_time=None, model_id=None, name=None, company_name=None, company_id=None, owner=None, version='1.0', model_size=0, source=None, quantization_level=None, primary_hardware=None, primary_batch_size=None, framework=None, dl_task=None, input_dimensions=None, dataset_name='', architecture=None, deleted=False, benchmark_state=None, benchmark_start_date=None, benchmark_end_date=None, benchmark=None, optimization_state=None, optimization_start_date=None, optimization_end_date=None, baseline_model_id=None, input_tensor_name=None, output_tensor_name=None, description='', tags=[], kpis=[], accuracy_metrics=[], hyper_parameters=[], local_vars_configuration=None):  # noqa: E501
