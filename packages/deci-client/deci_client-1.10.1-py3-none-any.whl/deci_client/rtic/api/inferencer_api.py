...
class InferencerApi(object):
    ...
    def get_model(self, model_name, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: APIResponseRegisteredModelMetaData
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def get_model_with_http_info(self, model_name, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(APIResponseRegisteredModelMetaData, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='APIResponseRegisteredModelMetaData',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def list_registered_models(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: APIResponseTypingDictUuidUUIDDeciCoreInferencerInferenceManagerRegisteredModelMetaData
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def list_registered_models_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(APIResponseTypingDictUuidUUIDDeciCoreInferencerInferenceManagerRegisteredModelMetaData, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='APIResponseTypingDictUuidUUIDDeciCoreInferencerInferenceManagerRegisteredModelMetaData',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def predict(self, model_name, content_length, **kwargs):  # noqa: E501
        """Predict  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.predict(model_name, content_length, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str model_name: The unique name of the model. (required)
        :param str content_length: (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.predict_with_http_info(model_name, content_length, **kwargs)  # noqa: E501

    def predict_with_http_info(self, model_name, content_length, **kwargs):  # noqa: E501
        """Predict  # noqa: E501

        Predict (Classify) input tensors. The request body is the input tensor, serialized with nump. Use Deci's API client for maximum result.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.predict_with_http_info(model_name, content_length, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('content_length' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `content_length` when calling `predict`")  # noqa: E501
    ...
    def register_model(self, model_name, framework_type, inference_hardware, model_weights_source, weights_path, **kwargs):  # noqa: E501
        ...
        :param FrameworkType framework_type: The Deep Learning framework of the model. Must be one of: tf1, tf2, pytorch, onnx, torchscript, trt, tvm, openvino, keras (required)
