...
class StrategyBacktestStats(Model):
    ...
    def apply_2_symbol(self, symbols=None, ignore_no_s_pattern_record=False):
        ...
        if symbols is None:
            ...
            symbols_info_curr = SymbolsInfo.get_instance(symbols)
        ...
        symbols = symbols_info_curr.symbols
        is_multi = len(symbols.split('_'))>1
        if is_multi:
