...
class test_spliter(unittest.TestCase):
    ...
    def test_bug_2021_4_3_1(self):
        ...
        expect = ["The show's writers gave these tropes a 2021 refresh by leaning into the "
                  '"woke" culture of millennials and Gen Z, calling out intolerance, accepting '
                  'and normalising LGBTQ+ issues,',
                  ' and highlighting struggles faced by minorities living in the US – '
 ...
 ' Like ~ in the sea. ']
    ...
    def test_bug_2021_4_10_4(self):
        ...
        acutal = m_input.sentence_list()
        print(acutal)
        expect = ['\'"Who was it used to pray, O God, make me good, but not yet"?',
                  "' and 1 2 3 4 5 6 7"]
        self.assertEqual(expect, acutal)
