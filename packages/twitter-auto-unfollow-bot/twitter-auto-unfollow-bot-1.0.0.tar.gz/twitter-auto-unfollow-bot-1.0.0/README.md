Twitter-Auto-Unfollow-Bot is a python library to unfollow user on twitter using browser automation. 
...
twitter.unfollow(profile_url='https://twitter.com/LinkedIn')
```
