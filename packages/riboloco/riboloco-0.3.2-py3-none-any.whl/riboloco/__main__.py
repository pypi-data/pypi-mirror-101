...
def read_types_each_orf(df, orf_df, filename, offset=-14):
    ...
    df = df.reset_index()[["transcript_id", "read_type", "est", "counts_this_type_this_tx_this_pos"]]
    ...
    numbers = combined.groupby(["orf_id", "read_type", "annotated"]).sum()["counts_this_type_this_tx_this_pos"]
