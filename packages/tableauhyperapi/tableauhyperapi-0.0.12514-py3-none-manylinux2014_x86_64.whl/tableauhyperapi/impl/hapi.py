...
hyper_connection_get_hyper_service_version: Callable = lib.hyper_connection_get_hyper_service_version
...
hyper_connection_is_capability_active: Callable = lib.hyper_connection_is_capability_active
