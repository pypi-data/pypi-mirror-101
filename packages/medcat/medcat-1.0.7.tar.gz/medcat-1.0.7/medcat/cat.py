                    ...
                    try:
                        if max_chars_in_memory > 0:
                            while out_dict['current_size_in_chars'] > max_chars_in_memory:
                                ...
                                print("Process: {}, waiting because current chars in memory: {}".format(pid, out_dict['current_size_in_chars']))
                        ...
                        print("Process: {}, current chars in memory (before) is: {}".format(pid, out_dict['current_size_in_chars']))
                        # Annotate document
                        ...
                        print("Process: {}, current chars in memory (after) is: {}".format(pid, out_dict['current_size_in_chars']))
                        doc['text'] = text
                        out.append((id, doc))
                    except Exception as e:
