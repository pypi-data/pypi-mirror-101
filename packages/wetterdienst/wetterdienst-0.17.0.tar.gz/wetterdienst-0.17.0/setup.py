...
{':extra == "ipython" or extra == "docs"': ['matplotlib>=3.3.2,<4.0.0'],
 ...
 ':sys_platform != "darwin" or sys_platform == "darwin" and platform_machine != "arm64"': ['h5netcdf>=0.10.0,<0.11.0'],
 ...
 'mysql:sys_platform != "darwin" or sys_platform == "darwin" and platform_machine != "arm64"': ['mysqlclient>=2.0.1,<3.0.0'],
 'postgresql': ['psycopg2-binary>=2.8.6,<3.0.0'],
 'radar:sys_platform != "darwin" or sys_platform == "darwin" and platform_machine != "arm64"': ['wradlib>=1.9.0,<2.0.0'],
