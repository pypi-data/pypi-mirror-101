...
def main(args: List[str]) -> bool:
    ...
    try:
        ...
        if args.credential_definition:
            do_credential_definition(args.credential_definition)

    except KeyboardInterrupt:
        print(" ==> Exit init")


def do_credential_definition(schema_id):
...
def parse_args(args):
    ...
    parser.add_argument("-cd", "--credential-definition", required=False, help="The credential definition")
...
def do_schema(schema):
    try:
        ...
        logger.error("created schema failed.")
