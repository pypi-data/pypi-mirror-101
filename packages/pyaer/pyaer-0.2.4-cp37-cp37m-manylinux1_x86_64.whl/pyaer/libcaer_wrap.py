...
class discovery_result(object):
    r"""Proxy of C discovery_result struct."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, nelements):
        r"""__init__(discovery_result self, size_t nelements) -> discovery_result"""
        _libcaer_wrap.discovery_result_swiginit(self, _libcaer_wrap.new_discovery_result(nelements))
    __swig_destroy__ = _libcaer_wrap.delete_discovery_result

    def __getitem__(self, index):
        r"""__getitem__(discovery_result self, size_t index) -> caer_device_discovery_result"""
        return _libcaer_wrap.discovery_result___getitem__(self, index)

    def __setitem__(self, index, value):
        r"""__setitem__(discovery_result self, size_t index, caer_device_discovery_result value)"""
        return _libcaer_wrap.discovery_result___setitem__(self, index, value)

    def cast(self):
        r"""cast(discovery_result self) -> caer_device_discovery_result"""
        return _libcaer_wrap.discovery_result_cast(self)

    @staticmethod
    def frompointer(t):
        r"""frompointer(caer_device_discovery_result t) -> discovery_result"""
        return _libcaer_wrap.discovery_result_frompointer(t)

# Register discovery_result in _libcaer_wrap:
_libcaer_wrap.discovery_result_swigregister(discovery_result)

def discovery_result_frompointer(t):
    r"""discovery_result_frompointer(caer_device_discovery_result t) -> discovery_result"""
    return _libcaer_wrap.discovery_result_frompointer(t)
...
def device_discover(device_type):
    r"""device_discover(int16_t device_type) -> caer_device_discovery_result"""
    return _libcaer_wrap.device_discover(device_type)
