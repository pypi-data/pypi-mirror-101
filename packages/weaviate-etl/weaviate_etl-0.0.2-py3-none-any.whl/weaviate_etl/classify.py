...
def _reset_classification_configuration(client, classification):
...
def execute_classification(client, classification):
...
def import_and_classify(instance, model, classification, datapoints):
    ...
    ccuuid = _reset_classification_configuration(client, classification)
