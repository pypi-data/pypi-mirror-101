...
from common.answers import RESPONSE_511
from common.decorators import Log
from common.errors import ServerError
from common.utils import get_configs, send_message, \
    get_message
...
class ClientTransport(threading.Thread, QObject):
    ...
    def contacts_list_update(self):
        ...
        if CONFIGS.get(
                'RESPONSE') in ans and ans[CONFIGS.get('RESPONSE')] == 202:
    ...
    def key_request(self, user):
        ...
        with socket_lock:
            ...
            ans = get_message(self.transport, CONFIGS)
        if CONFIGS.get(
                'RESPONSE') in ans and ans[CONFIGS.get('RESPONSE')] == 511:
