...
class histogram1d(basehistogram):
    ...
    def to_root(self, nominal_label='nominal', key_form='{name}_{variation}'):
        ...
        def to_th1(name, binedges, areas):
            ...
            rnp.array2hist(areas, th1) # bin errors are not set
            return th1
        th1s = {}
        # Add nominal
...
class histogram2d(basehistogram):
    ...
    def to_root(self, nominal_label='nominal', key_form='{name}_{variation}'):
        ...
        def to_th2(name, binedges, areas):
            ...
            rnp.array2hist(areas, th2) # bin errors are not set
            return th2
        th2s = {}
        # Add nominal
        key = key_form.format(name=self.name, variation=nominal_label)
