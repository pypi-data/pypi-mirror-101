...
class LazoIndex(object):
    ...
    def IndexData(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/lazo_index.LazoIndex/IndexData',
    ...
    def GetLazoSketchFromData(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/lazo_index.LazoIndex/GetLazoSketchFromData',
            lazo__index__pb2.ColumnValues.SerializeToString,
            lazo__index__pb2.LazoSketchData.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
