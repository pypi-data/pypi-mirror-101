...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, content_guard=None, base_path=None, pulp_labels=None, pulp_created=None, repository_version=None, repository=None, pulp_href=None, name=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
