...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, base_path=None, repository_version=None, content_guard=None, pulp_created=None, repository=None, name=None, pulp_href=None, pulp_labels=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
