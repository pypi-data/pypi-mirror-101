...
class ContainerContainerDistributionResponse(object):
    ...
    def __init__(self, pulp_labels=None, base_path=None, content_guard=None, pulp_href=None, pulp_created=None, name=None, repository=None, repository_version=None, registry_path=None, namespace=None, private=None, description=None, local_vars_configuration=None):  # noqa: E501
