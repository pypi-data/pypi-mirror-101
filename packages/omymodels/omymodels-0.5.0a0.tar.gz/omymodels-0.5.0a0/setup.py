...
packages = \
['omymodels', 'omymodels.gino', 'omymodels.pydantic']

package_data = \
{'': ['*']}

install_requires = \
['simple-ddl-parser>=0.11,<0.12']
...
setup_kwargs = {
    'name': 'omymodels',
    'version': '0.5.0a0',
    'description': 'O! My Models (omymodels) is a library to generate Python Models for GinoORM & Pydantic from SQL DDL .',
