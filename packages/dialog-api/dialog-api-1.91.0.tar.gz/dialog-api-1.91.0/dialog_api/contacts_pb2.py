...
_UPDATECONTACTSADDED_USERSBYPHONEENTRY = _descriptor.Descriptor(
  name='UsersByPhoneEntry',
  full_name='dialog.UpdateContactsAdded.UsersByPhoneEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='dialog.UpdateContactsAdded.UsersByPhoneEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='dialog.UpdateContactsAdded.UsersByPhoneEntry.value', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UPDATECONTACTSADDED = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\212\3520\t\n\007compact', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='users_by_phone', full_name='dialog.UpdateContactsAdded.users_by_phone', index=2,
  ...
  nested_types=[_UPDATECONTACTSADDED_USERSBYPHONEENTRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
...
_UPDATECONTACTSADDED_USERSBYPHONEENTRY.containing_type = _UPDATECONTACTSADDED
_UPDATECONTACTSADDED.fields_by_name['task_id'].message_type = google_dot_protobuf_dot_wrappers__pb2._STRINGVALUE
_UPDATECONTACTSADDED.fields_by_name['users_by_phone'].message_type = _UPDATECONTACTSADDED_USERSBYPHONEENTRY
...
UpdateContactsAdded = _reflection.GeneratedProtocolMessageType('UpdateContactsAdded', (_message.Message,), {
  ...
  'UsersByPhoneEntry' : _reflection.GeneratedProtocolMessageType('UsersByPhoneEntry', (_message.Message,), {
    'DESCRIPTOR' : _UPDATECONTACTSADDED_USERSBYPHONEENTRY,
    '__module__' : 'contacts_pb2'
    # @@protoc_insertion_point(class_scope:dialog.UpdateContactsAdded.UsersByPhoneEntry)
    })
  ,
...
_sym_db.RegisterMessage(UpdateContactsAdded.UsersByPhoneEntry)
...
_UPDATECONTACTSADDED_USERSBYPHONEENTRY._options = None
