Linkedin-Auto-Unfollow-Company is a python library to unfollow a company on linkedin using browser automation. 
It currently runs only on windows.

### Example
In this example we first import library, then we login with cookies and then unfollow company.
```sh
from linkedin_auto_unfollow_company import *
...
```sh
pip install linkedin-auto-unfollow-company
```
