...
class HoloWAN:
    ...
    def __init__(self):
        ...
        # 错误码
        self.POengineIDError = self.ini.get("PathOperateErrorCode", "engineIDError")
        self.POpathIDError = self.ini.get("PathOperateErrorCode", "pathIDError")
        self.POpathNameError = self.ini.get("PathOperateErrorCode", "pathIDError")
        self.POremovePathNotFound = self.ini.get("PathOperateErrorCode", "removePathNotFound")
        self.POpathExist = self.ini.get("PathOperateErrorCode", "pathExist")
        self.POopenPathNotFound = self.ini.get("PathOperateErrorCode", "openPathNotFound")
        self.POclosePathNotFound = self.ini.get("pathOperateErrorCode", "closePathNotFound")
    ...
    def remove_path(self, holowan_ip: str, holowan_port: str, engineID: int, pathID: int, pathName: str,
        ...
        if self.has_engine(holowan_ip, holowan_port, engineID) is False:
            ...
            if pathID > 15 or pathID <= 0:
                return r'{"errCode":"-7","errMsg":"ERROR","errReason":"PATH is not found"}'
            else:
    ...
    def close_Background_Utilization(self, holowan_ip: str, holowan_port: str, engineID: int, pathID: int,
        ...
        try:
            if pathDirection == 1:
                ...
                return r'{"errCode":"-10","errMsg":"ERROR","errReason":"Error parameter values pathDirection"}'
            tagText = 1
            return self.set_one_tag_text(holowan_ip, holowan_port, engineID, pathID, tagPath, tagText)
    ...
    def get_path_config_information(self, holowan_ip:str, holowan_port:str, engineID:int, pathID: int):
        ...
        try:
            ...
            if self.has_engine(holowan_ip, holowan_port, engineID) is False:
                return r'{"errCode":"-501","errMsg":"ERROR","errReason":"ENGINE has no found"}'
            if self.has_path(holowan_ip, holowan_port, engineID, pathID) is False:
                return r'{"errCode":"-502","errMsg":"ERROR","errReason":"PATH has no found"}'
    ...
    def set_one_tag_text(self, holowan_ip: str, holowan_port: str, engineID: int, pathID: int, tagPath: str, tagText):
        ...
        try:
            ...
            if pathXMLStr == r'{"errCode":"-501","errMsg":"ERROR","errReason":"ENGINE has no found"}' or \
                    pathXMLStr == r'{"errCode":"-502","errMsg":"ERROR","errReason":"PATH has no found"}':
                return pathXMLStr
    ...
    def set_tag_children(self, holowan_ip: str, holowan_port: str, engineID: int, pathID: int, pathDirection,
        ...
        try:
            if pathDirection == 1:
                ...
                return r'{"errCode":"-10","errMsg":"ERROR","errReason":"Error pathDirection"}'
            pathXMLStr = self.get_path_config_information(holowan_ip, holowan_port, engineID, pathID)
            if pathXMLStr == r'{"errCode":"-501","errMsg":"ERROR","errReason":"ENGINE has no found"}' or \
                    pathXMLStr == r'{"errCode":"-502","errMsg":"ERROR","errReason":"PATH has no found"}':
                return pathXMLStr
...
if __name__ == '__main__':
    holowan_ip = "192.168.1.224"
    holowan_port = "8080"
    engineID = 1
    holowan = HoloWAN()
    subholowan = SubHoloWAN(holowan_ip, holowan_port)
    # response = holowan.resetEngine(holowan_ip, holowan_port, engineID)
    response = subholowan.resetEngine()
    print(response)
