...
if __name__ == '__main__':
    ...
    rateValue = 1000
    rateUnit = 3
    holowan = SubHoloWAN(holowan_ip, holowan_port)
    response = holowan.set_path_Bandwidth_Fixed(engineID=engineID, pathID=pathID, pathDirection=pathDirection,
                                                rateValue=rateValue, rateUnit=rateUnit)
    print(response)
