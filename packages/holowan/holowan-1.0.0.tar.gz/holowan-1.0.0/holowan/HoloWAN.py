...
if __name__ == '__main__':
    ...
    action = -1
    holowan = HoloWAN()
    # response = holowan.add_TCP_to_Classifier(holowan_ip=holowan_ip,
    ...
    #                                          action=action)
    # response = holowan.remove_TCP_from_Classifier(holowan_ip=holowan_ip,
    #                                          holowan_port=holowan_port,
    #                                          engineID=engineID,
    #                                          portID=portID,
    #                                          sourcePort=sourcePort,
    ...
    #                                          checkVersion=checkVersion,
    #                                          action=action)
    response = holowan.remove_all_TCP_from_Classifier(holowan_ip=holowan_ip,
                                                      holowan_port=holowan_port,
                                                      engineID=engineID,
                                                      portID=portID)
