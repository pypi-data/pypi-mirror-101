    ...
    def __call__(self, function):
        ...
        def wrapper(*args, **kwargs):
            ...
            for arg, param in zip(args, va):
                if type(arg) == int and isinstance(arg, float):
                    arg = float(arg)
            ...
            for k, v in kwargs.items():
                ...
                if params[k].annotation != inspect._empty and not isinstance(v, params[k].annotation):
                    ...
                    # print(isinstance(params[k].annotation, float))
                    # print(params[k].annotation == float)
...
class HoloWAN:
    ...
    def add_IPV4_TCP_to_Classifier(self, holowan_ip: str, holowan_port: str, engineID: int, portID: int, sourceIP: str,
        ...
        parameters = {"holowan_ip": holowan_ip, "holowan_port": holowan_port, "engineID": engineID, "portID": portID,
                      ...
                      "destPort": destPort, "checkVersion": checkVersion, "action": action}
        ...
        if operation == self.ADD or operation == self.REMOVE:
            ...
            if operation == self.ADD:
                ...
                if remove_flags is False:
                    return RuntimeError(
                        "Engine{0} port{1} has not such {2}".format(engineID, portID, classifierNodeName))
...
class SubHoloWAN(HoloWAN):
    ...
    def hold_engine(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                    password: int = 123456, new_password: int = 123456):
    ...
    def init_path(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                  pathID: int = 1, pathName: str = "PATH"):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().init_path(holowan_ip, holowan_port, engineID, pathID, pathName)

    def remove_path(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                    pathID: int = 1, pathName: str = "PATH"):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().remove_path(holowan_ip, holowan_port, engineID, pathID, pathName)

    def open_path(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                  pathID: int = 1, pathName: str = "PATH"):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().open_path(holowan_ip, holowan_port, engineID, pathID, pathName)

    def close_path(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                   pathID: int = 1, pathName: str = "PATH"):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().close_path(holowan_ip, holowan_port, engineID, pathID, pathName)

    def set_path_direction(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                           pathID: int = 1, pathDirection: int = 3):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().set_path_direction(holowan_ip, holowan_port, engineID, pathID, pathDirection)

    def set_path_Bandwidth_Fixed(self, holowan_ip: str = "defaule", holowan_port: str = "default",
    ...
    def close_Background_Utilization(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                     engineID: int = 1, pathID: int = 1,
                                     pathDirection: int = 3):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().close_Background_Utilization(holowan_ip, holowan_port, engineID, pathID, pathDirection)

    def set_Background_Utilization(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                   engineID: int = 1, pathID: int = 1,
    ...
    def set_Queue_Limit_Drop_Tail(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                  engineID: int = 1, pathID: int = 1,
    ...
    def close_message_Modify(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                             pathID: int = 1, pathDirection: int = 3):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().close_message_Modify(holowan_ip, holowan_port, engineID, pathID, pathDirection)

    def set_message_Modify_Normal(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                  engineID: int = 1, pathID: int = 1,
                                  pathDirection: int = 3, matchType: int = 1, matchOffset: int = 0,
    ...
    def set_message_Modify_Cycle(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                 engineID: int = 1, pathID: int = 1,
                                 pathDirection: int = 3, matchType: int = 1, matchOffset: int = 0,
                                 matchSize: int = 1, matchValue: str = "FF",
                                 modifyType: int = 1, modifyOffset: int = 0, modifySize: int = 1,
    ...
    def set_message_Modify_Random(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                  engineID: int = 1, pathID: int = 1,
                                  pathDirection: int = 3, matchType: int = 1, matchOffset: int = 0,
                                  matchSize: int = 1, matchValue: str = "FF",
                                  modifyType: int = 1, modifyOffset: int = 0, modifySize: int = 1,
    ...
    def close_MTU_Limit(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                        pathID: int = 1, pathDirection: int = 3):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().close_MTU_Limit(holowan_ip, holowan_port, engineID, pathID, pathDirection)

    def set_MTU_Limit(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                      pathID: int = 1, pathDirection: int = 3,
                      limitValue: int = 1500):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().set_MTU_Limit(holowan_ip, holowan_port, engineID, pathID, pathDirection, limitValue)

    def set_Frame_Overhead(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                           pathID: int = 1, pathDirection: int = 3,
                           type: int = 3, rate: int = 24):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().set_Frame_Overhead(holowan_ip, holowan_port, engineID, pathID, pathDirection, type, rate)

    def set_Delay_Constant(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                           pathID: int = 1, pathDirection: int = 3,
                           delay: float = 2):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().set_Delay_Constant(holowan_ip, holowan_port, engineID, pathID, pathDirection, delay)

    def set_Delay_Uniform(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                          pathID: int = 1, pathDirection: int = 3,
    ...
    def set_Delay_Normal(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                         pathID: int = 1, pathDirection: int = 3,
    ...
    def set_Delay_Normal_AdvancedSetup(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                       engineID: int = 1, pathID: int = 1,
                                       pathDirection: int = 3, min: float = 1.0, mean: float = 50.0,
    ...
    def set_Delay_Custom(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                         pathID: int = 1, pathDirection: int = 3,
    ...
    def set_Loss_Random(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                        pathID: int = 1, pathDirection: int = 3,
                        rate: float = 5.000):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().set_Loss_Random(holowan_ip, holowan_port, engineID, pathID, pathDirection, rate)

    def set_Loss_Cycle(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                       pathID: int = 1, pathDirection: int = 3,
    ...
    def set_Loss_Burst(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                       pathID: int = 1, pathDirection: int = 3,
    ...
    def set_Loss_Dual(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                      pathID: int = 1, pathDirection: int = 3,
    ...
    def set_BER(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                pathID: int = 1, pathDirection: int = 3,
                bitErrorValue: int = 1, bitErrorIndex: int = -14):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().set_BER(holowan_ip, holowan_port, engineID, pathID, pathDirection, bitErrorValue,
                               bitErrorIndex)

    def set_Reordering_Normal(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                              pathID: int = 1, pathDirection: int = 3,
    ...
    def set_Duplication_Normal(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                               pathID: int = 1, pathDirection: int = 3,
    ...
    def get_path_config_information(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                    engineID: int = 1, pathID: int = 1):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().get_path_config_information(holowan_ip, holowan_port, engineID, pathID)

    def add_IPV4_to_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
    ...
    def remove_IPV4_from_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default",
    ...
    def remove_all_IPV4_from_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                        engineID: int = 1, portID: int = 1):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().remove_all_IPV4_from_Classifier(holowan_ip, holowan_port, engineID, portID)

    def add_IPV6_to_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                               portID: int = 1, sourceIP: str = "any",
    ...
    def remove_IPV6_from_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                    engineID: int = 1, portID: int = 1, sourceIP: str = "any",
                                    destinationIP: str = "any", action: int = 1):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
    ...
    def remove_all_IPV6_from_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                        engineID: int = 1, portID: int = 1):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().remove_all_IPV6_from_Classifier(holowan_ip, holowan_port, engineID, portID)

    def add_MAC_to_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
    ...
    def remove_MAC_from_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default",
    ...
    def remove_all_MAC_from_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                       engineID: int = 1, portID: int = 1):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().remove_all_MAC_from_Classifier(holowan_ip, holowan_port, engineID, portID)

    def add_TCP_to_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
    ...
    def remove_TCP_from_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                   engineID: int = 1, portID: int = 1,
    ...
    def remove_all_TCP_from_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                       engineID: int = 1, portID: int = 1):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().remove_all_TCP_from_Classifier(holowan_ip, holowan_port, engineID, portID)

    def add_UDP_to_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                              portID: int = 1, sourcePort: str = "any",
                              destPort: str = "any", checkVersion: int = 0, action: int = 1):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
    ...
    def remove_UDP_from_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                   engineID: int = 1, portID: int = 1,
                                   sourcePort: str = "any", destPort: str = "any", checkVersion: int = 0,
                                   action: int = 1):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
    ...
    def remove_all_UDP_from_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                       engineID: int = 1, portID: int = 1):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().remove_all_UDP_from_Classifier(holowan_ip, holowan_port, engineID, portID)

    def create_TCP_or_UDP(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
    ...
    def add_IPV4_TCP_to_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                   engineID: int = 1, portID: int = 1, sourceIP: str = "any",
                                   sourceMask: int = 32, destinationIP: str = "any", destinationMask: int = 32,
    ...
    def remove_IPV4_TCP_from_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                        engineID: int = 1, portID: int = 1,
                                        ...
                                        checkVersion: int = 0, action: int = 1):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
    ...
    def remove_all_IPV4_TCP_from_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                            engineID: int = 1, portID: int = 1):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().remove_all_IPV4_TCP_from_Classifier(holowan_ip, holowan_port, engineID, portID)

    def add_IPV4_UDP_to_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                   engineID: int = 1, portID: int = 1, sourceIP: str = "any",
                                   sourceMask: int = 32, destinationIP: str = "any", destinationMask: int = 32,
                                   TOS: str = "any", sourcePort: str = "any",
                                   destPort: str = "any", checkVersion: int = 0, action: int = 1):
    ...
    def remove_IPV4_UDP_from_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                        engineID: int = 1, portID: int = 1,
                                        sourceIP: str = "any", sourceMask: int = 32, destinationIP: str = "any",
                                        destinationMask: int = 32,
                                        TOS: str = "any", sourcePort: str = "any", destPort: str = "any",
    ...
    def remove_all_IPV4_UDP_from_Classifier(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                            engineID: int = 1, portID: int = 1):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().remove_all_IPV4_UDP_from_Classifier(holowan_ip, holowan_port, engineID, portID)

    def create_IPV4_and_TCP_or_UDP(self, holowan_ip: str = "defaule", holowan_port: str = "default",
    ...
    def get_Packet_Classifier_config_information(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                                 engineID: int = 1):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
    ...
    def remove_or_open_or_close_path(self, holowan_ip: str = "defaule", holowan_port: str = "default",
    ...
    def get_path_current_data(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                              pathID: int = 1):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().get_path_current_data(holowan_ip, holowan_port, engineID, pathID)

    def get_path_graph_current(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                               pathID: int = 1, id: int = "rx_bytes",
                               type: str = "rx_bytes"):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().get_path_graph_current(holowan_ip, holowan_port, engineID, pathID, id, type)

    def get_HoloWAN_history_entire_data(self, holowan_ip: str = "defaule", holowan_port: str = "default",
    ...
    def get_path_graph_current_dataGroup(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                         engineID: int = 1, pathID: int = 1,
    ...
    def clean_engine_statistic_data(self, holowan_ip: str = "defaule", holowan_port: str = "default",
                                    engineID: int = 1):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().clean_engine_statistic_data(holowan_ip, holowan_port, engineID)

    def create_csv(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
    ...
    def set_network(self, holowan_ip: str = "defaule", holowan_port: str = "default", hostName: str = "MyHoloWAN",
    ...
    def set_preferences(self, holowan_ip: str = "defaule", holowan_port: str = "default",
    ...
    def get_path_Name(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                      pathID: int = 1):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
    ...
    def resetPath(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                  pathID: int = 1):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
        return super().resetPath(holowan_ip, holowan_port, engineID, pathID)

    def resetClassifier(self, holowan_ip: str = "defaule", holowan_port: str = "default", engineID: int = 1,
                        portID: int = 1):
        holowan_ip, holowan_port = self.setDefaultParameter(holowan_ip, holowan_port)
...
if __name__ == '__main__':
    ...
    portID = 2
    holowan = HoloWAN()
    response = holowan.remove_all_IPV4_UDP_from_Classifier(holowan_ip=holowan_ip,
