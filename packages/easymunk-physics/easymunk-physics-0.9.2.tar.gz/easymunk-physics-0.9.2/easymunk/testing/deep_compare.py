...
@_compare.register(Space)
def _space(x, y, path, memo):
...
@_compare.register(Body)
def _body(x, y, path, memo):
    _base_compare(x, y, path, memo)
    deep_compare(set(x.shapes), set(y.shapes), path, memo)
