...
# for PyInstaller, py2exe and other bundlers
...
def cp_property_(api: str, fset=None, doc: str = None, **kwargs) -> Any:
    return cp_property(api, fset, doc, **kwargs)
...
def cpvec_property_(api: str, fset=None, doc: str = None, **kwargs) -> Vec2d:
    return cpvec_property(api, fset, doc, **kwargs)  # type: ignore


def property_(fget=None, fset=None, fdel=None, doc=None) -> Any:
    return property(fget, fset, fdel, doc=None)
