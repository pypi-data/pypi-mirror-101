...
def main():
    ...
    for x in range(-100, 150, 50):
        ...
        mass = 10
        radius = 25
        moment = mk.moment_for_circle(mass, radius, 0, (0, 0))
        ...
        bodies.append(body)
        pj = mk.DistanceJoint(
            space.static_body, body, anchor_a=(x, 125 + offset_y), anchor_b=(0, 0)
        )
        space.add(pj)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.USEREVENT + 2:
                ...
                if hit is not None:
                    ...
                    ds = mk.DampedSpring(
                        mouse_body, shape.body, 1000, 10, rest_length, (0, 0), (0, 0)
                    )
                    space.add(ds)
                    selected = ds
