...
class PartDisbout(BinoutData):
    ...
    def get_data_of_defined_json(self, data_offsets, type, ID, array):
        """
        ...
        part_ids = self.get_channels_ids_object_name(ID, self._name)
...
class JointForc(BinoutData):
    ...
    def get_measurement_channel(self, id_, channel_name):
        ...
        return d.reshape(-1, len(data_index)) * unit
