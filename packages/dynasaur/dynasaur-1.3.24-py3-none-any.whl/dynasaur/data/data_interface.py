...
class BinoutData(object):
    ...
    def get_channels_ids_object_name(self, object_name, binout_data_type):
        """

        Args:
          object_name: type object_name:
          binout_data_type: type plugin_name:

        Returns:
          np.array: time

        """
        defined_ids = self._dynasaur_definitions.get_ids_from_name(object_name, self._name, binout_data_type)
        availbale_ids = self.get_ids()
        channel_ids = np.intersect1d(defined_ids, availbale_ids)
    ...
    def get_data_of_defined_json(self, data_offsets, type: str, ID: str, array: list):
        """
        ...
        """
        ids = self.get_channels_ids_object_name(ID, self._name)
