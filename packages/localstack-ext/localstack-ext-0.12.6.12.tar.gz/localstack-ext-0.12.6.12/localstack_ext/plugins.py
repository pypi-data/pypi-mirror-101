...
def register_localstack_plugins():
 ...
 if lzxcH([is_api_enabled(api)for api in EXTERNAL_PORT_APIS]):
...
def load_plugin_files():
 try:
  ...
  if 'No module named' not in lzxcC(e):
   print('ERROR: %s'%e)
...
def api_key_configured():
 return lzxcV(os.environ.get('LOCALSTACK_API_KEY'))
