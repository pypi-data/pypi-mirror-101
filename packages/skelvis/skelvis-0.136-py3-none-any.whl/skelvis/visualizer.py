...
class SkeletonVisualizer:
    ...
    def visualize_video_from_file_with_ground_truths(self, pred_file_name: str, gt_file_name: str,
        ...
        file.close()
        self.visualize_video_with_ground_truths(pred_frames, gt_frames, pred_colors, gt_colors, fps, include_names, include_coordinates, automatic_camera_orientation)
    ...
    def __create_skeleton_plot(self, skeletons: np.ndarray, skeleton_converter: Callable[[Skeleton], DrawableSkeleton],
        ...
        if positions is None:
            positions = skeletons
        skeleton_objects: List[Skeleton] = self.__get_skeletons(positions, colors, skeleton_part_size, is_gt_list)
