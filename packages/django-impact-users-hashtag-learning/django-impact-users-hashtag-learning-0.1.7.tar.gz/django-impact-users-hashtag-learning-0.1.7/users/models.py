...
class CustomUserManager(BaseUserManager):
    ...
    def update_school(self, user, school):
        user.school = school
        school_as_faculty = Faculty.objects.get_school_as_faculty()
        user.faculty = school_as_faculty
        user.member_of_faculties.add(school_as_faculty)
        user.save()

    def get_users_signed_up_between(self, start_time, end_time):
...
class User(AbstractUser):
    ...
    def remove_from_faculty(self, faculty):
        self.member_of_faculties.remove(faculty)
