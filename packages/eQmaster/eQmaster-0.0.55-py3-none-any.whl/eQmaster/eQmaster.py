...
class eQueries:
    ...
    def get_current_quotes(self, _list):
        ...
        bucket = 'ephod-tech.trading-advisor.auto-trade.tw.dumpster'
        prefix = 'stock_tick'
    ...
    def get_ext(self, label):
        if label == 'stock':
            return pandas.read_parquet('s3://ephod-tech.trading-advisor.auto-trade.tw.data/stock_extensions/stock_all.parquet.gzip')
        return None
