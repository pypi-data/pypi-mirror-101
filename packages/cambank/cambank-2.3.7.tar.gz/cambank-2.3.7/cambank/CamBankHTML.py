...
""" % (self.op.oid, strftime('%Y-%m-%d', self.op.odate), float(self.op.omontant)/100, float(self.op.obalance)/100, self.op.olibelle, self.op.odetail, self.op.account, self.op.loadid)
