import click
from ..support_modules.perturbator import branch_insert_process, validate_flow_presence_in_file
...
@click.option('--branch-end', required=True,
              help='ID of the FLOW where the branching starts')
def insert_process_fragment_parallel(insert_to, insert_from, output_file, branch_start, branch_end):
    ...
    branch_insert_process(insert_to, insert_from, branch_start, branch_end, output_file)
