...
[boto3.CostandUsageReportService 1.17.49](https://boto3.amazonaws.com/v1/documentation/api/1.17.49/reference/services/cur.html#CostandUsageReportService) service
compatible with
