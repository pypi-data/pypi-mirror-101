...
# sources: envoy/admin/v3/config_dump.proto, envoy/admin/v3/init_dump.proto, envoy/admin/v3/listeners.proto, envoy/admin/v3/metrics.proto, envoy/admin/v3/mutex_stats.proto, envoy/admin/v3/server_info.proto, envoy/admin/v3/tap.proto
...
class ConfigDump(betterproto.Message):
    ...
    # <envoy_api_msg_admin.v3.BootstrapConfigDump>` * *clusters*:
    # :ref:`ClustersConfigDump <envoy_api_msg_admin.v3.ClustersConfigDump>` *
    # *endpoints*:  :ref:`EndpointsConfigDump
    # <envoy_api_msg_admin.v3.EndpointsConfigDump>` * *listeners*:
    # :ref:`ListenersConfigDump <envoy_api_msg_admin.v3.ListenersConfigDump>` *
    # *routes*:  :ref:`RoutesConfigDump
    # <envoy_api_msg_admin.v3.RoutesConfigDump>` EDS Configuration will only be
    # dumped by using parameter `?include_eds` You can filter output with the
...
class ListenersConfigDump(betterproto.Message):
    ...
    # <envoy_api_field_service.discovery.v3.DiscoveryResponse.version_info>` in
    # the last processed LDS discovery response. If there are only static
...
class ListenersConfigDumpDynamicListenerState(betterproto.Message):
    ...
    # <envoy_api_field_service.discovery.v3.DiscoveryResponse.version_info>`
...
class ClustersConfigDump(betterproto.Message):
    ...
    # This is the :ref:`version_info
    # <envoy_api_field_service.discovery.v3.DiscoveryResponse.version_info>` in
    # the last processed CDS discovery response. If there are only static
