...
# sources: envoy/config/route/v4alpha/route.proto, envoy/config/route/v4alpha/route_components.proto, envoy/config/route/v4alpha/scoped_route.proto
...
class Route(betterproto.Message):
    ...
    metadata: "__core_v4_alpha__.Metadata" = betterproto.message_field(4)
...
class RouteMatch(betterproto.Message):
    ...
    safe_regex: "___type_matcher_v4_alpha__.RegexMatcher" = betterproto.message_field(
    ...
    # semantics.
    runtime_fraction: "__core_v4_alpha__.RuntimeFractionalPercent" = (
        betterproto.message_field(9)
    )
...
class CorsPolicy(betterproto.Message):
    ...
    filter_enabled: "__core_v4_alpha__.RuntimeFractionalPercent" = (
        betterproto.message_field(9, group="enabled_specifier")
    )
    ...
    shadow_enabled: "__core_v4_alpha__.RuntimeFractionalPercent" = (
        betterproto.message_field(10)
    )
...
class RouteAction(betterproto.Message):
    ...
    host_rewrite_path_regex: "___type_matcher_v4_alpha__.RegexMatchAndSubstitute" = (
    ...
    priority: "__core_v4_alpha__.RoutingPriority" = betterproto.enum_field(11)
...
class HeaderMatcher(betterproto.Message):
    ...
    safe_regex_match: "___type_matcher_v4_alpha__.RegexMatcher" = (
        betterproto.message_field(11, group="header_match_specifier")
    )
...
class QueryParameterMatcher(betterproto.Message):
    ...
    string_match: "___type_matcher_v4_alpha__.StringMatcher" = (
        betterproto.message_field(5, group="query_parameter_match_specifier")
    )
...
class Vhds(betterproto.Message):
    ...
    config_source: "__core_v4_alpha__.ConfigSource" = betterproto.message_field(1)
