...
# sources: envoy/config/core/v4alpha/address.proto, envoy/config/core/v4alpha/backoff.proto, envoy/config/core/v4alpha/base.proto, envoy/config/core/v4alpha/config_source.proto, envoy/config/core/v4alpha/event_service_config.proto, envoy/config/core/v4alpha/extension.proto, envoy/config/core/v4alpha/grpc_method_list.proto, envoy/config/core/v4alpha/grpc_service.proto, envoy/config/core/v4alpha/health_check.proto, envoy/config/core/v4alpha/http_uri.proto, envoy/config/core/v4alpha/protocol.proto, envoy/config/core/v4alpha/proxy_protocol.proto, envoy/config/core/v4alpha/socket_option.proto, envoy/config/core/v4alpha/substitution_format_string.proto
...
class BackoffStrategy(betterproto.Message):
    ...
    # <envoy_api_field_config.core.v4alpha.BackoffStrategy.base_interval>` if
...
class Locality(betterproto.Message):
    ...
    # Region this :ref:`zone <envoy_api_field_config.core.v4alpha.Locality.zone>`
    # belongs to.
...
class Node(betterproto.Message):
    ...
    # verification <envoy_api_field_config.core.v4alpha.HealthCheck.HttpHealthChe
    # ck.service_name_matcher>`, :ref:`runtime override directory
    # <envoy_api_msg_config.bootstrap.v4alpha.Runtime>`, :ref:`user agent
    # addition <envoy_api_field_extensions.filters.network.http_connection_manage
    # r.v4alpha.HttpConnectionManager.add_user_agent>`, :ref:`HTTP global rate
    # limiting <config_http_filters_rate_limit>`, :ref:`CDS
    # <config_cluster_manager_cds>`, and :ref:`HTTP tracing
    # <arch_overview_tracing>`, either in this message or via :option:`--service-
    # cluster`.
...
class RetryPolicy(betterproto.Message):
    ...
    # <envoy_api_msg_config.core.v4alpha.BackoffStrategy>`. This parameter is
...
class TransportSocket(betterproto.Message):
    ...
    and :ref:`clusters <envoy_api_msg_config.cluster.v4alpha.Cluster>`. If the
...
class GrpcService(betterproto.Message):
    ...
    <envoy_api_msg_config.core.v4alpha.ApiConfigSource>` and filter
    configurations. [#next-free-field: 6]
    """
...
class GrpcServiceEnvoyGrpc(betterproto.Message):
    ...
    # the :ref:`Cluster <envoy_api_msg_config.cluster.v4alpha.Cluster>`
...
class GrpcServiceGoogleGrpc(betterproto.Message):
    ...
    # :ref:`channel_credentials <envoy_api_field_config.core.v4alpha.GrpcService.
    # GoogleGrpc.channel_credentials>`.
...
class AggregatedConfigSource(betterproto.Message):
    ...
    <envoy_api_msg_config.core.v4alpha.ConfigSource>` can be used to specify
    that ADS is to be used.
    """
...
class SelfConfigSource(betterproto.Message):
    ...
    <envoy_api_msg_config.core.v4alpha.ConfigSource>` can be used to specify
    that other data can be obtained from the same server.
    """
...
class ConfigSource(betterproto.Message):
    ...
    # <envoy_api_msg_extensions.transport_sockets.tls.v4alpha.Secret>`, the
...
class EnvoyInternalAddress(betterproto.Message):
    ...
    # <envoy_api_field_config.listener.v4alpha.Listener.name>` of the destination
    # internal listener.
...
class SocketAddress(betterproto.Message):
    ...
    # <envoy_api_msg_config.listener.v4alpha.FilterChainMatch>`.] When used
    # within an upstream :ref:`BindConfig
    # <envoy_api_msg_config.core.v4alpha.BindConfig>`, the address controls the
    # source address of outbound connections. For :ref:`clusters
    # <envoy_api_msg_config.cluster.v4alpha.Cluster>`, the cluster type
    ...
    # <envoy_api_field_config.core.v4alpha.SocketAddress.resolver_name>`.
    address: str = betterproto.string_field(2)
    port_value: int = betterproto.uint32_field(3, group="port_specifier")
    # This is only valid if :ref:`resolver_name
    # <envoy_api_field_config.core.v4alpha.SocketAddress.resolver_name>` is
...
class BindConfig(betterproto.Message):
    ...
    # <envoy_api_field_config.cluster.v4alpha.UpstreamBindConfig.source_address>`
...
class HttpProtocolOptions(betterproto.Message):
    ...
    # tion_manager.v4alpha.HttpConnectionManager.drain_timeout>`. Note that
    # request based timeouts mean that HTTP/2 PINGs will not keep the connection
    # alive. If not specified, this defaults to 1 hour. To disable idle timeouts
    ...
    # work.http_connection_manager.v4alpha.HttpConnectionManager.drain_timeout>`.
...
class HealthCheck(betterproto.Message):
    ...
    # <envoy_api_msg_config.cluster.v4alpha.Cluster.TransportSocketMatch>` ..
    # code-block:: yaml  transport_socket_matches:  - name: "useMTLS"    match:
    ...
    # <envoy_api_field_config.cluster.v4alpha.Cluster.transport_socket>` will be
...
class HealthCheckHttpHealthCheck(betterproto.Message):
    ...
    # <envoy_api_msg_type.matcher.v4alpha.StringMatcher>`. See the
    # :ref:`architecture overview <arch_overview_health_checking_identity>` for
    # more information.
    service_name_matcher: "___type_matcher_v4_alpha__.StringMatcher" = (
...
class HealthCheckTlsOptions(betterproto.Message):
    ...
    # <envoy_api_msg_config.listener.v4alpha.FilterChainMatch>` along with
