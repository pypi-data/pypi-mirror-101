...
# sources: envoy/extensions/transport_sockets/tls/v3/common.proto, envoy/extensions/transport_sockets/tls/v3/secret.proto
...
class TlsCertificate(betterproto.Message):
    ...
    # :ref:`private_key <envoy_api_field_extensions.transport_sockets.tls.v3.TlsC
    # ertificate.private_key>` field. This can't be marked as ``oneof`` due to
    # API compatibility reasons. Setting both :ref:`private_key <envoy_api_field_
    # extensions.transport_sockets.tls.v3.TlsCertificate.private_key>` and
    # :ref:`private_key_provider <envoy_api_field_extensions.transport_sockets.tl
    # s.v3.TlsCertificate.private_key_provider>` fields will result in an error.
...
class TlsSessionTicketKeys(betterproto.Message):
    ...
    # _field_extensions.transport_sockets.tls.v3.DownstreamTlsContext.session_tic
    # ket_keys>` is not specified, the TLS library will still support resuming
...
class CertificateValidationContext(betterproto.Message):
    ...
    # kets.tls.v3.DownstreamTlsContext.require_client_certificate>`,
    ...
    # .tls.v3.CertificateValidationContext.verify_certificate_hash>`, or
    ...
    # :ref:`verify_certificate_hash <envoy_api_field_extensions.transport_sockets
    # .tls.v3.CertificateValidationContext.verify_certificate_hash>` and
    # :ref:`verify_certificate_spki <envoy_api_field_extensions.transport_sockets
    # .tls.v3.CertificateValidationContext.verify_certificate_spki>` are
    ...
    # sockets.tls.v3.CertificateValidationContext.verify_certificate_hash>`,
    ...
    # ort_sockets.tls.v3.CertificateValidationContext.verify_certificate_hash>`
    # and :ref:`verify_certificate_spki <envoy_api_field_extensions.transport_soc
    # kets.tls.v3.CertificateValidationContext.verify_certificate_spki>` are
    # specified, a hash matching value from either of the lists will result in
    ...
    # in the :ref:`string matcher <envoy_api_msg_type.matcher.v3.StringMatcher>`.
    ...
    # :ref:`trusted_ca   <envoy_api_field_extensions.transport_sockets.tls.v3.Cer
    # tificateValidationContext.trusted_ca>`.
