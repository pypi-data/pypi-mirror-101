...
text_cl.run_code_for_training_with_TEXTnetOrder2_word2vec(model, hidden_size=512)

import pymsgbox
response = pymsgbox.confirm("Finished training.  Start testing on unseen data?")
if response == "OK": 
    text_cl.run_code_for_testing_with_TEXTnetOrder2_word2vec(model, hidden_size=512)
