Linkedin-Auto-Comment is a python library to comment on linkedin post using browser automation. 
It currently runs only on windows.

### Example
In this example we first import library, then we login with cookies and then posted a comment on linkedin.
```sh
from linkedin_auto_comment import *
...
post_link="https://www.linkedin.com/posts/er-chirag-grover-290918101_help-androiddevelopment-flutterappdevelopment-activity-6766960247794937856-2jh3"
linkedin.comment_on_post(post_link=post_link, comment='Please share your resume here abc@gmail.com')
```
...
```sh
pip install linkedin-auto-comment
```
...
### Post comment
```sh
linkedin.comment_on_post(post_link='post link', comment='comment text')
```
