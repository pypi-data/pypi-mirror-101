...
class ArgoRollout(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(ArgoRollout, self, [scope, id, props])
...
class BlueGreenStrategySpecs:
    def __init__(
        ...
        *,
        ...
        anti_affinity: _PodAntiAffinity_afb5a5bc,
    ...
    @builtins.property
    def anti_affinity(self) -> _PodAntiAffinity_afb5a5bc:
        '''
        :stability: experimental
        '''
        result = self._values.get("anti_affinity")
        assert result is not None, "Required property 'anti_affinity' is missing"
        return typing.cast(_PodAntiAffinity_afb5a5bc, result)
