...
class TablesApi(object):
    ...
    def build(self, **kwargs):
        ...
        :param list[str] condition_ids: The IDs of the capsule sets that will be used to create table rows. (required)
        :param list[str] column_definitions: A list of column definitions for the table, where a column definition is: \"formula ON id AS name\" where id and name are optional. If id is supplied, the formula can reference it using the \"$series\" variable (e.g. $series.max()). If id is not supplied the calculation is assumed to act on the capsules that define each row and the formula should reference the \"$capsule\" variable (e.g. $capsule.getStart()).
        :param list[str] sort_orders: A list of sort orders for the table, where a sort order is the column index, starting at 0, followed by a space and a sort direction of either \"asc\" or \"desc\".
