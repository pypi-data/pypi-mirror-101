...
def test_push_to_workbook():
    ...
    workbook = spy.workbooks.pull(pd.DataFrame([{
    ...
    try:
        ...
        # R49 and earlier doesn't prepend the synthetic "All" folder -- this code is different in R50 and later
        assert workbook.path == f'{folder_name} >> test_push_to_workbook'
        ...
        # R49 and earlier doesn't prepend the synthetic "Shared" folder -- this code is different in R50 and later
        assert workbook.path == f'{folder_name} >> test_push_to_workbook'
