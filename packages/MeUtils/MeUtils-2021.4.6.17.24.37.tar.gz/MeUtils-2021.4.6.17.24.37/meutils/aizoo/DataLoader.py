...
if __name__ == '__main__':
    ...
    # tf.get_logger().setLevel(logging.ERROR)  # tf.compat.v1.logging.set_verbosity(tf.compat.v1.logging.ERROR)
    ...
    clf = estimator.BoostedTreesClassifier(
        feature_columns=my_feature_columns,
