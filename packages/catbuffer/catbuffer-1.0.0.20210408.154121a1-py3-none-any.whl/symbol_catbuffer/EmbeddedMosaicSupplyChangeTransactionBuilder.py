...
class EmbeddedMosaicSupplyChangeTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> EmbeddedMosaicSupplyChangeTransactionBuilder:
        ...
        result = EmbeddedMosaicSupplyChangeTransactionBuilder(superObject.signer_public_key, superObject.network)
