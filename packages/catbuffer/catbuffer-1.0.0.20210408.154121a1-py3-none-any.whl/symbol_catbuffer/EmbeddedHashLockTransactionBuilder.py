...
class EmbeddedHashLockTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> EmbeddedHashLockTransactionBuilder:
        ...
        result = EmbeddedHashLockTransactionBuilder(superObject.signer_public_key, superObject.network)
