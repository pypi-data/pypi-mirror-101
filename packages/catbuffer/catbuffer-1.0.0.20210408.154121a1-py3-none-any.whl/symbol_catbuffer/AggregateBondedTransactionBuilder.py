...
class AggregateBondedTransactionBuilder(TransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> AggregateBondedTransactionBuilder:
        ...
        result = AggregateBondedTransactionBuilder(superObject.signer_public_key, superObject.network)
