...
class EmbeddedMosaicAddressRestrictionTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> EmbeddedMosaicAddressRestrictionTransactionBuilder:
        ...
        body = MosaicAddressRestrictionTransactionBodyBuilder.load_from_binary(bytes_)  # kind:CUSTOM1_nonbyte
        bytes_ = bytes_[body.get_size():]

        # create object and call
        result = EmbeddedMosaicAddressRestrictionTransactionBuilder(superObject.signer_public_key, superObject.network)
