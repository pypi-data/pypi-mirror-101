...
class AccountMetadataTransactionBuilder(TransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> AccountMetadataTransactionBuilder:
        ...
        result = AccountMetadataTransactionBuilder(superObject.signer_public_key, superObject.network)
