...
class AccountOperationRestrictionTransactionBuilder(TransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> AccountOperationRestrictionTransactionBuilder:
        ...
        result = AccountOperationRestrictionTransactionBuilder(superObject.signer_public_key, superObject.network)
