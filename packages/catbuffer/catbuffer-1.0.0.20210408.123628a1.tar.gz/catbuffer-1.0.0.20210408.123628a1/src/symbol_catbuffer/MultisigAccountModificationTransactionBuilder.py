...
class MultisigAccountModificationTransactionBuilder(TransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> MultisigAccountModificationTransactionBuilder:
        ...
        result = MultisigAccountModificationTransactionBuilder(superObject.signer_public_key, superObject.network)
