...
class EmbeddedNamespaceMetadataTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> EmbeddedNamespaceMetadataTransactionBuilder:
        ...
        body = NamespaceMetadataTransactionBodyBuilder.load_from_binary(bytes_)  # kind:CUSTOM1_nonbyte
        bytes_ = bytes_[body.get_size():]

        # create object and call
        result = EmbeddedNamespaceMetadataTransactionBuilder(superObject.signer_public_key, superObject.network)
    ...
    def target_namespace_id(self):
        return self.body.target_namespace_id

    @target_namespace_id.setter
    def target_namespace_id(self, target_namespace_id): # MARKER1 AttributeKind.CUSTOM
        self.body.target_namespace_id = target_namespace_id
