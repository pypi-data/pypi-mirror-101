...
class NodeKeyLinkTransactionBuilder(TransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> NodeKeyLinkTransactionBuilder:
        ...
        result = NodeKeyLinkTransactionBuilder(superObject.signer_public_key, superObject.network)
