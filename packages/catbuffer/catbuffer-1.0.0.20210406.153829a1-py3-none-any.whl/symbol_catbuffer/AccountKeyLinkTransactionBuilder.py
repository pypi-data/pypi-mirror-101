...
class AccountKeyLinkTransactionBuilder(TransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> AccountKeyLinkTransactionBuilder:
        ...
        result = AccountKeyLinkTransactionBuilder(superObject.signer_public_key, superObject.network)
