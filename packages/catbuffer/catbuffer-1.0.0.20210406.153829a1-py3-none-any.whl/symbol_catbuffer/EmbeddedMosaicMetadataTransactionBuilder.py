...
class EmbeddedMosaicMetadataTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> EmbeddedMosaicMetadataTransactionBuilder:
        ...
        result = EmbeddedMosaicMetadataTransactionBuilder(superObject.signer_public_key, superObject.network)
