...
class SecretLockTransactionBuilder(TransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> SecretLockTransactionBuilder:
        ...
        result = SecretLockTransactionBuilder(superObject.signer_public_key, superObject.network)
