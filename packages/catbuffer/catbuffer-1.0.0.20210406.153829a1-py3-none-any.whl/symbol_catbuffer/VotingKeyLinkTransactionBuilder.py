...
class VotingKeyLinkTransactionBuilder(TransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> VotingKeyLinkTransactionBuilder:
        ...
        result = VotingKeyLinkTransactionBuilder(superObject.signer_public_key, superObject.network)
