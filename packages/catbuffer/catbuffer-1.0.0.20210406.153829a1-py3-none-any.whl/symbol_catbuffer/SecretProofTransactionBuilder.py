...
class SecretProofTransactionBuilder(TransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> SecretProofTransactionBuilder:
        ...
        result = SecretProofTransactionBuilder(superObject.signer_public_key, superObject.network)
