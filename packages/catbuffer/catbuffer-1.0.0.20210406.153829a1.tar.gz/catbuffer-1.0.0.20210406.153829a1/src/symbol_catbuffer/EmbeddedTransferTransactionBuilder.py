...
class EmbeddedTransferTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> EmbeddedTransferTransactionBuilder:
        ...
        result = EmbeddedTransferTransactionBuilder(superObject.signer_public_key, superObject.network)
