...
class MosaicAliasTransactionBuilder(TransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> MosaicAliasTransactionBuilder:
        ...
        result = MosaicAliasTransactionBuilder(superObject.signer_public_key, superObject.network)
