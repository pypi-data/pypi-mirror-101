...
class EmbeddedVrfKeyLinkTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> EmbeddedVrfKeyLinkTransactionBuilder:
        ...
        body = VrfKeyLinkTransactionBodyBuilder.load_from_binary(bytes_)  # kind:CUSTOM1_nonbyte
        bytes_ = bytes_[body.get_size():]

        # create object and call
        result = EmbeddedVrfKeyLinkTransactionBuilder(superObject.signer_public_key, superObject.network)
