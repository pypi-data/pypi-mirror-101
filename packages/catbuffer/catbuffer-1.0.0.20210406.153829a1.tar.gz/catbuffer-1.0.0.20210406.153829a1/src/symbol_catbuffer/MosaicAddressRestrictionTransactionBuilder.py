...
class MosaicAddressRestrictionTransactionBuilder(TransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> MosaicAddressRestrictionTransactionBuilder:
        ...
        result = MosaicAddressRestrictionTransactionBuilder(superObject.signer_public_key, superObject.network)
