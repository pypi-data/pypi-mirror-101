...
class EmbeddedMosaicDefinitionTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> EmbeddedMosaicDefinitionTransactionBuilder:
        ...
        result = EmbeddedMosaicDefinitionTransactionBuilder(superObject.signer_public_key, superObject.network)
