...
class NamespaceMetadataTransactionBuilder(TransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> NamespaceMetadataTransactionBuilder:
        ...
        result = NamespaceMetadataTransactionBuilder(superObject.signer_public_key, superObject.network)
