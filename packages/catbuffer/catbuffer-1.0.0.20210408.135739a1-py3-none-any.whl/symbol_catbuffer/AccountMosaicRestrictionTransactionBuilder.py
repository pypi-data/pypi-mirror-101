...
class AccountMosaicRestrictionTransactionBuilder(TransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> AccountMosaicRestrictionTransactionBuilder:
        ...
        result = AccountMosaicRestrictionTransactionBuilder(superObject.signer_public_key, superObject.network)
