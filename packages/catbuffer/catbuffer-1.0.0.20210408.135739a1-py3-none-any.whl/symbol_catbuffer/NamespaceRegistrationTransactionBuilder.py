...
class NamespaceRegistrationTransactionBuilder(TransactionBuilder):
    ...
    type_hints = {
        ...
        'id' : 'NamespaceIdDto',
        'registration_type' : 'NamespaceRegistrationTypeDto',
    }
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> NamespaceRegistrationTransactionBuilder:
        ...
        result = NamespaceRegistrationTransactionBuilder(superObject.signer_public_key, superObject.network)
