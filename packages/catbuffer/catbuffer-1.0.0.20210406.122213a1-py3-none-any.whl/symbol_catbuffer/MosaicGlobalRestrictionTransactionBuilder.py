...
class MosaicGlobalRestrictionTransactionBuilder(TransactionBuilder):
    ...
    type_hints = {
        ...
        'previous_restriction_type' : 'MosaicRestrictionTypeDto',
        'new_restriction_type' : 'MosaicRestrictionTypeDto',
    }
    ...
    def loadFromBinary(cls, payload: bytes) -> MosaicGlobalRestrictionTransactionBuilder:
        ...
        result = MosaicGlobalRestrictionTransactionBuilder(superObject.signer_public_key, superObject.network)
