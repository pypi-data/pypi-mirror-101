...
class VrfKeyLinkTransactionBuilder(TransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> VrfKeyLinkTransactionBuilder:
        ...
        result = VrfKeyLinkTransactionBuilder(superObject.signer_public_key, superObject.network)
