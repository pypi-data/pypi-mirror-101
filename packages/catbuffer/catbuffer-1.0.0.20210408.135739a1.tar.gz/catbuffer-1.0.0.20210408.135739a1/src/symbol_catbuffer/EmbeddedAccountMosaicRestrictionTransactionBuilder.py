...
class EmbeddedAccountMosaicRestrictionTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> EmbeddedAccountMosaicRestrictionTransactionBuilder:
        ...
        body = AccountMosaicRestrictionTransactionBodyBuilder.load_from_binary(bytes_)  # kind:CUSTOM1_nonbyte
        bytes_ = bytes_[body.get_size():]

        # create object and call
        result = EmbeddedAccountMosaicRestrictionTransactionBuilder(superObject.signer_public_key, superObject.network)
