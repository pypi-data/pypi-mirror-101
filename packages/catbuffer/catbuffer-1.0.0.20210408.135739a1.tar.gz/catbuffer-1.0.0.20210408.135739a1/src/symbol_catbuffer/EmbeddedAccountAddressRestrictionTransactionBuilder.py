...
class EmbeddedAccountAddressRestrictionTransactionBuilder(EmbeddedTransactionBuilder):
    ...
    @classmethod
    def load_from_binary(cls, payload: bytes) -> EmbeddedAccountAddressRestrictionTransactionBuilder:
        ...
        result = EmbeddedAccountAddressRestrictionTransactionBuilder(superObject.signer_public_key, superObject.network)
