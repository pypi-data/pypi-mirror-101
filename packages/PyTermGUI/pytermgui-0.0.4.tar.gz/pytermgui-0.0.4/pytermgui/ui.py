...
class Container(BaseElement):
    ...
    def __repr__(self):
        ...
        for i,e in enumerate(self.elements):
            ...
            diff = e.height + (1 if isinstance(e,Container) else 0)
            ...
            starty += diff- (0 if isinstance(e,Container) else 1)
    ...
    def _add_element(self,element):
        ...
        # update real_height
        self.real_height += element.height #+ (1 if isinstance(element,Container) else 0)
        self.height += element.height #+ (1 if isinstance(element,Container) else 0)
