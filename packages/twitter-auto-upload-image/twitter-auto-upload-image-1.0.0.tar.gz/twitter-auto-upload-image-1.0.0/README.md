Twitter-Auto-Upload-Image is a python library to post image on twitter using browser automation. 
It currently runs only on windows.

### Example
In this example we first import library, then we login with cookies and then post image on twitter.
```sh
from twitter_auto_upload_image import *
...
twitter.post_image(image_path='C:/Users/image.png', tweet='Good Morning')
```
...
```sh
pip install twitter-auto-upload-image
```
