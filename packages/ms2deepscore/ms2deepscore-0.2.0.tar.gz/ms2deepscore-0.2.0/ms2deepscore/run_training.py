...
import pickle
outfile = os.path.join(path_data, 'GNPS_all', 'ALL_GNPS_positive_train_split_binned.pickle')
with open(outfile, 'rb') as file:
    binned_spectrums_training = pickle.load(file)

outfile = os.path.join(path_data, 'GNPS_all', 'ALL_GNPS_positive_val_split_binned.pickle')
with open(outfile, 'rb') as file:
...
import pickle
outfile = os.path.join(path_data, 'GNPS_all', 'ALL_GNPS_positive_training_spectrum_binner.pickle')
with open(outfile, 'rb') as file:
...
model_output_file = "ms2ds_210210_ALL_GNPS_positive_600_500_500_400.hdf5"
