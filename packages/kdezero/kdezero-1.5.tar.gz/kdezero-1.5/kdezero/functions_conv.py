...
from kdezero.core import Function, as_variable
from kdezero.utils import pair, get_conv_outsize, get_deconv_outsize
...
def deconv2d(x, W, b=None, stride=1, pad=0, out_size=None):
    return Deconv2d(stride, pad, out_size)(x, W, b)
