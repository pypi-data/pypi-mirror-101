...
def define_for_train_loader():
    ...
    train_dataset = LoadDataset(data_dir=config.train_image, transform=train_transform)
...
def define_for_valid_loader():
    ...
    valid_dataset = LoadDataset(data_dir=config.val_image, transform=valid_transform)
