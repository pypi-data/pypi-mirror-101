...
var RuleFormContainer = /** @class */ (function (_super) {
    ...
    RuleFormContainer.prototype.renderBody = function () {
        var _this = this;
        var _a;
        var _b = this.props, organization = _b.organization, ruleId = _b.ruleId, rule = _b.rule, params = _b.params, onSubmitSuccess = _b.onSubmitSuccess, project = _b.project, userTeamIds = _b.userTeamIds;
        ...
        var wizardBuilderChart = function (_a) {
            var footer = _a.footer;
            return (<TriggersChart {...chartProps} header={<ChartHeader>
          ...
          </ChartHeader>} footer={footer}/>);
        };
        var chart = <TriggersChart {...chartProps}/>;
        var ownerId = (_a = rule.owner) === null || _a === void 0 ? void 0 : _a.split(':')[1];
        var canEdit = ownerId ? userTeamIds.has(ownerId) : true;
        ...
        {function (_a) {
            ...
            <Feature organization={organization} features={['alert-wizard']}>
              {function (_a) {
                        ...
                        return hasFeature ? (<List symbol="colored-numeric">
                    <RuleConditionsFormForWizard api={_this.api} projectSlug={params.projectId} organization={organization} disabled={!hasAccess || !canEdit} thresholdChart={wizardBuilderChart} onFilterSearch={_this.handleFilterUpdate} allowChangeEventTypes={dataset === Dataset.ERRORS}/>
                    <StyledListItem>
                    ...
                    <RuleConditionsForm api={_this.api} projectSlug={params.projectId} organization={organization} disabled={!hasAccess || !canEdit} thresholdChart={chart} onFilterSearch={_this.handleFilterUpdate}/>
                    {triggerForm(hasAccess)}
                    {ruleNameOwnerForm(hasAccess)}
                  </React.Fragment>);
                    }}
