...
var TIME_WINDOW_MAP = (_a = {},
    ...
    _a[TimeWindow.FIVE_MINUTES] = t('5 minute'),
    _a[TimeWindow.TEN_MINUTES] = t('10 minute'),
    _a[TimeWindow.FIFTEEN_MINUTES] = t('15 minute'),
    _a[TimeWindow.THIRTY_MINUTES] = t('30 minute'),
    _a[TimeWindow.ONE_HOUR] = t('1 hour'),
    _a[TimeWindow.TWO_HOURS] = t('2 hour'),
    _a[TimeWindow.FOUR_HOURS] = t('4 hour'),
    _a[TimeWindow.ONE_DAY] = t('24 hour'),
    _a);
var RuleConditionsFormForWizard = /** @class */ (function (_super) {
    ...
    RuleConditionsFormForWizard.prototype.render = function () {
        var _a;
        var _b = this.props, organization = _b.organization, disabled = _b.disabled, onFilterSearch = _b.onFilterSearch, allowChangeEventTypes = _b.allowChangeEventTypes;
        ...
        <Panel>
          <StyledPanelBody>
            {this.props.thresholdChart({
                footer: (<ChartFooter>
                  <MetricField name="aggregate" help={null} organization={organization} disabled={disabled} style={__assign({}, formElemBaseStyle)} inline={false} flexibleControlStateSize columnWidth={200} inFieldLabels required/>
                  <FormRowText>{t('Time Interval')}</FormRowText>
                  <Tooltip title={t('Triggers are evaluated every minute regardless of this value.')}>
                    <SelectField name="timeWindow" style={__assign(__assign({}, formElemBaseStyle), { flex: 1, minWidth: 130 })} choices={Object.entries(TIME_WINDOW_MAP)} required isDisabled={disabled} getValue={function (value) { return Number(value); }} setValue={function (value) { return "" + value; }} inline={false} flexibleControlStateSize/>
                  </Tooltip>
                </ChartFooter>),
            })}
          </StyledPanelBody>
...
var ChartFooter = styled(FormRow)(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n  margin: 0;\n"], ["\n  margin: 0;\n"])));
var FormRowText = styled('div')(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n  padding: ", ";\n  /* Match the height of the select controls */\n  line-height: 36px;\n"], ["\n  padding: ", ";\n  /* Match the height of the select controls */\n  line-height: 36px;\n"])), space(0.5));
