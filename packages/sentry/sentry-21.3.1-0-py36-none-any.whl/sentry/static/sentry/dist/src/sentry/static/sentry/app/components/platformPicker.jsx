import { __decorate, __extends, __makeTemplateObject, __read, __rest, __spreadArray } from "tslib";
...
var PLATFORM_CATEGORIES = __spreadArray(__spreadArray([], __read(categoryList)), [{ id: 'all', name: t('All') }]);
