...
import { aggregateOutputType, generateFieldAsString, getAggregateAlias, isAggregateField, isLegalYAxisType, } from './fields';
...
var EventView = /** @class */ (function () {
    ...
    EventView.prototype.getYAxisOptions = function () {
        ...
        return uniqBy(this.getAggregateFields()
            ...
            .filter(function (field) { return isLegalYAxisType(aggregateOutputType(field.field)); })
