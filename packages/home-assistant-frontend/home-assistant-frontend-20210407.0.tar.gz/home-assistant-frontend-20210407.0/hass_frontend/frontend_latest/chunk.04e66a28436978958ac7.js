...
`,E=(e,t,r)=>{const i=getComputedStyle(t).getPropertyValue(`--weather-icon-${e}`);return i?n.dy`
  ...
  ${p.has(e)?n.YP`
    ...
    `}},{kind:"method",key:"renderEntity",value:function(e){var t;const r=this.hass.states[e.entity];return r?i.dy`
      ...
      >
        ...
        ${this._config.show_state&&!1!==e.show_state?i.dy`
              <div>
                ${"sensor"!==(0,c.M)(e.entity)||"timestamp"!==r.attributes.device_class||h.V_.includes(r.state)?e.show_last_changed?(0,s.Z)(new Date(r.last_changed),this.hass.localize):(0,l.D)(this.hass.localize,r,this.hass.locale):i.dy`
        ...
        <div class="content">
          ...
          <div id="info">
            ${u.V_.includes(e.state)?n.dy`
                  <div>
                    ${(0,l.D)(this.hass.localize,e,this.hass.locale)}
                  </div>
                `:n.dy`
    ...
    `}}]}}),i.oi)}}]);
//# sourceMappingURL=chunk.04e66a28436978958ac7.js.map