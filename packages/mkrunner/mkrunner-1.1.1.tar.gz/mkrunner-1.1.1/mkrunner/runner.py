...
class mkrunner(object):
    ...
    def __run_step_request(self, step: TStep) -> StepData:
        ...
        if USE_ALLURE:
                import json
                allure.attach(json.dumps(parsed_request_dict, ensure_ascii=False), "request", allure.attachment_type.JSON)
                allure.attach(json.dumps(resp.json(),ensure_ascii=False), "response", allure.attachment_type.JSON)
