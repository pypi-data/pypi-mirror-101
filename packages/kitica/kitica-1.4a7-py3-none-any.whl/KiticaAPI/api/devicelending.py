...
class DeviceLending(Service):
    ...
    args = {
        ...
        'testCase': fields.Str(required=False),
        'testResult': fields.Str(required=False),
    ...
    def get(self,
        ...
        currentTestCase : str, optional
            The Test case the device will be used to run.
    ...
    @use_kwargs(args)
    def post(self, deviceId, testResult=''):
        ...
        device : json
            ...
            successful.
        """
        response = self.return_device(deviceId, testResult)
        socketio.emit('update', {'data': 'device was updated'})
        return response
