...
class vectoritkImageCD4(collections.abc.MutableSequence):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    iterator = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_iterator)
    def __iter__(self):
        return self.iterator()
    __nonzero__ = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4___nonzero__)
    __bool__ = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4___bool__)
    __len__ = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4___len__)
    __getslice__ = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4___getslice__)
    __setslice__ = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4___setslice__)
    __delslice__ = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4___delslice__)
    __delitem__ = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4___delitem__)
    __getitem__ = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4___getitem__)
    __setitem__ = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4___setitem__)
    pop = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_pop)
    append = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_append)
    empty = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_empty)
    size = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_size)
    swap = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_swap)
    begin = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_begin)
    end = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_end)
    rbegin = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_rbegin)
    rend = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_rend)
    clear = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_clear)
    get_allocator = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_get_allocator)
    pop_back = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_pop_back)
    erase = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_erase)
    ...
    def __init__(self, *args):
        ...
        """
        _itkPhaseCorrelationOperatorPython.vectoritkImageCD4_swiginit(self, _itkPhaseCorrelationOperatorPython.new_vectoritkImageCD4(*args))
    push_back = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_push_back)
    front = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_front)
    back = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_back)
    assign = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_assign)
    resize = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_resize)
    insert = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_insert)
    reserve = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_reserve)
    capacity = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_capacity)
    __swig_destroy__ = _itkPhaseCorrelationOperatorPython.delete_vectoritkImageCD4

# Register vectoritkImageCD4 in _itkPhaseCorrelationOperatorPython:
_itkPhaseCorrelationOperatorPython.vectoritkImageCD4_swigregister(vectoritkImageCD4)
...
class itkImageCD4(itk.itkImagePython.itkImageBase4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkPhaseCorrelationOperatorPython.itkImageCD4___New_orig__)
    Clone = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageCD4_Clone)
    Allocate = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageCD4_Allocate)
    FillBuffer = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageCD4_FillBuffer)
    SetPixel = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageCD4_SetPixel)
    GetPixel = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageCD4_GetPixel)
    GetBufferPointer = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageCD4_GetBufferPointer)
    GetPixelContainer = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageCD4_GetPixelContainer)
    SetPixelContainer = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageCD4_SetPixelContainer)
    Graft = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageCD4_Graft)
    GetPixelAccessor = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageCD4_GetPixelAccessor)
    GetNeighborhoodAccessor = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageCD4_GetNeighborhoodAccessor)
    __swig_destroy__ = _itkPhaseCorrelationOperatorPython.delete_itkImageCD4
    cast = _swig_new_static_method(_itkPhaseCorrelationOperatorPython.itkImageCD4_cast)
...
# Register itkImageCD4 in _itkPhaseCorrelationOperatorPython:
_itkPhaseCorrelationOperatorPython.itkImageCD4_swigregister(itkImageCD4)
itkImageCD4___New_orig__ = _itkPhaseCorrelationOperatorPython.itkImageCD4___New_orig__
itkImageCD4_cast = _itkPhaseCorrelationOperatorPython.itkImageCD4_cast
...
class itkImageSourceICD4(itk.ITKCommonBasePython.itkProcessObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    GetOutput = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageSourceICD4_GetOutput)
    GraftOutput = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageSourceICD4_GraftOutput)
    GraftNthOutput = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageSourceICD4_GraftNthOutput)
    MakeOutput = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageSourceICD4_MakeOutput)
    __swig_destroy__ = _itkPhaseCorrelationOperatorPython.delete_itkImageSourceICD4
    cast = _swig_new_static_method(_itkPhaseCorrelationOperatorPython.itkImageSourceICD4_cast)

# Register itkImageSourceICD4 in _itkPhaseCorrelationOperatorPython:
_itkPhaseCorrelationOperatorPython.itkImageSourceICD4_swigregister(itkImageSourceICD4)
itkImageSourceICD4_cast = _itkPhaseCorrelationOperatorPython.itkImageSourceICD4_cast
...
class itkImageToImageFilterICD4ICD4(itkImageSourceICD4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    SetInput = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageToImageFilterICD4ICD4_SetInput)
    GetInput = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageToImageFilterICD4ICD4_GetInput)
    PushBackInput = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageToImageFilterICD4ICD4_PushBackInput)
    PopBackInput = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageToImageFilterICD4ICD4_PopBackInput)
    PushFrontInput = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageToImageFilterICD4ICD4_PushFrontInput)
    PopFrontInput = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageToImageFilterICD4ICD4_PopFrontInput)
    SetCoordinateTolerance = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageToImageFilterICD4ICD4_SetCoordinateTolerance)
    GetCoordinateTolerance = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageToImageFilterICD4ICD4_GetCoordinateTolerance)
    SetDirectionTolerance = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageToImageFilterICD4ICD4_SetDirectionTolerance)
    GetDirectionTolerance = _swig_new_instance_method(_itkPhaseCorrelationOperatorPython.itkImageToImageFilterICD4ICD4_GetDirectionTolerance)
    __swig_destroy__ = _itkPhaseCorrelationOperatorPython.delete_itkImageToImageFilterICD4ICD4
    cast = _swig_new_static_method(_itkPhaseCorrelationOperatorPython.itkImageToImageFilterICD4ICD4_cast)

# Register itkImageToImageFilterICD4ICD4 in _itkPhaseCorrelationOperatorPython:
_itkPhaseCorrelationOperatorPython.itkImageToImageFilterICD4ICD4_swigregister(itkImageToImageFilterICD4ICD4)
itkImageToImageFilterICD4ICD4_cast = _itkPhaseCorrelationOperatorPython.itkImageToImageFilterICD4ICD4_cast
...
class itkPhaseCorrelationOperatorD4(itkImageToImageFilterICD4ICD4):
...
def image_to_image_filter_init_docstring():
    ...
    filter_class = itk.Montage.ImageToImageFilter
...
def image_source_init_docstring():
    ...
    filter_class = itk.Montage.ImageSource
