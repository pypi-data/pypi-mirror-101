...
r"""
   ...
   ⋅         /context/ 123
   ⋅
   ⋅     .read_variables["context"] will contain (str)"123"
   ⋅
   ⋅     Variable names DO NOT contain space; variable value may
...
class ETR:
    ...
    def _init_parsingtoolsdef(self,
        ...
        """
                ...
                lors de la lecture (=à la volée, pendant _read/_read2)
initialisation de .parsingtools[]
        """
    ...
    def _parse_read_line(self,
        ...
        if self._parse_read_line__variable(line, fals):
            # yes, it was a variable definition: this line doesn't have to be yielded.
            return None, None

        # ---- is there a new tag definition ? --------------------------------
        if self._parse_read_line__tag(line, fals):
            # yes, it was a variable definition: this line doesn't have to be yielded.
            return None, None
    ...
    def _parse_read_line__variable(self,
        ...
        if variable:
            res = True
            if variable.group("value") is None or variable.group("value").strip() == "":
            ...
            self.read_variables[variable.group("name")] = variable.group("value")
