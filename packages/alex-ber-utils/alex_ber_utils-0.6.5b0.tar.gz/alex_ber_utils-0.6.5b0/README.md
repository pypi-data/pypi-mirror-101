...
```bash
python3 -m pip uninstall --yes alex_ber_utils
python3 setup.py clean sdist bdist_wheel
python3 -m pip install --find-links=./dist alex_ber_utils

python38 -m pip uninstall --yes alex_ber_utils
python38 setup.py clean sdist bdist_wheel
python38 -m pip install --find-links=./dist alex_ber_utils==0.6.5b0
