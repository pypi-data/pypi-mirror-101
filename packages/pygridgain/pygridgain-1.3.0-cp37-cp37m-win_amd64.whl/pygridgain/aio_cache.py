...
class AioCache(BaseCache):
    ...
    :py:meth:`~pygridgain.aio_client.AioClient.create_cache`,
    :py:meth:`~pygridgain.aio_client.AioClient.get_or_create_cache` or
    :py:meth:`~pygridgain.aio_client.AioClient.get_cache` methods instead. See
