...
from .constants import DEFAULT_HOST, DEFAULT_PORT, PROTOCOL_BYTE_ORDER, AFFINITY_RETRIES, AFFINITY_DELAY
from .datatypes import BinaryObject, AnyDataObject
from .datatypes.base import GridGainDataType
...
class Client(BaseClient):
    ...
    def get_best_node(
            self, cache: Union[int, str, 'BaseCache'], key: Any = None, key_hint: 'GridGainDataType' = None
    ) -> 'Connection':
        """
