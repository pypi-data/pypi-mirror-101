...
setup(
 ...
 '      * `port`: the TCP port to connect on, default 995 for TLS/SSL or 110 '    
 'for cleartext\n'    
 '      * `sni_host`: the TLS/SSL SNI server name, which may be different from '    
 'the `tcp_host`\n'    
 '\n'    
 ...
 '        typically an ssh port forward to a remote private cleartext POP '    
 'service,\n'    
 '        logging in as `username`\n'    
 '      * `username@localhost!mail.example.com:1995`:\n'    
 '        use cleartext to connect to `localhost:1995`,\n'    
 '        usually an ssh port forward to a remote private TLS/SSL POP '    
 'service,\n'    
