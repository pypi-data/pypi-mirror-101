...
"""
# pylint: disable=C0301,C0103,W0622,R0912,R0904,R0913,R0914,R0915
import os
...
def _origin_date_offset(to_df):
    ...
    if nJD == 2018:#2018 date system, 0 at 00:00 on Jan 1 2018
        return 2458119.5 if to_df else -2458119.5
