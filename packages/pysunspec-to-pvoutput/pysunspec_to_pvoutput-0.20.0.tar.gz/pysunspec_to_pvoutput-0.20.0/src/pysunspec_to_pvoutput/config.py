...
from pysunspec_read.schema import ConnectOptionsSchema, OutputOptionsSchema, BaseSchema, PathField
...
def load_config(config_path: Path) -> Config:
    ...
    config.pvoutput_publish_options = PvOutputOptionsSchema().load(yaml_conf.get("pvoutput_publish_options"), partial=True)
