...
from treform.spelling.spelling_error_correction_upgraded import SpellingErrorCorrection
    ...
    def __call__(self, *args, **kwargs):
        ...
        with detection_graph.as_default() as default_graph:
            ...
            with tf.compat.v1.Session() as sess:
                ...
                loader = tf.compat.v1.train.import_meta_graph('/home/bible/treform/spelling_training/models/spelling_error_correction/spelling_error_correction_model.sentences=3.window_size=10.noise_rate=0.1.n_hidden=100/model.meta')
                loader.restore(sess, tf.compat.v1.latest_checkpoint(model_path))
                ...
                vals = tf.train.list_variables(tf.train.latest_checkpoint('/home/bible/treform/spelling_training/models/spelling_error_correction/spelling_error_correction_model.sentences=3.window_size=10.noise_rate=0.1.n_hidden=100/'))
                print(vals)
