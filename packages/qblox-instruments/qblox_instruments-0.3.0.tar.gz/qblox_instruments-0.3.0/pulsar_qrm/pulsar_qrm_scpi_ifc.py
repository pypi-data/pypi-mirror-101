    ...
    def __init__(self, transport_inst, debug = 0):
        ...
        if self._debug == 0:
            try:
                ...
                build_ref = "fwVersion=0.4.0 fwBuild=25/03/2021-06:22:30 fwHash=0x5D532ECC fwDirty=0 kmodVersion=0.4.0 kmodBuild=25/03/2021-06:22:30 kmodHash=0x5D532ECC kmodDirty=0 swVersion=0.4.0 swBuild=25/03/2021-06:22:30 swHash=0x5D532ECC swDirty=0"
                if build != build_ref:
                    build     = re.split(' |=', build)
                    build_ref = re.split(' |=', build_ref)
                    raise Exception("Error: pulsar_qrm_scpi_ifc version is not compatible with device version:\n" + \
                                    "\n" + \
