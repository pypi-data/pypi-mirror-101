    ...
    def __init__(self, transport_inst, debug = 0):
        ...
        if self._debug == 0:
            try:
                ...
                build_ref = "fwVersion=0.5.0 fwBuild=24/03/2021-13:45:16 fwHash=0xAA640F9F fwDirty=0 kmodVersion=0.5.0 kmodBuild=24/03/2021-13:45:16 kmodHash=0xAA640F9F kmodDirty=0 swVersion=0.5.0 swBuild=24/03/2021-13:45:16 swHash=0xAA640F9F swDirty=0"
                if build != build_ref:
