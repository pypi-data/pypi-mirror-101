...
from .files import filename_ends_with_json
...
def read_with_clean(connect_options: ConnectOptions, output_options: OutputOptions) -> str:
    ...
    if output_options.save_reading:
        ...
        if not filename_ends_with_json(output_options.output_file_path):
            output_options.output_file_path = Path(output_options.output_file_path, "reading.json")
