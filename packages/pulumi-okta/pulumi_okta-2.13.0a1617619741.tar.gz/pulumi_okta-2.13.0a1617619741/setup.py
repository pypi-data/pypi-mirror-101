...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', '2.13.0-alpha.1617619741+1ae740dc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta 2.13.0-alpha.1617619741+1ae740dc`
                """)
            else:
                raise
