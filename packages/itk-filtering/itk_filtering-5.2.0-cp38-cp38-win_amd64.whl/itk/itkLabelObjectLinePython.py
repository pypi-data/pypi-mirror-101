...
class itkLabelObjectLine4(object):
    ...
    SetIndex = _swig_new_instance_method(_itkLabelObjectLinePython.itkLabelObjectLine4_SetIndex)
    GetIndex = _swig_new_instance_method(_itkLabelObjectLinePython.itkLabelObjectLine4_GetIndex)
    SetLength = _swig_new_instance_method(_itkLabelObjectLinePython.itkLabelObjectLine4_SetLength)
    GetLength = _swig_new_instance_method(_itkLabelObjectLinePython.itkLabelObjectLine4_GetLength)
    HasIndex = _swig_new_instance_method(_itkLabelObjectLinePython.itkLabelObjectLine4_HasIndex)
    IsNextIndex = _swig_new_instance_method(_itkLabelObjectLinePython.itkLabelObjectLine4_IsNextIndex)
    Print = _swig_new_instance_method(_itkLabelObjectLinePython.itkLabelObjectLine4_Print)
