...
VERSION = datetime.today().strftime('%Y.%m.%d')+'a'
...
EXTRAS = {
    ...
    'cuda110': [f'cupy-cuda111=={CUPY_VERSION}', ],
    'cuda102': [f'cupy-cuda111=={CUPY_VERSION}', ],
    'cuda101': [f'cupy-cuda111=={CUPY_VERSION}', ],
    'cuda100': [f'cupy-cuda111=={CUPY_VERSION}', ],
}
