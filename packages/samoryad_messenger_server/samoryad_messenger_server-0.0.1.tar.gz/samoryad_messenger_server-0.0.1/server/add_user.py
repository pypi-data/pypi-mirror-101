...
class RegisterUser(QDialog):
    ...
    def __init__(self, database, server):
        ...
        self.setFixedSize(213, 183)
        self.setModal(True)
        self.setAttribute(Qt.WA_DeleteOnClose)

        self.label_username = QLabel('Введите имя пользователя:', self)
        self.label_username.move(10, 10)
        self.label_username.setFixedSize(170, 15)

        self.client_name = QLineEdit(self)
        self.client_name.setFixedSize(194, 20)
        ...
        self.client_passwd.setFixedSize(194, 20)
        ...
        self.client_conf.setFixedSize(194, 20)
