...
class NFEnv(gym.Env):
    ...
    def __init__(self,show_gui=False,fall_rew=-1000.0,motion_rew=0,time_rew=0,height_rew=1.0,rand_force=None,mp4_path=None,foot_friction=1):
        self.step_counter = 0
        if show_gui:
            mode=p.GUI
        else:
    ...
    def reset(self):
        ...
        try:
            ...
            self.bot_id = p.loadURDF("/content/drive/My Drive/bot/bot11.urdf", cubeStartPos, cubeStartOrientation)
        ...
        for i in range(20):
            print(i)
            p.changeDynamics(self.bot_id, i, lateralFriction=self.foot_friction)
