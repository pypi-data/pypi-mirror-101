...
def mesh_wing(wing):
    ...
    if len(wing.wing_cross_sections) > 2:
        ...
        # Vertically stack the first normalized section quarter chord, and the last
        # normalized section quarter chord.
        cross_sections_local_normal = np.vstack(
            (
                section_quarter_chords_proj_yz_norm[0, :],
                section_quarter_chords_proj_yz_norm[-1, :],
    ...
    for section_num in range(len(wing.wing_cross_sections) - 1):
        ...
        # Loop through the empty section panels matrix and create a new panel object
        # in each slot.
        ...
        # This section's panel matrix is stack horizontally, to the right of the
        # wing's panel matrix.
        ...
        if wing.symmetric:
            ...
            # Loop through the empty section panels matrix and create a new panel
            # object in each slot.
            for chordwise_position in range(num_chordwise_panels):
                for spanwise_position in range(num_spanwise_panels):
            ...
            # This section's panel matrix is stack horizontally, to the left of the
            # wing's panel matrix.
