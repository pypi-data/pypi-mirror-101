...
def dla_34(pretrained=False, **kwargs):
    model = DLA(
        levels=(1, 1, 1, 2, 2, 1),
...
def dla_46_c(pretrained=False, **kwargs):
    model = DLA(
        levels=(1, 1, 1, 2, 2, 1),
...
def dla_46x_c(pretrained=False, **kwargs):
    model = DLA(
        levels=(1, 1, 1, 2, 2, 1),
        channels=(16, 32, 64, 64, 128, 256),
        block=DlaBottleneck,
...
def dla_60x_c(pretrained=False, **kwargs):
    model = DLA(
        levels=(1, 1, 1, 2, 3, 1),
        channels=(16, 32, 64, 64, 128, 256),
        block=DlaBottleneck,
...
def dla_60(pretrained=False, **kwargs):
    model = DLA(
        levels=(1, 1, 1, 2, 3, 1),
...
def dla_60x(pretrained=False, **kwargs):
    model = DLA(
        levels=(1, 1, 1, 2, 3, 1),
        channels=(16, 32, 128, 256, 512, 1024),
        block=DlaBottleneck,
...
def dla_102(pretrained=False, **kwargs):
    model = DLA(
        levels=(1, 1, 1, 3, 4, 1),
        channels=(16, 32, 128, 256, 512, 1024),
        block=DlaBottleneck,
...
def dla_102x(pretrained=False, **kwargs):
    model = DLA(
        levels=(1, 1, 1, 3, 4, 1),
        channels=(16, 32, 128, 256, 512, 1024),
        block=DlaBottleneck,
...
def dla_102x2(pretrained=False, **kwargs):
    model = DLA(
        levels=(1, 1, 1, 3, 4, 1),
        channels=(16, 32, 128, 256, 512, 1024),
        block=DlaBottleneck,
...
def dla_169(pretrained=False, **kwargs):
    model = DLA(
        levels=(1, 1, 2, 3, 5, 1),
        channels=(16, 32, 128, 256, 512, 1024),
        block=DlaBottleneck,
