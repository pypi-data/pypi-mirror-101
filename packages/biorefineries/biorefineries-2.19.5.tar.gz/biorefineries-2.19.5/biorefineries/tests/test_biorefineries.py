...
def test_corn():
    ...
    tea = module.corn_tea
    units = UnitGroup('Biorefinery', tea.units)
    assert np.allclose(tea.IRR, 0.039517726426300984, rtol=1e-2)
    ...
    assert np.allclose(tea.installed_equipment_cost, 67233071.8912951, rtol=1e-2)
    assert np.allclose(tea.utility_cost, 8247788.996095207, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 98.28626797545293, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 103.39995970438198, rtol=1e-2)
...
def test_lipidcane():
    ...
    units = UnitGroup('Biorefinery', tea.units)
    assert np.allclose(tea.IRR, 0.20259411072613762, rtol=1e-2)
    assert np.allclose(feedstock.price, 0.03455, rtol=1e-2)
    assert np.allclose(product.price, 0.789, rtol=1e-2)
    assert np.allclose(tea.sales, 108167304.73481971, rtol=1e-2)
    assert np.allclose(tea.material_cost, 61706814.36344768, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 207118997.7059105, rtol=1e-2)
    assert np.allclose(tea.utility_cost, -24479356.172526166, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 227.78977065457084, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 215.67747251070844, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 9.04949963500663, rtol=1e-2)
    assert np.allclose(units.get_electricity_production(), 87.50897454694947, rtol=1e-2)
    bst.process_tools.default()
...
def test_cornstover():
    ...
    assert np.allclose(product.price, 0.7392880795412653, rtol=1e-2)
    assert np.allclose(tea.sales, 135063914.2493784, rtol=1e-2)
    assert np.allclose(tea.material_cost, 85228633.06968293, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 215035844.8854254, rtol=1e-2)
    assert np.allclose(tea.utility_cost, -11468483.120072812, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 307.7827202919676, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 354.17669427442786, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 23.271786013594273, rtol=1e-2)
    assert np.allclose(units.get_electricity_production(), 47.11334288248572, rtol=1e-2)
    bst.process_tools.default()
...
def test_sugarcane():
    ...
    units = UnitGroup('Biorefinery', tea.units)
    assert np.allclose(tea.IRR, 0.11747002619566663, rtol=1e-2)
    assert np.allclose(feedstock.price, 0.03455, rtol=1e-2)
    assert np.allclose(product.price, 0.789, rtol=1e-2)
    assert np.allclose(tea.sales, 86988832.10763392, rtol=1e-2)
    assert np.allclose(tea.material_cost, 59808168.519397505, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 176154071.16043076, rtol=1e-2)
    assert np.allclose(tea.utility_cost, -12167089.996099468, rtol=1e-2)
    assert np.allclose(units.get_heating_duty(), 252.13421061060077, rtol=1e-2)
    assert np.allclose(units.get_cooling_duty(), 221.87964648244164, rtol=1e-2)
    assert np.allclose(units.get_electricity_consumption(), 9.31260886963292, rtol=1e-2)
...
def test_LAOs():
    ...
    assert np.allclose(product.price, 1.2902775937900404, rtol=1e-2)
    assert np.allclose(tea.sales, 156712021.86927858, rtol=1e-2)
    assert np.allclose(tea.material_cost, 135661164.88724265, rtol=1e-2)
    assert np.allclose(tea.installed_equipment_cost, 46121167.04750812, rtol=1e-2)
    assert np.allclose(tea.utility_cost, 777422.23492239, rtol=1e-2)
    ...
    assert np.allclose(units.get_electricity_production(), 3.6356480724025113, rtol=1e-2)
    bst.process_tools.default()
