...
class BottleClient:
    ...
    def kb_analysis_progress(self): #, nodes: List = None) -> List[Dict[str, Any]]:
        """
        ...
        response = requests.get(f'{self.url}kb/analysis-progress', verify=self.secure, json=[], headers=self.headers).json()
        return response

    def set_target_class(self, target_class: str = None, nodes: List = None) -> List:
