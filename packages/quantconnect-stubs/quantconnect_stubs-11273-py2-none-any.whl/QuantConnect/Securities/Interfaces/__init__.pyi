...
class IContinuousContractModel(metaclass=abc.ABCMeta):
    ...
    def GetContinuousData(self, dateTime: datetime.date) -> System.Collections.Generic.IEnumerator[QuantConnect.Data.BaseData]:
        """
    ...
    def GetCurrentSymbol(self, dateTime: datetime.date) -> QuantConnect.Symbol:
        """
