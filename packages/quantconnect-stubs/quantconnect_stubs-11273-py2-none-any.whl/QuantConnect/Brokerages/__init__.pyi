...
class SymbolPropertiesDatabaseSymbolMapper(System.Object, QuantConnect.Brokerages.ISymbolMapper):
    ...
    def GetLeanSymbol(self, brokerageSymbol: str, securityType: QuantConnect.SecurityType, market: str, expirationDate: datetime.date = ..., strike: float = 0, optionRight: QuantConnect.OptionRight = ...) -> QuantConnect.Symbol:
        """
        Converts a brokerage symbol to a Lean symbol instance
...
class IConnectionHandler(System.IDisposable, metaclass=abc.ABCMeta):
    ...
    def KeepAlive(self, lastDataReceivedTime: datetime.date) -> None:
        """
