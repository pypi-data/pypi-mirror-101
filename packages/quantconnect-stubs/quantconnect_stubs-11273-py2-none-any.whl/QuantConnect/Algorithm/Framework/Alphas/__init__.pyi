...
class InsightScore(System.Object):
    ...
    @typing.overload
    def __init__(self, direction: float, magnitude: float, updatedTimeUtc: datetime.date) -> None:
        """
...
class Insight(System.Object):
    ...
    def IsExpired(self, utcTime: datetime.date) -> bool:
        """
    ...
    def IsActive(self, utcTime: datetime.date) -> bool:
        """
    ...
    @typing.overload
    def __init__(self, generatedTimeUtc: datetime.date, symbol: typing.Union[QuantConnect.Symbol, str], period: datetime.timedelta, type: QuantConnect.Algorithm.Framework.Alphas.InsightType, direction: QuantConnect.Algorithm.Framework.Alphas.InsightDirection, magnitude: typing.Optional[float], confidence: typing.Optional[float], sourceModel: str = None, weight: typing.Optional[float] = None) -> None:
        """
        Initializes a new instance of the Insight class.
    ...
    @staticmethod
    @typing.overload
    def Price(symbol: typing.Union[QuantConnect.Symbol, str], closeTimeLocal: datetime.date, direction: QuantConnect.Algorithm.Framework.Alphas.InsightDirection, magnitude: typing.Optional[float] = None, confidence: typing.Optional[float] = None, sourceModel: str = None, weight: typing.Optional[float] = None) -> QuantConnect.Algorithm.Framework.Alphas.Insight:
        """
        Creates a new insight for predicting the percent change in price over the specified period
    ...
    @staticmethod
    @typing.overload
    def ComputeCloseTime(exchangeHours: QuantConnect.Securities.SecurityExchangeHours, generatedTimeUtc: datetime.date, resolution: QuantConnect.Resolution, barCount: int) -> datetime.datetime:
        """
    ...
    @staticmethod
    @typing.overload
    def ComputeCloseTime(exchangeHours: QuantConnect.Securities.SecurityExchangeHours, generatedTimeUtc: datetime.date, period: datetime.timedelta) -> datetime.datetime:
        """
    ...
    @staticmethod
    def ComputePeriod(exchangeHours: QuantConnect.Securities.SecurityExchangeHours, generatedTimeUtc: datetime.date, closeTimeUtc: datetime.date) -> datetime.timedelta:
        """
...
class ConstantAlphaModel(QuantConnect.Algorithm.Framework.Alphas.AlphaModel):
    ...
    def ShouldEmitInsight(self, utcTime: datetime.date, symbol: typing.Union[QuantConnect.Symbol, str]) -> bool:
        """
...
class GeneratedInsightsCollection(System.Object):
    ...
    def __init__(self, dateTimeUtc: datetime.date, insights: System.Collections.Generic.IEnumerable[QuantConnect.Algorithm.Framework.Alphas.Insight], clone: bool = True) -> None:
        """
...
class InsightCollection(System.Object, System.Collections.Generic.ICollection[QuantConnect.Algorithm.Framework.Alphas.Insight], typing.Iterable[QuantConnect.Algorithm.Framework.Alphas.Insight]):
    ...
    def GetActiveInsights(self, utcTime: datetime.date) -> System.Collections.Generic.ICollection[QuantConnect.Algorithm.Framework.Alphas.Insight]:
        """
    ...
    def HasActiveInsights(self, symbol: typing.Union[QuantConnect.Symbol, str], utcTime: datetime.date) -> bool:
        """
    ...
    def RemoveExpiredInsights(self, utcTime: datetime.date) -> System.Collections.Generic.ICollection[QuantConnect.Algorithm.Framework.Alphas.Insight]:
        """
