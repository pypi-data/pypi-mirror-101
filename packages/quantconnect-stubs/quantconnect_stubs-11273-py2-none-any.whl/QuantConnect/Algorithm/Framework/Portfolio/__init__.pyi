...
class PortfolioConstructionModelPythonWrapper(QuantConnect.Algorithm.Framework.Portfolio.PortfolioConstructionModel):
    ...
    def IsRebalanceDue(self, insights: typing.List[QuantConnect.Algorithm.Framework.Alphas.Insight], algorithmUtc: datetime.date) -> bool:
        """
...
class PortfolioConstructionModel(System.Object, QuantConnect.Algorithm.Framework.Portfolio.IPortfolioConstructionModel):
    ...
    def RefreshRebalance(self, algorithmUtc: datetime.date) -> None:
        """
...
class ReturnsSymbolData(System.Object):
    ...
    def Add(self, time: datetime.date, value: float) -> None:
        """
    ...
    def Update(self, time: datetime.date, value: float) -> bool:
        """
