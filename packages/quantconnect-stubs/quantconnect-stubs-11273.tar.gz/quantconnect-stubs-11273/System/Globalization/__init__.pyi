...
class Calendar(System.Object, System.ICloneable, metaclass=abc.ABCMeta):
    ...
    def AddMilliseconds(self, time: datetime.date, milliseconds: float) -> datetime.datetime:
        """
    ...
    def AddDays(self, time: datetime.date, days: int) -> datetime.datetime:
        """
    ...
    def AddHours(self, time: datetime.date, hours: int) -> datetime.datetime:
        """
        Returns the DateTime resulting from adding a fractional number of
    ...
    def AddMinutes(self, time: datetime.date, minutes: int) -> datetime.datetime:
        """
        Returns the DateTime resulting from adding a fractional number of
    ...
    def AddMonths(self, time: datetime.date, months: int) -> datetime.datetime:
        """
        Returns the DateTime resulting from adding the given number of
    ...
    def AddSeconds(self, time: datetime.date, seconds: int) -> datetime.datetime:
        """
    ...
    def AddWeeks(self, time: datetime.date, weeks: int) -> datetime.datetime:
        ...

    def AddYears(self, time: datetime.date, years: int) -> datetime.datetime:
        """
        Returns the DateTime resulting from adding the given number of
    ...
    def GetDayOfMonth(self, time: datetime.date) -> int:
        """
    ...
    def GetDayOfWeek(self, time: datetime.date) -> int:
        """
    ...
    def GetDayOfYear(self, time: datetime.date) -> int:
        """
    ...
    def GetEra(self, time: datetime.date) -> int:
        """Returns the era for the specified DateTime value."""
        ...

    def GetHour(self, time: datetime.date) -> int:
        ...

    def GetMilliseconds(self, time: datetime.date) -> float:
        ...

    def GetMinute(self, time: datetime.date) -> int:
        ...

    def GetMonth(self, time: datetime.date) -> int:
        ...
    ...
    def GetSecond(self, time: datetime.date) -> int:
        ...

    def GetWeekOfYear(self, time: datetime.date, rule: System.Globalization.CalendarWeekRule, firstDayOfWeek: System.DayOfWeek) -> int:
        """
    ...
    def GetYear(self, time: datetime.date) -> int:
        """
...
class EastAsianLunisolarCalendar(System.Globalization.Calendar, metaclass=abc.ABCMeta):
    ...
    def GetSexagenaryYear(self, time: datetime.date) -> int:
...
class ISOWeek(System.Object):
    ...
    @staticmethod
    def GetWeekOfYear(date: datetime.date) -> int:
        ...

    @staticmethod
    def GetYear(date: datetime.date) -> int:
        ...
...
class DaylightTime(System.Object):
    ...
    def __init__(self, start: datetime.date, end: datetime.date, delta: datetime.timedelta) -> None:
        ...
