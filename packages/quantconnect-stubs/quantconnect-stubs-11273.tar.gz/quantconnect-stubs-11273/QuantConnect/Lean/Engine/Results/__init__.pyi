...
class BaseResultsHandler(System.Object, metaclass=abc.ABCMeta):
    ...
    def GetServerStatistics(self, utcNow: datetime.date) -> System.Collections.Generic.Dictionary[str, str]:
        """
    ...
    def StoreOrderEvents(self, utcTime: datetime.date, orderEvents: System.Collections.Generic.List[QuantConnect.Orders.OrderEvent]) -> None:
        """
    ...
    @typing.overload
    def Sample(self, time: datetime.date, force: bool = False) -> None:
        """
    ...
    def SampleEquity(self, time: datetime.date, value: float) -> None:
        """
    ...
    def SamplePerformance(self, time: datetime.date, value: float) -> None:
        """
    ...
    def SampleBenchmark(self, time: datetime.date, value: float) -> None:
        """
    ...
    @typing.overload
    def Sample(self, chartName: str, seriesName: str, seriesIndex: int, seriesType: QuantConnect.SeriesType, time: datetime.date, value: float, unit: str = "$") -> None:
        """
