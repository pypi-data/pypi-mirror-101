...
class Crisis(System.Object):
    ...
    def __init__(self, name: str, start: datetime.date, end: datetime.date) -> None:
        """
    ...
    @typing.overload
    def ToString(self, start: datetime.date, end: datetime.date) -> str:
        """
...
class DrawdownPeriod(System.Object):
    ...
    def __init__(self, start: datetime.date, end: datetime.date, drawdown: float) -> None:
        """
...
class PointInTimePortfolio(System.Object):
    ...
    @typing.overload
    def __init__(self, portfolio: QuantConnect.Report.PointInTimePortfolio, time: datetime.date) -> None:
        """
...
class PortfolioLooper(System.Object, System.IDisposable):
    ...
    @staticmethod
    def GetHistory(symbols: System.Collections.Generic.List[QuantConnect.Symbol], start: datetime.date, end: datetime.date, resolution: QuantConnect.Resolution) -> System.Collections.Generic.IEnumerable[QuantConnect.Data.Slice]:
        """
