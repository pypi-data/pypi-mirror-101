...
class IDateRule(metaclass=abc.ABCMeta):
    ...
    def GetDates(self, start: datetime.date, end: datetime.date) -> System.Collections.Generic.IEnumerable[datetime.datetime]:
        """
...
class ScheduledEvent(System.Object, System.IDisposable):
    ...
    @typing.overload
    def __init__(self, name: str, eventUtcTime: datetime.date, callback: typing.Callable[[str, datetime.datetime], None] = None) -> None:
        """
    ...
    def OnEventFired(self, triggerTime: datetime.date) -> None:
        """
...
class IFluentSchedulingDateSpecifier(metaclass=abc.ABCMeta):
    ...
    @typing.overload
    def On(self, *dates: datetime.date) -> QuantConnect.Scheduling.IFluentSchedulingTimeSpecifier:
...
class DateRules(System.Object):
    ...
    @typing.overload
    def On(self, *dates: datetime.date) -> QuantConnect.Scheduling.IDateRule:
        """
