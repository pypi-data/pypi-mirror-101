...
class Prices(System.Object):
    ...
    @typing.overload
    def __init__(self, endTime: datetime.date, bar: QuantConnect.Data.Market.IBar) -> None:
        """
    ...
    @typing.overload
    def __init__(self, endTime: datetime.date, current: float, open: float, high: float, low: float, close: float) -> None:
        """
