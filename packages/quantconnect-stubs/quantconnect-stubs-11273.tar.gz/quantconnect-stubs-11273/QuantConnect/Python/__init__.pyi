...
class VolatilityModelPythonWrapper(QuantConnect.Securities.Volatility.BaseVolatilityModel):
    ...
    def GetHistoryRequirements(self, security: QuantConnect.Securities.Security, utcTime: datetime.date) -> System.Collections.Generic.IEnumerable[QuantConnect.Data.HistoryRequest]:
        """
...
class DataConsolidatorPythonWrapper(System.Object, QuantConnect.Data.Consolidators.IDataConsolidator):
    ...
    def Scan(self, currentLocalTime: datetime.date) -> None:
        """
