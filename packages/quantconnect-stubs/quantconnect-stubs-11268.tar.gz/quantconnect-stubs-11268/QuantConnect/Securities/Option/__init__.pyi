...
class OptionSymbol(System.Object):
    ...
    @staticmethod
    def IsOptionContractExpired(symbol: typing.Union[QuantConnect.Symbol, str], currentTimeUtc: datetime.date) -> bool:
        """
...
class OptionStrategies(System.Object):
    ...
    @staticmethod
    def BearCallSpread(canonicalOption: typing.Union[QuantConnect.Symbol, str], leg1Strike: float, leg2Strike: float, expiration: datetime.date) -> QuantConnect.Securities.Option.OptionStrategy:
        """
    ...
    @staticmethod
    def BearPutSpread(canonicalOption: typing.Union[QuantConnect.Symbol, str], leg1Strike: float, leg2Strike: float, expiration: datetime.date) -> QuantConnect.Securities.Option.OptionStrategy:
        """
    ...
    @staticmethod
    def BullCallSpread(canonicalOption: typing.Union[QuantConnect.Symbol, str], leg1Strike: float, leg2Strike: float, expiration: datetime.date) -> QuantConnect.Securities.Option.OptionStrategy:
        """
    ...
    @staticmethod
    def BullPutSpread(canonicalOption: typing.Union[QuantConnect.Symbol, str], leg1Strike: float, leg2Strike: float, expiration: datetime.date) -> QuantConnect.Securities.Option.OptionStrategy:
        """
    ...
    @staticmethod
    def Straddle(canonicalOption: typing.Union[QuantConnect.Symbol, str], strike: float, expiration: datetime.date) -> QuantConnect.Securities.Option.OptionStrategy:
        """
    ...
    @staticmethod
    def Strangle(canonicalOption: typing.Union[QuantConnect.Symbol, str], leg1Strike: float, leg2Strike: float, expiration: datetime.date) -> QuantConnect.Securities.Option.OptionStrategy:
        """
    ...
    @staticmethod
    def CallButterfly(canonicalOption: typing.Union[QuantConnect.Symbol, str], leg1Strike: float, leg2Strike: float, leg3Strike: float, expiration: datetime.date) -> QuantConnect.Securities.Option.OptionStrategy:
        """
    ...
    @staticmethod
    def PutButterfly(canonicalOption: typing.Union[QuantConnect.Symbol, str], leg1Strike: float, leg2Strike: float, leg3Strike: float, expiration: datetime.date) -> QuantConnect.Securities.Option.OptionStrategy:
        """
    ...
    @staticmethod
    def CallCalendarSpread(canonicalOption: typing.Union[QuantConnect.Symbol, str], strike: float, expiration1: datetime.date, expiration2: datetime.date) -> QuantConnect.Securities.Option.OptionStrategy:
        """
    ...
    @staticmethod
    def PutCalendarSpread(canonicalOption: typing.Union[QuantConnect.Symbol, str], strike: float, expiration1: datetime.date, expiration2: datetime.date) -> QuantConnect.Securities.Option.OptionStrategy:
        """
