...
class TradierBrokerage(QuantConnect.Brokerages.Brokerage, QuantConnect.Interfaces.IDataQueueHandler, QuantConnect.Interfaces.IDataQueueUniverseProvider, QuantConnect.Interfaces.IHistoryProvider):
    ...
    def GetTimeSeries(self, symbol: str, start: datetime.date, end: datetime.date, interval: QuantConnect.Brokerages.Tradier.TradierTimeSeriesIntervals) -> System.Collections.Generic.List[QuantConnect.Brokerages.Tradier.TradierTimeSeries]:
        """Get the historical bars for this period"""
        ...

    def GetHistoricalData(self, symbol: str, start: datetime.date, end: datetime.date, interval: QuantConnect.Brokerages.Tradier.TradierHistoricalDataIntervals = ...) -> System.Collections.Generic.List[QuantConnect.Brokerages.Tradier.TradierHistoryBar]:
