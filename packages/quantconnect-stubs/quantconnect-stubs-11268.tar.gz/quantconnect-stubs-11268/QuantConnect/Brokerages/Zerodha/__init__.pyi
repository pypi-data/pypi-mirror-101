...
class Kite(System.Object):
    ...
    def GetHistoricalData(self, InstrumentToken: str, FromDate: datetime.date, ToDate: datetime.date, Interval: str, Continuous: bool = False, OI: bool = False) -> System.Collections.Generic.List[QuantConnect.Brokerages.Zerodha.Messages.Historical]:
        """
