...
class OandaBrokerage(QuantConnect.Brokerages.Brokerage, QuantConnect.Interfaces.IDataQueueHandler):
    ...
    def DownloadTradeBars(self, symbol: typing.Union[QuantConnect.Symbol, str], startTimeUtc: datetime.date, endTimeUtc: datetime.date, resolution: QuantConnect.Resolution, requestedTimeZone: typing.Any) -> System.Collections.Generic.IEnumerable[QuantConnect.Data.Market.TradeBar]:
        """
    ...
    def DownloadQuoteBars(self, symbol: typing.Union[QuantConnect.Symbol, str], startTimeUtc: datetime.date, endTimeUtc: datetime.date, resolution: QuantConnect.Resolution, requestedTimeZone: typing.Any) -> System.Collections.Generic.IEnumerable[QuantConnect.Data.Market.QuoteBar]:
        """
...
class OandaSymbolMapper(System.Object, QuantConnect.Brokerages.ISymbolMapper):
    ...
    def GetLeanSymbol(self, brokerageSymbol: str, securityType: QuantConnect.SecurityType, market: str, expirationDate: datetime.date = ..., strike: float = 0, optionRight: QuantConnect.OptionRight = 0) -> QuantConnect.Symbol:
        """
