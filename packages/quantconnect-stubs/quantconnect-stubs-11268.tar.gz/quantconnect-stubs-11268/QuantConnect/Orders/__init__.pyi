...
class TimeInForce(System.Object, QuantConnect.Interfaces.ITimeInForceHandler, metaclass=abc.ABCMeta):
    ...
    @staticmethod
    def GoodTilDate(expiry: datetime.date) -> QuantConnect.Orders.TimeInForce:
...
class OrderRequest(System.Object, metaclass=abc.ABCMeta):
    ...
    def __init__(self, time: datetime.date, orderId: int, tag: str) -> None:
        """
...
class UpdateOrderRequest(QuantConnect.Orders.OrderRequest):
    ...
    def __init__(self, time: datetime.date, orderId: int, fields: QuantConnect.Orders.UpdateOrderFields) -> None:
        """
...
class SubmitOrderRequest(QuantConnect.Orders.OrderRequest):
    ...
    @typing.overload
    def __init__(self, orderType: QuantConnect.Orders.OrderType, securityType: QuantConnect.SecurityType, symbol: typing.Union[QuantConnect.Symbol, str], quantity: float, stopPrice: float, limitPrice: float, triggerPrice: float, time: datetime.date, tag: str, properties: QuantConnect.Interfaces.IOrderProperties = None) -> None:
        """
    ...
    @typing.overload
    def __init__(self, orderType: QuantConnect.Orders.OrderType, securityType: QuantConnect.SecurityType, symbol: typing.Union[QuantConnect.Symbol, str], quantity: float, stopPrice: float, limitPrice: float, time: datetime.date, tag: str, properties: QuantConnect.Interfaces.IOrderProperties = None) -> None:
        """
        Initializes a new instance of the SubmitOrderRequest class.
        The OrderRequest.OrderId will default to OrderResponseErrorCode.UnableToFindOrder
...
class Order(System.Object, metaclass=abc.ABCMeta):
    ...
    @typing.overload
    def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], quantity: float, time: datetime.date, tag: str = ..., properties: QuantConnect.Interfaces.IOrderProperties = None) -> None:
        """
...
class LimitIfTouchedOrder(QuantConnect.Orders.Order):
    ...
    @typing.overload
    def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], quantity: float, triggerPrice: typing.Optional[float], limitPrice: float, time: datetime.date, tag: str = ..., properties: QuantConnect.Interfaces.IOrderProperties = None) -> None:
        """
...
class LimitOrder(QuantConnect.Orders.Order):
    ...
    @typing.overload
    def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], quantity: float, limitPrice: float, time: datetime.date, tag: str = ..., properties: QuantConnect.Interfaces.IOrderProperties = None) -> None:
        """
...
class OrderEvent(System.Object):
    ...
    @typing.overload
    def __init__(self, orderId: int, symbol: typing.Union[QuantConnect.Symbol, str], utcTime: datetime.date, status: QuantConnect.Orders.OrderStatus, direction: QuantConnect.Orders.OrderDirection, fillPrice: float, fillQuantity: float, orderFee: QuantConnect.Orders.Fees.OrderFee, message: str = ...) -> None:
        """
    ...
    @typing.overload
    def __init__(self, order: QuantConnect.Orders.Order, utcTime: datetime.date, orderFee: QuantConnect.Orders.Fees.OrderFee, message: str = ...) -> None:
        """
...
class StopMarketOrder(QuantConnect.Orders.Order):
    ...
    @typing.overload
    def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], quantity: float, stopPrice: float, time: datetime.date, tag: str = ..., properties: QuantConnect.Interfaces.IOrderProperties = None) -> None:
        """
...
class StopLimitOrder(QuantConnect.Orders.Order):
    ...
    @typing.overload
    def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], quantity: float, stopPrice: float, limitPrice: float, time: datetime.date, tag: str = ..., properties: QuantConnect.Interfaces.IOrderProperties = None) -> None:
        """
        New Stop Market Order constructor -
