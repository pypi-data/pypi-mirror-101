...
class IApi(System.IDisposable, metaclass=abc.ABCMeta):
    ...
    def ReadDataLink(self, symbol: typing.Union[QuantConnect.Symbol, str], resolution: QuantConnect.Resolution, date: datetime.date) -> QuantConnect.Api.Link:
        """
    ...
    def DownloadData(self, symbol: typing.Union[QuantConnect.Symbol, str], resolution: QuantConnect.Resolution, date: datetime.date) -> bool:
        """
...
class IAlgorithm(QuantConnect.Interfaces.ISecurityInitializerProvider, QuantConnect.Interfaces.IAccountCurrencyProvider, metaclass=abc.ABCMeta):
    ...
    def SetDateTime(self, time: datetime.date) -> None:
        """Set the DateTime Frontier: This is the master time and is"""
        ...

    def SetStartDate(self, start: datetime.date) -> None:
        """
    ...
    def SetEndDate(self, end: datetime.date) -> None:
        """
...
class IBrokerageCashSynchronizer(metaclass=abc.ABCMeta):
    ...
    def ShouldPerformCashSync(self, currentTimeUtc: datetime.date) -> bool:
        """
    ...
    def PerformCashSync(self, algorithm: QuantConnect.Interfaces.IAlgorithm, currentTimeUtc: datetime.date, getTimeSinceLastFill: typing.Callable[[], datetime.timedelta]) -> bool:
        """
...
class IShortableProvider(metaclass=abc.ABCMeta):
    ...
    def AllShortableSymbols(self, localTime: datetime.date) -> System.Collections.Generic.Dictionary[QuantConnect.Symbol, int]:
        """
    ...
    def ShortableQuantity(self, symbol: typing.Union[QuantConnect.Symbol, str], localTime: datetime.date) -> typing.Optional[int]:
        """
