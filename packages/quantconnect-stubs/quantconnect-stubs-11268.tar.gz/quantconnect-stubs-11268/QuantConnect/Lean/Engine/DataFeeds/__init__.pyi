...
class RealTimeScheduleEventService(System.Object, System.IDisposable):
    ...
    def ScheduleEvent(self, dueTime: datetime.timedelta, utcNow: datetime.date) -> None:
        """
...
class SubscriptionData(System.Object):
    ...
    def __init__(self, data: QuantConnect.Data.BaseData, emitTimeUtc: datetime.date) -> None:
        """
...
class UniverseSelection(System.Object):
    ...
    def ApplyUniverseSelection(self, universe: QuantConnect.Data.UniverseSelection.Universe, dateTimeUtc: datetime.date, universeData: QuantConnect.Data.UniverseSelection.BaseDataCollection) -> QuantConnect.Data.UniverseSelection.SecurityChanges:
        """
    ...
    def AddPendingInternalDataFeeds(self, utcStart: datetime.date) -> bool:
        """
...
class TimeSliceFactory(System.Object):
    ...
    def CreateTimePulse(self, utcDateTime: datetime.date) -> QuantConnect.Lean.Engine.DataFeeds.TimeSlice:
        """
    ...
    def Create(self, utcDateTime: datetime.date, data: System.Collections.Generic.List[QuantConnect.Lean.Engine.DataFeeds.DataFeedPacket], changes: QuantConnect.Data.UniverseSelection.SecurityChanges, universeData: System.Collections.Generic.Dictionary[QuantConnect.Data.UniverseSelection.Universe, QuantConnect.Data.UniverseSelection.BaseDataCollection]) -> QuantConnect.Lean.Engine.DataFeeds.TimeSlice:
        """
...
class LiveSynchronizer(QuantConnect.Lean.Engine.DataFeeds.Synchronizer):
    ...
    def GetPulseDueTime(self, now: datetime.date) -> int:
        """
...
class SubscriptionFrontierTimeProvider(System.Object, QuantConnect.ITimeProvider):
    ...
    def __init__(self, utcNow: datetime.date, subscriptionManager: QuantConnect.Lean.Engine.DataFeeds.IDataFeedSubscriptionManager) -> None:
        """
...
class ZipEntryNameSubscriptionDataSourceReader(System.Object, QuantConnect.Lean.Engine.DataFeeds.ISubscriptionDataSourceReader):
    ...
    def __init__(self, config: QuantConnect.Data.SubscriptionDataConfig, date: datetime.date, isLiveMode: bool) -> None:
        """
...
class CollectionSubscriptionDataSourceReader(System.Object, QuantConnect.Lean.Engine.DataFeeds.ISubscriptionDataSourceReader):
    ...
    def __init__(self, dataCacheProvider: QuantConnect.Interfaces.IDataCacheProvider, config: QuantConnect.Data.SubscriptionDataConfig, date: datetime.date, isLiveMode: bool) -> None:
        """
...
class BacktestingFutureChainProvider(System.Object, QuantConnect.Interfaces.IFutureChainProvider):
    ...
    def GetFutureContractList(self, symbol: typing.Union[QuantConnect.Symbol, str], date: datetime.date) -> System.Collections.Generic.IEnumerable[QuantConnect.Symbol]:
        """
...
class BacktestingOptionChainProvider(System.Object, QuantConnect.Interfaces.IOptionChainProvider):
    ...
    def GetOptionContractList(self, underlyingSymbol: typing.Union[QuantConnect.Symbol, str], date: datetime.date) -> System.Collections.Generic.IEnumerable[QuantConnect.Symbol]:
        """
...
class PrecalculatedSubscriptionData(QuantConnect.Lean.Engine.DataFeeds.SubscriptionData):
    ...
    def __init__(self, configuration: QuantConnect.Data.SubscriptionDataConfig, rawData: QuantConnect.Data.BaseData, normalizedData: QuantConnect.Data.BaseData, normalizationMode: QuantConnect.DataNormalizationMode, emitTimeUtc: datetime.date) -> None:
        """
...
class CreateStreamReaderErrorEventArgs(System.EventArgs):
    ...
    def __init__(self, date: datetime.date, source: QuantConnect.Data.SubscriptionDataSource) -> None:
        """
...
class ManualTimeProvider(System.Object, QuantConnect.ITimeProvider):
    ...
    @typing.overload
    def __init__(self, currentTime: datetime.date, setCurrentTimeTimeZone: typing.Any = None) -> None:
        """
    ...
    def SetCurrentTimeUtc(self, time: datetime.date) -> None:
        """
    ...
    def SetCurrentTime(self, time: datetime.date) -> None:
        """
...
class CachingOptionChainProvider(System.Object, QuantConnect.Interfaces.IOptionChainProvider):
    ...
    def GetOptionContractList(self, symbol: typing.Union[QuantConnect.Symbol, str], date: datetime.date) -> System.Collections.Generic.IEnumerable[QuantConnect.Symbol]:
        """
        Gets the list of option contracts for a given underlying symbol
