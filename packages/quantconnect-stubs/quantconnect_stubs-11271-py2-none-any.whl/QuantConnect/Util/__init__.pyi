...
class LeanDataPathComponents(System.Object):
    ...
    def __init__(self, securityType: QuantConnect.SecurityType, market: str, resolution: QuantConnect.Resolution, symbol: typing.Union[QuantConnect.Symbol, str], filename: str, date: datetime.date, tickType: QuantConnect.TickType) -> None:
...
class LeanData(System.Object):
    ...
    @staticmethod
    @typing.overload
    def GenerateZipFilePath(dataDirectory: str, symbol: typing.Union[QuantConnect.Symbol, str], date: datetime.date, resolution: QuantConnect.Resolution, tickType: QuantConnect.TickType) -> str:
        """Generates the full zip file path rooted in the"""
        ...

    @staticmethod
    @typing.overload
    def GenerateZipFilePath(dataDirectory: str, symbol: str, securityType: QuantConnect.SecurityType, market: str, date: datetime.date, resolution: QuantConnect.Resolution) -> str:
        """Generates the full zip file path rooted in the"""
        ...
    ...
    @staticmethod
    @typing.overload
    def GenerateRelativeZipFilePath(symbol: typing.Union[QuantConnect.Symbol, str], date: datetime.date, resolution: QuantConnect.Resolution, tickType: QuantConnect.TickType) -> str:
        """Generates the relative zip file path rooted in the /Data directory"""
        ...

    @staticmethod
    @typing.overload
    def GenerateRelativeZipFilePath(symbol: str, securityType: QuantConnect.SecurityType, market: str, date: datetime.date, resolution: QuantConnect.Resolution) -> str:
        """Generates the relative zip file path rooted in the /Data directory"""
        ...

    @staticmethod
    def GenerateZipEntryName(symbol: typing.Union[QuantConnect.Symbol, str], date: datetime.date, resolution: QuantConnect.Resolution, tickType: QuantConnect.TickType) -> str:
        """Generate's the zip entry name to hold the specified data."""
        ...

    @staticmethod
    @typing.overload
    def GenerateZipFileName(symbol: typing.Union[QuantConnect.Symbol, str], date: datetime.date, resolution: QuantConnect.Resolution, tickType: QuantConnect.TickType) -> str:
        """Generates the zip file name for the specified date of data."""
        ...

    @staticmethod
    @typing.overload
    def GenerateZipFileName(symbol: str, securityType: QuantConnect.SecurityType, date: datetime.date, resolution: QuantConnect.Resolution, tickType: typing.Optional[QuantConnect.TickType] = None) -> str:
    ...
    @staticmethod
    def TryParsePath(fileName: str, symbol: typing.Optional[typing.Union[QuantConnect.Symbol, str]], date: typing.Optional[datetime.date], resolution: typing.Optional[QuantConnect.Resolution]) -> typing.Union[bool, typing.Union[QuantConnect.Symbol, str], datetime.date, QuantConnect.Resolution]:
        """
