...
class ScheduledEventFactory(System.Object):
    ...
    @staticmethod
    def EveryAlgorithmEndOfDay(algorithm: QuantConnect.Interfaces.IAlgorithm, resultHandler: QuantConnect.Lean.Engine.Results.IResultHandler, start: datetime.date, end: datetime.date, endOfDayDelta: datetime.timedelta, currentUtcTime: typing.Optional[datetime.datetime] = None) -> QuantConnect.Scheduling.ScheduledEvent:
        """
    ...
    @staticmethod
    def EverySecurityEndOfDay(algorithm: QuantConnect.Interfaces.IAlgorithm, resultHandler: QuantConnect.Lean.Engine.Results.IResultHandler, security: QuantConnect.Securities.Security, start: datetime.date, end: datetime.date, endOfDayDelta: datetime.timedelta, currentUtcTime: typing.Optional[datetime.datetime] = None) -> QuantConnect.Scheduling.ScheduledEvent:
        """
        Creates a new ScheduledEvent that will fire before market close by the specified time
...
class BaseRealTimeHandler(System.Object, QuantConnect.Scheduling.IEventSchedule, metaclass=abc.ABCMeta):
    ...
    def Setup(self, start: datetime.date, end: datetime.date, language: QuantConnect.Language, currentUtcTime: typing.Optional[datetime.datetime] = None) -> None:
        """
    ...
    def AddAlgorithmEndOfDayEvent(self, start: datetime.date, end: datetime.date, currentUtcTime: typing.Optional[datetime.datetime] = None) -> None:
        """
        Creates a new ScheduledEvent that will fire before market close by the specified time
    ...
    def AddSecurityDependentEndOfDayEvents(self, securities: System.Collections.Generic.IEnumerable[QuantConnect.Securities.Security], start: datetime.date, end: datetime.date, currentUtcTime: typing.Optional[datetime.datetime] = None) -> None:
        """
...
class IRealTimeHandler(QuantConnect.Scheduling.IEventSchedule, metaclass=abc.ABCMeta):
    ...
    def SetTime(self, time: datetime.date) -> None:
        """
    ...
    def ScanPastEvents(self, time: datetime.date) -> None:
        """
