...
class IBaseData(metaclass=abc.ABCMeta):
    ...
    @typing.overload
    def Reader(self, config: QuantConnect.Data.SubscriptionDataConfig, line: str, date: datetime.date, dataFeed: QuantConnect.DataFeedEndpoint) -> QuantConnect.Data.BaseData:
        """
    ...
    def GetSource(self, config: QuantConnect.Data.SubscriptionDataConfig, date: datetime.date, datafeed: QuantConnect.DataFeedEndpoint) -> str:
        """
...
class Slice(QuantConnect.ExtendedDictionary[typing.Any], System.Collections.Generic.IEnumerable[System.Collections.Generic.KeyValuePair[QuantConnect.Symbol, QuantConnect.Data.BaseData]], typing.Iterable[System.Collections.Generic.KeyValuePair[QuantConnect.Symbol, QuantConnect.Data.BaseData]]):
    ...
    @typing.overload
    def __init__(self, time: datetime.date, data: System.Collections.Generic.IEnumerable[QuantConnect.Data.BaseData]) -> None:
        """
    ...
    @typing.overload
    def __init__(self, time: datetime.date, data: System.Collections.Generic.List[QuantConnect.Data.BaseData]) -> None:
        """
        Initializes a new instance of the Slice class, lazily
        instantiating the Slice.Bars and Slice.Ticks
        collections on demand
...
class BaseDataRequest(System.Object, metaclass=abc.ABCMeta):
    ...
    def __init__(self, startTimeUtc: datetime.date, endTimeUtc: datetime.date, exchangeHours: QuantConnect.Securities.SecurityExchangeHours, tickType: QuantConnect.TickType) -> None:
        """
...
class HistoryRequest(QuantConnect.Data.BaseDataRequest):
    ...
    @typing.overload
    def __init__(self, config: QuantConnect.Data.SubscriptionDataConfig, hours: QuantConnect.Securities.SecurityExchangeHours, startTimeUtc: datetime.date, endTimeUtc: datetime.date) -> None:
        """
...
class HistoryRequestFactory(System.Object):
    ...
    def CreateHistoryRequest(self, subscription: QuantConnect.Data.SubscriptionDataConfig, startAlgoTz: datetime.date, endAlgoTz: datetime.date, exchangeHours: QuantConnect.Securities.SecurityExchangeHours, resolution: typing.Optional[QuantConnect.Resolution]) -> QuantConnect.Data.HistoryRequest:
        """
...
class IndexedBaseData(QuantConnect.Data.BaseData, metaclass=abc.ABCMeta):
    ...
    def GetSourceForAnIndex(self, config: QuantConnect.Data.SubscriptionDataConfig, date: datetime.date, index: str, isLiveMode: bool) -> QuantConnect.Data.SubscriptionDataSource:
        """
