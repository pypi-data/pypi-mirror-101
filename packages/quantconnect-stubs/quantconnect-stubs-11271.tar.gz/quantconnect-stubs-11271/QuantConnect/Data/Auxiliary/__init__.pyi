...
class MapFileRow(System.Object, System.IEquatable[QuantConnect_Data_Auxiliary_MapFileRow]):
    ...
    @typing.overload
    def __init__(self, date: datetime.date, mappedSymbol: str, primaryExchange: str = ...) -> None:
        """Initializes a new instance of the MapFileRow class."""
        ...

    @typing.overload
    def __init__(self, date: datetime.date, mappedSymbol: str, primaryExchange: QuantConnect.PrimaryExchange) -> None:
        """Initializes a new instance of the MapFileRow class."""
        ...
...
class FactorFileRow(System.Object):
    ...
    def __init__(self, date: datetime.date, priceFactor: float, splitFactor: float, referencePrice: float = 0) -> None:
...
class MapFile(System.Object, System.Collections.Generic.IEnumerable[QuantConnect.Data.Auxiliary.MapFileRow], typing.Iterable[QuantConnect.Data.Auxiliary.MapFileRow]):
    ...
    def GetMappedSymbol(self, searchDate: datetime.date, defaultReturnValue: str = ...) -> str:
        """
    ...
    def HasData(self, date: datetime.date) -> bool:
...
class MapFileResolver(System.Object, System.Collections.Generic.IEnumerable[QuantConnect.Data.Auxiliary.MapFile], typing.Iterable[QuantConnect.Data.Auxiliary.MapFile]):
    ...
    def ResolveMapFile(self, symbol: str, date: datetime.date) -> QuantConnect.Data.Auxiliary.MapFile:
        """
...
class FactorFile(System.Object, System.Collections.Generic.IEnumerable[QuantConnect.Data.Auxiliary.FactorFileRow], typing.Iterable[QuantConnect.Data.Auxiliary.FactorFileRow]):
    ...
    def GetPriceScaleFactor(self, searchDate: datetime.date) -> float:
        """Gets the price scale factor that includes dividend and split adjustments for the specified search date"""
        ...

    def GetSplitFactor(self, searchDate: datetime.date) -> float:
        """Gets the split factor to be applied at the specified date"""
        ...

    def GetScalingFactors(self, searchDate: datetime.date) -> QuantConnect.Data.Auxiliary.FactorFileRow:
    ...
    def HasDividendEventOnNextTradingDay(self, date: datetime.date, priceFactorRatio: typing.Optional[float], referencePrice: typing.Optional[float]) -> typing.Union[bool, float, float]:
        """
    ...
    def HasSplitEventOnNextTradingDay(self, date: datetime.date, splitFactor: typing.Optional[float], referencePrice: typing.Optional[float]) -> typing.Union[bool, float, float]:
        """
