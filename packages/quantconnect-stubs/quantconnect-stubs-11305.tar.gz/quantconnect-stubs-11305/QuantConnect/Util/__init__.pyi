...
class LinqExtensions(System.Object):
    ...
    @staticmethod
    def DoForEach(source: System.Collections.Generic.IEnumerable[QuantConnect_Util_LinqExtensions_DoForEach_T], action: typing.Callable[[], QuantConnect_Util_LinqExtensions_DoForEach_T]) -> None:
        """
...
class Ref(typing.Generic[QuantConnect_Util_Ref_T], System.Object, QuantConnect.Util.IReadOnlyRef[QuantConnect_Util_Ref_T]):
    ...
    @staticmethod
    @typing.overload
    def Create(getter: typing.Callable[[], QuantConnect_Util_Ref_Create_T], setter: typing.Callable[[], QuantConnect_Util_Ref_Create_T]) -> QuantConnect.Util.Ref[QuantConnect_Util_Ref_Create_T]:
...
class CircularQueue(typing.Generic[QuantConnect_Util_CircularQueue_T], System.Object):
    ...
    @property
    def CircleCompleted(self) -> typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]:
        """Fired when we do a full circle"""
        ...

    @CircleCompleted.setter
    def CircleCompleted(self, value: typing.List[typing.Callable[[typing.Optional[typing.Any], System.EventArgs], None]]):
        """Fired when we do a full circle"""
        ...
...
class PythonUtil(System.Object):
    ...
    @staticmethod
    @typing.overload
    def ToAction(pyObject: typing.Any) -> typing.Callable[[], QuantConnect_Util_PythonUtil_ToAction_T1]:
        """
    ...
    @staticmethod
    @typing.overload
    def ToAction(pyObject: typing.Any) -> typing.Callable[[QuantConnect_Util_PythonUtil_ToAction_T1], QuantConnect_Util_PythonUtil_ToAction_T2]:
        """
