...
class BacktestResultPacket(QuantConnect.Packets.Packet):
    ...
    @typing.overload
    def __init__(self, job: QuantConnect.Packets.BacktestNodePacket, results: QuantConnect.Packets.BacktestResult, endDate: datetime.date, startDate: datetime.date, progress: float = 1) -> None:
        """
...
class MarketHours(System.Object):
    ...
    def __init__(self, referenceDate: datetime.date, defaultStart: float, defaultEnd: float) -> None:
        """
