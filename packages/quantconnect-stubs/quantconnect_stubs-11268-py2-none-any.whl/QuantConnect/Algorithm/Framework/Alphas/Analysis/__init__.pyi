...
class SecurityValues(System.Object):
    ...
    def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], timeUtc: datetime.date, exchangeHours: QuantConnect.Securities.SecurityExchangeHours, price: float, volatility: float, volume: float, quoteCurrencyConversionRate: float) -> None:
        """
...
class IInsightManager(System.IDisposable, metaclass=abc.ABCMeta):
    ...
    def InitializeExtensionsForRange(self, start: datetime.date, end: datetime.date, current: datetime.date) -> None:
        """
    ...
    def Step(self, frontierTimeUtc: datetime.date, securityValuesCollection: QuantConnect.Algorithm.Framework.Alphas.Analysis.ReadOnlySecurityValuesCollection, generatedInsights: QuantConnect.Algorithm.Framework.Alphas.GeneratedInsightsCollection) -> None:
        """
...
class InsightManager(System.Object, QuantConnect.Algorithm.Framework.Alphas.Analysis.IInsightManager, System.IDisposable):
    ...
    def ContextsOpenAt(self, frontierTimeUtc: datetime.date) -> System.Collections.Generic.IEnumerable[QuantConnect.Algorithm.Framework.Alphas.Analysis.InsightAnalysisContext]:
