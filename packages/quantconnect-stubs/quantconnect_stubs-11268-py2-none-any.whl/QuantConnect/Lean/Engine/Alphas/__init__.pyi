...
class StatisticsInsightManagerExtension(System.Object, QuantConnect.Algorithm.Framework.Alphas.IInsightManagerExtension):
    ...
    def Step(self, frontierTimeUtc: datetime.date) -> None:
        """
    ...
    def InitializeForRange(self, algorithmStartDate: datetime.date, algorithmEndDate: datetime.date, algorithmUtcTime: datetime.date) -> None:
        """
