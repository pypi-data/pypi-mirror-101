...
class BaseDataCollection(QuantConnect.Data.BaseData):
    ...
    @typing.overload
    def __init__(self, time: datetime.date, symbol: typing.Union[QuantConnect.Symbol, str], data: System.Collections.Generic.IEnumerable[QuantConnect.Data.BaseData] = None) -> None:
        """
    ...
    @typing.overload
    def __init__(self, time: datetime.date, endTime: datetime.date, symbol: typing.Union[QuantConnect.Symbol, str], data: System.Collections.Generic.IEnumerable[QuantConnect.Data.BaseData] = None) -> None:
        """
        Initializes a new instance of the BaseDataCollection class
    ...
    @typing.overload
    def __init__(self, time: datetime.date, endTime: datetime.date, symbol: typing.Union[QuantConnect.Symbol, str], data: System.Collections.Generic.List[QuantConnect.Data.BaseData]) -> None:
        """
        Initializes a new instance of the BaseDataCollection class
...
class SubscriptionRequest(QuantConnect.Data.BaseDataRequest):
    ...
    @typing.overload
    def __init__(self, isUniverseSubscription: bool, universe: QuantConnect.Data.UniverseSelection.Universe, security: QuantConnect.Securities.Security, configuration: QuantConnect.Data.SubscriptionDataConfig, startTimeUtc: datetime.date, endTimeUtc: datetime.date) -> None:
...
class Universe(System.Object, System.IDisposable, metaclass=abc.ABCMeta):
    ...
    class Member(System.Object):
        ...
        def __init__(self, added: datetime.date, security: QuantConnect.Securities.Security) -> None:
            """
    ...
    def CanRemoveMember(self, utcTime: datetime.date, security: QuantConnect.Securities.Security) -> bool:
        """
    ...
    def PerformSelection(self, utcTime: datetime.date, data: QuantConnect.Data.UniverseSelection.BaseDataCollection) -> System.Collections.Generic.IEnumerable[QuantConnect.Symbol]:
        """
    ...
    def SelectSymbols(self, utcTime: datetime.date, data: QuantConnect.Data.UniverseSelection.BaseDataCollection) -> System.Collections.Generic.IEnumerable[QuantConnect.Symbol]:
        """
        Performs universe selection using the data specified
    ...
    @typing.overload
    def GetSubscriptionRequests(self, security: QuantConnect.Securities.Security, currentTimeUtc: datetime.date, maximumEndTimeUtc: datetime.date) -> System.Collections.Generic.IEnumerable[QuantConnect.Data.UniverseSelection.SubscriptionRequest]:
        """
    ...
    @typing.overload
    def GetSubscriptionRequests(self, security: QuantConnect.Securities.Security, currentTimeUtc: datetime.date, maximumEndTimeUtc: datetime.date, subscriptionService: QuantConnect.Interfaces.ISubscriptionDataConfigService) -> System.Collections.Generic.IEnumerable[QuantConnect.Data.UniverseSelection.SubscriptionRequest]:
        """
        Gets the subscription requests to be added for the specified security
...
class SelectSymbolsUniverseDecorator(QuantConnect.Data.UniverseSelection.UniverseDecorator):
    ...
    def SelectSymbolsDelegate(self, utcTime: datetime.date, data: QuantConnect.Data.UniverseSelection.BaseDataCollection) -> System.Collections.Generic.IEnumerable[QuantConnect.Symbol]:
        """
...
class GetSubscriptionRequestsUniverseDecorator(QuantConnect.Data.UniverseSelection.UniverseDecorator):
    ...
    def GetSubscriptionRequestsDelegate(self, security: QuantConnect.Securities.Security, currentTimeUtc: datetime.date, maximumEndTimeUtc: datetime.date) -> System.Collections.Generic.IEnumerable[QuantConnect.Data.UniverseSelection.SubscriptionRequest]:
        """
...
class ITimeTriggeredUniverse(metaclass=abc.ABCMeta):
    ...
    def GetTriggerTimes(self, startTimeUtc: datetime.date, endTimeUtc: datetime.date, marketHoursDatabase: QuantConnect.Securities.MarketHoursDatabase) -> System.Collections.Generic.IEnumerable[datetime.datetime]:
        """
...
class FuturesChainUniverseDataCollection(QuantConnect.Data.UniverseSelection.BaseDataCollection):
    ...
    @typing.overload
    def __init__(self, time: datetime.date, symbol: typing.Union[QuantConnect.Symbol, str], data: System.Collections.Generic.List[QuantConnect.Data.BaseData] = None) -> None:
        """
    ...
    @typing.overload
    def __init__(self, time: datetime.date, endTime: datetime.date, symbol: typing.Union[QuantConnect.Symbol, str], data: System.Collections.Generic.List[QuantConnect.Data.BaseData] = None) -> None:
        """
        Initializes a new instance of the FuturesChainUniverseDataCollection class
...
class OptionChainUniverseDataCollection(QuantConnect.Data.UniverseSelection.BaseDataCollection):
    ...
    @typing.overload
    def __init__(self, time: datetime.date, symbol: typing.Union[QuantConnect.Symbol, str], data: System.Collections.Generic.List[QuantConnect.Data.BaseData] = None, underlying: QuantConnect.Data.BaseData = None) -> None:
        """
    ...
    @typing.overload
    def __init__(self, time: datetime.date, endTime: datetime.date, symbol: typing.Union[QuantConnect.Symbol, str], data: System.Collections.Generic.List[QuantConnect.Data.BaseData] = None, underlying: QuantConnect.Data.BaseData = None) -> None:
        """
        Initializes a new instance of the OptionChainUniverseDataCollection class
