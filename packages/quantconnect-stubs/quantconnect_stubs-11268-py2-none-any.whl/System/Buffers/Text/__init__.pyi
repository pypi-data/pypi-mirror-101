...
class Utf8Parser(System.Object):
    ...
    @staticmethod
    @typing.overload
    def TryParse(source: System.ReadOnlySpan[int], value: typing.Optional[datetime.date], bytesConsumed: typing.Optional[int], standardFormat: str = ...) -> typing.Union[bool, datetime.date, int]:
        """
...
class Utf8Formatter(System.Object):
    ...
    @staticmethod
    @typing.overload
    def TryFormat(value: datetime.date, destination: System.Span[int], bytesWritten: typing.Optional[int], format: System.Buffers.StandardFormat = ...) -> typing.Union[bool, int]:
        """
