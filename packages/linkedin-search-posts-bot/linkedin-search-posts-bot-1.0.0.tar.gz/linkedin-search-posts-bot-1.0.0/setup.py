...
VERSION = '1.0.0'
PACKAGE_NAME = 'linkedin-search-posts-bot'
AUTHOR = 'DataKund'
...
DESCRIPTION = 'A python library to search keyword in linkedin content and scrape search results data from linkedin automatically.'
