...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '3.55.0-alpha.1617963249+e2c4299e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 3.55.0-alpha.1617963249+e2c4299e`
                """)
            else:
                raise
