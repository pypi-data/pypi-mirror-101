...
class Display:
    ...
    def send(self, cmd, mode=0):
        self.send_four_bits(mode | (cmd & 0xF0))
        self.send_four_bits(mode | ((cmd << 4) & 0xF0))

    # write a character to lcd (or character rom) 0x09: backlight | RS=DR<
    # works!
    def send_char(self, charvalue, mode=1):
        self.send_four_bits(mode | (charvalue & 0xF0))
        self.send_four_bits(mode | ((charvalue << 4) & 0xF0))
