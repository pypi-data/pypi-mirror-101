Linkedin-Auto-Post is a python library to post content on linkedin using browser automation. 
It currently runs only on windows.

### Example
In this example we first import library, then we login with cookies and then post content on linkedin.
```sh
...
linkedin.upload_content(content='Hi everyone, i am looking for following profiles...')
```
...
### Upload content 
```sh
linkedin.upload_content(content='content')
```
