...
def test_linear_attention_softmax_kernel():
    a = C.sequence.input_variable(24)
    b = LinearAttention(hidden_dim=32, model_dim=24, kernel_type='softmax')(a, a, a)
...
def test_linear_attention_model_softmax_kernel():
    a = C.sequence.input_variable(24)
    b = LinearAttentionModel(hidden_dim=32, model_dim=24, kernel_type='softmax')(a, a)
