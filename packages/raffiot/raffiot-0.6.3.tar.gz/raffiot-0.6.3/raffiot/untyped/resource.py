...
from raffiot.untyped import result
...
from raffiot.untyped.utils import ComputationStatus, MatchError, TracedException
...
def close_and_merge_failure(close, r):
    """
    Helper to close
...
def panic(*exceptions, errors=None):
    """
