...
_ASSERTIONINPUT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='service_accessibility', full_name='com.intentionet.bfe.assertions.AssertionInput.service_accessibility', index=17,
    ...
    _descriptor.FieldDescriptor(
      name='service_protection', full_name='com.intentionet.bfe.assertions.AssertionInput.service_protection', index=18,
    ...
    _descriptor.FieldDescriptor(
      name='duplicate_bgp_asn', full_name='com.intentionet.bfe.assertions.AssertionInput.duplicate_bgp_asn', index=19,
    ...
    _descriptor.FieldDescriptor(
      name='description', full_name='com.intentionet.bfe.assertions.AssertionInput.description', index=20,
    ...
    _descriptor.FieldDescriptor(
      name='title', full_name='com.intentionet.bfe.assertions.AssertionInput.title', index=21,
...
_ASSERTIONRESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, json_name='bgpPeeringEstablishment', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='service_accessibility', full_name='com.intentionet.bfe.assertions.AssertionResult.service_accessibility', index=17,
      number=42, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='serviceAccessibility', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='service_protection', full_name='com.intentionet.bfe.assertions.AssertionResult.service_protection', index=18,
      number=43, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='serviceProtection', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='duplicate_bgp_asn', full_name='com.intentionet.bfe.assertions.AssertionResult.duplicate_bgp_asn', index=19,
      number=44, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='duplicateBgpAsn', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='com.intentionet.bfe.assertions.AssertionResult.metadata', index=20,
