...
class Requests:
    ...
    async def get_road_data_point(self, datatype: str = None, area: BaseGeometry = None) -> dict:
        params = {}
        if area is not None:
            params[RequestParam.within] = encode_geometry(area)
    ...
    async def get_data_point_indicator(self, indicator: str, fromdatetime: datetime,
        ...
        if datatypeeids is not None:
            params[RequestParam.datatype] = self.__encode_list_params(datatypeeids)
        return await self._get_indicator(indicator, fromdatetime, todatetime, datapointeids, period, sampling, window,
                                         RequestPath.datapoint, params)

    async def get_data_point_imputed_indicator(self, indicator: str, fromdatetime: datetime,
                                               todatetime: datetime = None, datapointeids: list = None,
                                               datatypeeids: list = None, period: str = None, sampling: str = None,
                                               window: str = None) -> dict:
        params = {}
        if datatypeeids is not None:
            params[RequestParam.datatype] = self.__encode_list_params(datatypeeids)
        return await self._get_indicator(indicator, fromdatetime, todatetime, datapointeids, period, sampling, window,
                                         SEPARATOR.join((RequestPath.datapoint, RequestPath.imputed)), params)
    ...
    async def get_road_indicator(self, indicator: str, fromdatetime: datetime, todatetime: datetime,
                                 ...
                                 window: str = None) -> dict:
        return await self._get_indicator(indicator, fromdatetime, todatetime, roadeids, period, sampling, window,
                                         RequestPath.road)

    async def _get_indicator(self, indicator: str, fromdatetime: datetime, todatetime: datetime, locationeids: list,
                             period: str, sampling: str, window: str, applyto: str, params: dict = None) -> dict:
        if params is None:
            params = {}
        ...
        return await self.__get_data(fromdatetime, todatetime, locationeids, period, sampling, window,
                                     SEPARATOR.join((applyto, RequestPath.indicator)), params)

    async def __get_data(self, fromdatetime: datetime, todatetime: datetime, locationeids: list, period: str,
                         sampling: str, window: str, applyto: str, params) -> dict:
        if params is None:
            params = {}
    ...
    async def get_zone_travel_time(self, frompointeid: str, topointeid: str, fromdatetime: datetime,
                                   todatetime: datetime, period: str, sampling: str) -> dict:
        params = {
    ...
    async def get_road_center(self, roadeids: list = None, area: BaseGeometry = None) -> dict:
        return await self._get_location(roadeids, area, SEPARATOR.join((RequestPath.road, RequestPath.roadcenter)))

    async def get_turn_ratio(self, fromroad: str, toroad: str, params = None) -> dict:
        if params is None:
            params = {}
        ...
        return await self._get(SEPARATOR.join((RequestPath.road, RequestPath.roadcenter, RequestPath.turnratio)), params)
