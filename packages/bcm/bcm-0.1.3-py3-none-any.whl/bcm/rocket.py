...
class Rocket:
    ...
    def load_rocket(self, color):
        ...
        self.first_img = arcade.Sprite(f"{SYS_RESOURCES_DIR}{os.sep}{color}{os.sep}first.png", scale=0.5)
        self.first_img.position = self.width / 2, self.height / 2 - self.change_num

        self.second = arcade.Sprite(f"{SYS_RESOURCES_DIR}{os.sep}{color}{os.sep}second.png", scale=0.5)
        self.second.position = self.width / 2, self.height / 2 + self.first_img.height / 2 - 10 - self.change_num

        self.push1 = arcade.Sprite(f"{SYS_RESOURCES_DIR}{os.sep}{color}{os.sep}push3.png", scale=0.3,
                                   mirrored=True)
        self.push1.position = self.width / 2 - 22, self.first_img.center_y - 5

        self.push2 = arcade.Sprite(f"{SYS_RESOURCES_DIR}{os.sep}{color}{os.sep}push2.png", scale=0.3)
        self.push2.position = self.width / 2, self.first_img.center_y - 5

        self.push3 = arcade.Sprite(f"{SYS_RESOURCES_DIR}{os.sep}{color}{os.sep}push3.png", scale=0.3)
        self.push3.position = self.width / 2 + 22, self.first_img.center_y - 5

        self.push4 = arcade.Sprite(f"{SYS_RESOURCES_DIR}{os.sep}{color}{os.sep}push2.png", scale=0.2)
        self.push4.position = self.width / 2, self.first_img.center_y - 5
