...
class Rocket:
    ...
    def load_rocket(self, color):
        self.tower = arcade.Sprite(f"{SYS_RESOURCES_DIR}{os.sep}{color}{os.sep}tower.png", scale=0.3)
        self.tower.position = self.width / 2 - 2, self.height / 2 - self.change_num + 148

        self.mask1 = arcade.Sprite(f"{SYS_RESOURCES_DIR}{os.sep}{color}{os.sep}mask1.png", scale=0.5)
        self.mask1.position = self.width / 2 + 6, self.height - 2 * self.change_num - 8

        self.mask2 = arcade.Sprite(f"{SYS_RESOURCES_DIR}{os.sep}{color}{os.sep}mask1.png", scale=0.5,
                                   mirrored=True)
        ...
        self.first = arcade.Sprite(f"{SYS_RESOURCES_DIR}{os.sep}{color}{os.sep}first.png", scale=0.5)
        self.first.position = self.width / 2, self.height / 2 - self.change_num

        self.second = arcade.Sprite(f"{SYS_RESOURCES_DIR}{os.sep}{color}{os.sep}second.png", scale=0.5)
        self.second.position = self.width / 2, self.height / 2 + self.first.height / 2 - 10 - self.change_num

        self.push1 = arcade.Sprite(f"{SYS_RESOURCES_DIR}{os.sep}{color}{os.sep}push3.png", scale=0.3,
                                   mirrored=True)
        self.push1.position = self.width / 2 - 22, self.first.center_y - 5

        self.push2 = arcade.Sprite(f"{SYS_RESOURCES_DIR}{os.sep}{color}{os.sep}push2.png", scale=0.3)
        self.push2.position = self.width / 2, self.first.center_y - 5

        self.push3 = arcade.Sprite(f"{SYS_RESOURCES_DIR}{os.sep}{color}{os.sep}push3.png", scale=0.3)
        self.push3.position = self.width / 2 + 22, self.first.center_y - 5

        self.push4 = arcade.Sprite(f"{SYS_RESOURCES_DIR}{os.sep}{color}{os.sep}push2.png", scale=0.2)
