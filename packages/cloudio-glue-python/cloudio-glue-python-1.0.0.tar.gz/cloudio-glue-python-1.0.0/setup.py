...
"""Script to install project using pip
...
setup(
    ...
    name='cloudio-glue-python',  # Required
    ...
    description='cloud.iO endpoint glue',  # Required
    ...
    keywords='cloud.iO endpoint library IoT cloud connector model',  # Optional
