...
class NPRankingPlotter(object):
    ...
    def create_ranking_plot(self, data, data_overlay=None, param_dict=None, out_dir="./"):
        ...
        label_size = (0.9 / max_label_len) if (0.9 / max_label_len) < 0.02 else 0.02
        ...
        for i, l in enumerate(self.config['label']):
            label_2.DrawLatex(self._POSITION_LABEL_X_,
                              self._POSITION_LABEL_Y_ - (1+i) * self._POSITION_LABEL_DY_, l)  
        label_2.DrawLatex(self._POSITION_LABEL_X_,
                              self._POSITION_LABEL_Y_ - (1+len(self.config['label'])) * self._POSITION_LABEL_DY_,
