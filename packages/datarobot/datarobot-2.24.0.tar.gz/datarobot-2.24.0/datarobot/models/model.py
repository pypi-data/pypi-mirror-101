...
class DatetimeModel(Model):
    ...
    def compute_datetime_trend_plots(
        ...
        """
        Computes datetime trend plots (Accuracy over Time, Forecast vs Actual) for this model
        ...
        forecast_distance_start : int, optional:
            ...
            If not specified, the first forecast distance for this project be used.
        ...
        forecast_distance_end : int, optional:
            ...
            If not specified, the last forecast distance for this project be used.
            Only for time series supervised models
