...
def print(nfe: Nfe):
    ...
    nfe_group = RenderGroup(
        Text(nfe.key.value, style="bold black", justify="center"),
        ...
        Text(
            f"Auth. protocol: {nfe.auth_protocol.value}",
            style="black",
            justify="center",
        ),
    )
    ...
    consumer_panel = Panel(
        RenderGroup(
            Text(f"CPF: {nfe.cpf.value}", style="black", justify="center",),
        ),
