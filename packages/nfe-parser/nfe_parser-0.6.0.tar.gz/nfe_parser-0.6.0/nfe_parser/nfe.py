...
class Nfe:
    ...
    def setkey(self, v: str):
        ...
        self.__dict__["key"] = " ".join(textwrap.wrap(v, 4))
    ...
    def setcpf(self, v: str):
        ...
        self.__dict__["cpf"] = f"{v[0:3]}.{v[3:6]}.{v[6:9]}-{v[9:12]}"
...
def print(nfe: Nfe):
    ...
    nfe_group = RenderGroup(
        Text(nfe.key, style="bold black", justify="center"),
    ...
    consumer_panel = Panel(
        RenderGroup(Text(f"CPF: {nfe.cpf}", style="black", justify="center",),),
