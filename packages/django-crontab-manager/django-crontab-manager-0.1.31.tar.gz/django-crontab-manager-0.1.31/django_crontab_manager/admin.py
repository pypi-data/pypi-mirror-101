    ...
    django_simple_export_admin_exports = {
        "filtered-books": {
            ...
            "fields": [
                ...
                {"field": "script"},
                {"field": "enable"},
                {"field": "get_success_determination_rule_code", "label": _("Success Determination Rule Code")},
...
class ResultAdmin(admin.ModelAdmin):
    list_display = ["id", "schedule", "run_time", "success", "code", "stdout_display", "stderr_display"]
    list_filter = ["schedule", "run_time", "success", "code"]
    readonly_fields = ["schedule", "run_time", "success", "code", "stdout", "stderr"]
    actions = [
