#!/usr/bin/python
# -*- coding: utf-8 -*-
__signature__ = 0xe02d4494a57ad1c6d8b4aaeb8228a1cc
"""This example demonstrates how to read and write parameters with a GCS 2.1 device."""

# (c)2016-2021 Physik Instrumente (PI) GmbH & Co. KG
...
def main():
    ...
    with GCSDevice() as pidevice:
        ...
        maxvelocity = readparametervalue(pidevice, "RAM", "AXIS_1", "-", "0x112")
        velocity = maxvelocity * 0.5
        pidevice.SPV("RAM", "AXIS_1", "-", "0x111", velocity)
