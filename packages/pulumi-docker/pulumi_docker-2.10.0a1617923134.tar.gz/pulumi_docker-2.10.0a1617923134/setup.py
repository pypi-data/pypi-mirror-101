...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'docker', '2.10.0-alpha.1617923134+b42364ee'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource docker 2.10.0-alpha.1617923134+b42364ee`
                """)
            else:
                raise
