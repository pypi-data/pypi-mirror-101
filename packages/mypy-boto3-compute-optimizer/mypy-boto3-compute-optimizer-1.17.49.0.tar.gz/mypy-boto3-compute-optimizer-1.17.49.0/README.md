...
[boto3.ComputeOptimizer 1.17.49](https://boto3.amazonaws.com/v1/documentation/api/1.17.49/reference/services/compute-optimizer.html#ComputeOptimizer) service
compatible with
