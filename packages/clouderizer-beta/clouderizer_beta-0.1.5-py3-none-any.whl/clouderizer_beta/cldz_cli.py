...
from clouderizer_beta.cldz_aws_lambda import lambda_deploy, lambda_delete, aws_region_set
...
def create_serving_model(file_name,s3Path,servingproject,servingprojectid,pipPackages,auth_token,training,model_type,subtype,image_type,preprocess=None,postprocess=None,predict=None,inputAttrs=[],outputAttrs=[],retry=0,is_lambda_deploy="false"):
	# print("Inside")
