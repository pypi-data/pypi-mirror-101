...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import HyphomicrobiumDenitrificansAtcc51888

    # Then load the graph
    graph = HyphomicrobiumDenitrificansAtcc51888()
...
def HyphomicrobiumDenitrificansAtcc51888(
    directed: bool = False,
    verbose: int = 2,
