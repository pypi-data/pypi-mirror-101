...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import LactobacillusCoryniformisKctc3167

    # Then load the graph
    graph = LactobacillusCoryniformisKctc3167()
...
def LactobacillusCoryniformisKctc3167(
    directed: bool = False,
    verbose: int = 2,
