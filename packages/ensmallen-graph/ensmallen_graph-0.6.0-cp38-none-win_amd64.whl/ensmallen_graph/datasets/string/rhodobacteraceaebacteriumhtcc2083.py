...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import RhodobacteraceaeBacteriumHtcc2083

    # Then load the graph
    graph = RhodobacteraceaeBacteriumHtcc2083()
...
def RhodobacteraceaeBacteriumHtcc2083(
    directed: bool = False,
    verbose: int = 2,
