...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import FusobacteriumNucleatumVincentii3136a2

    # Then load the graph
    graph = FusobacteriumNucleatumVincentii3136a2()
...
def FusobacteriumNucleatumVincentii3136a2(
    directed: bool = False,
    verbose: int = 2,
