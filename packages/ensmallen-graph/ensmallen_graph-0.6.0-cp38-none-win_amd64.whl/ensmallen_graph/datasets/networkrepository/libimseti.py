"""
This file offers the methods to automatically retrieve the graph libimseti.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Libimseti
