"""
This file offers the methods to automatically retrieve the graph C2000-5.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import C20005
