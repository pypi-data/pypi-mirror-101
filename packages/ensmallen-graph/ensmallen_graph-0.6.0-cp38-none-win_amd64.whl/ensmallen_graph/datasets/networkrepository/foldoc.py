"""
This file offers the methods to automatically retrieve the graph foldoc.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Foldoc
