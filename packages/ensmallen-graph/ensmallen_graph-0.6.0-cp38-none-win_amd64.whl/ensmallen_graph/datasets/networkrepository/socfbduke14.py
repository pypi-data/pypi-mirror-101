"""
This file offers the methods to automatically retrieve the graph socfb-Duke14.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import SocfbDuke14
