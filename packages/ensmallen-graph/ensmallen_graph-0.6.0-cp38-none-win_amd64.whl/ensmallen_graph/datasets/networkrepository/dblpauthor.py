"""
This file offers the methods to automatically retrieve the graph dblp-author.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import DblpAuthor
