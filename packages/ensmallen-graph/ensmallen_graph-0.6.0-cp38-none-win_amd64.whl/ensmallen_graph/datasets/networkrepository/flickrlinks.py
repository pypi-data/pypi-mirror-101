"""
This file offers the methods to automatically retrieve the graph flickr-links.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import FlickrLinks
