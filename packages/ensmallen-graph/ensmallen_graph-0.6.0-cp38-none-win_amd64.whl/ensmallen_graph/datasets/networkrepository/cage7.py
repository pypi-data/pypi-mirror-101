"""
This file offers the methods to automatically retrieve the graph cage7.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Cage7
