"""
This file offers the methods to automatically retrieve the graph cage9.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Cage9
