"""
This file offers the methods to automatically retrieve the graph Stanford.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Stanford
