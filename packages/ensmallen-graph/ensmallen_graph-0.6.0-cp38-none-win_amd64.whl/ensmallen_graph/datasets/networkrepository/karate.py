"""
This file offers the methods to automatically retrieve the graph karate.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Karate
