"""
This file offers the methods to automatically retrieve the graph ENZYMES123.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Enzymes123
