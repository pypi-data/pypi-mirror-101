"""
This file offers the methods to automatically retrieve the graph keller6.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Keller6
