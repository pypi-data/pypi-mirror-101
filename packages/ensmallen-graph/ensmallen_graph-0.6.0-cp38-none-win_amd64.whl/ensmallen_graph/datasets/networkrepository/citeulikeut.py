"""
This file offers the methods to automatically retrieve the graph citeulike-ut.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import CiteulikeUt
