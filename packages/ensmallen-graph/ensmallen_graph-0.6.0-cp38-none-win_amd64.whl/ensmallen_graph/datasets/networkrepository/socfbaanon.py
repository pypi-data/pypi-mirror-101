"""
This file offers the methods to automatically retrieve the graph socfb-A-anon.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import SocfbAAnon
