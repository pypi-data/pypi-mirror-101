"""
This file offers the methods to automatically retrieve the graph ca-aminer.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import CaAminer
