"""
This file offers the methods to automatically retrieve the graph divorce.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Divorce
