"""
This file offers the methods to automatically retrieve the graph socfb-UCLA.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import SocfbUcla
