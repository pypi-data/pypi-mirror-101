"""
This file offers the methods to automatically retrieve the graph C500-9.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import C5009
