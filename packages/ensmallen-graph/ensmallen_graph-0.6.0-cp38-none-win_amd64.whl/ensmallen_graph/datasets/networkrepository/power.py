"""
This file offers the methods to automatically retrieve the graph power.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Power
