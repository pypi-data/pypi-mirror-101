"""
This file offers the methods to automatically retrieve the graph Journals.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Journals
