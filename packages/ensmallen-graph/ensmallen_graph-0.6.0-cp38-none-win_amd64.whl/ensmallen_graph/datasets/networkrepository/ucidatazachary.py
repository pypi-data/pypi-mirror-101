...
Datetime: 2021-02-06 09:22:39.794888

The undirected graph ucidata-zachary has 34 nodes and 78 unweighted edges,
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import UcidataZachary

    # Then load the graph
    graph = UcidataZachary()
