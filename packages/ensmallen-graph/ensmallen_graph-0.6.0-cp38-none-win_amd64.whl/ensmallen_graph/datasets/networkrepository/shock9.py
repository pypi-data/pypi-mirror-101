"""
This file offers the methods to automatically retrieve the graph shock-9.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Shock9
