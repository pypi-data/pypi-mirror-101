"""
This file offers the methods to automatically retrieve the graph hamming8-2.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Hamming82
