"""
This file offers the methods to automatically retrieve the graph ODLIS.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Odlis
