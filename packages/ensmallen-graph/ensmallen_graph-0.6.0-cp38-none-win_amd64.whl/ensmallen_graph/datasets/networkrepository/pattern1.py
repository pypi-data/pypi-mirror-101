"""
This file offers the methods to automatically retrieve the graph pattern1.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Pattern1
