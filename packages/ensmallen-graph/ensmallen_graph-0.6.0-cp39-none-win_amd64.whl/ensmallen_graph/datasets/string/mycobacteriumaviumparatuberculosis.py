...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import MycobacteriumAviumParatuberculosis

    # Then load the graph
    graph = MycobacteriumAviumParatuberculosis()
...
def MycobacteriumAviumParatuberculosis(
    directed: bool = False,
    verbose: int = 2,
