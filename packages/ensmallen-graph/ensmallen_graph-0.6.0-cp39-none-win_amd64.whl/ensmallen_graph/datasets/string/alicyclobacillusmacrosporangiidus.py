...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import AlicyclobacillusMacrosporangiidus

    # Then load the graph
    graph = AlicyclobacillusMacrosporangiidus()
...
def AlicyclobacillusMacrosporangiidus(
    directed: bool = False,
    verbose: int = 2,
