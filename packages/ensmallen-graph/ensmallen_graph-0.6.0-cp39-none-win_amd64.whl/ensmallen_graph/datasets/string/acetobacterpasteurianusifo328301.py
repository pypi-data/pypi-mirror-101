...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import AcetobacterPasteurianusIfo328301

    # Then load the graph
    graph = AcetobacterPasteurianusIfo328301()
...
def AcetobacterPasteurianusIfo328301(
    directed: bool = False,
    verbose: int = 2,
