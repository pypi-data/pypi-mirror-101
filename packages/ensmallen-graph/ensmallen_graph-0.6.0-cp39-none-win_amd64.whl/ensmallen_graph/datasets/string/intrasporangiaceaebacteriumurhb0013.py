...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import IntrasporangiaceaeBacteriumUrhb0013

    # Then load the graph
    graph = IntrasporangiaceaeBacteriumUrhb0013()
...
def IntrasporangiaceaeBacteriumUrhb0013(
    directed: bool = False,
    verbose: int = 2,
