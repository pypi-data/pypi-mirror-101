...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import PseudaminobacterSalicylatoxidans

    # Then load the graph
    graph = PseudaminobacterSalicylatoxidans()
...
def PseudaminobacterSalicylatoxidans(
    directed: bool = False,
    verbose: int = 2,
