...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import AtelocyanobacteriumThalassaSio64986

    # Then load the graph
    graph = AtelocyanobacteriumThalassaSio64986()
...
def AtelocyanobacteriumThalassaSio64986(
    directed: bool = False,
    verbose: int = 2,
