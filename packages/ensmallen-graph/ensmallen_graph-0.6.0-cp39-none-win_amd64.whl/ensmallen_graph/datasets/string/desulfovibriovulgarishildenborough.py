...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import DesulfovibrioVulgarisHildenborough

    # Then load the graph
    graph = DesulfovibrioVulgarisHildenborough()
...
def DesulfovibrioVulgarisHildenborough(
    directed: bool = False,
    verbose: int = 2,
