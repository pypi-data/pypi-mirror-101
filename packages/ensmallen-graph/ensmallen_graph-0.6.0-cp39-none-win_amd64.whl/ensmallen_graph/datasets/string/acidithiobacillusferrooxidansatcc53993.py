...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import AcidithiobacillusFerrooxidansAtcc53993

    # Then load the graph
    graph = AcidithiobacillusFerrooxidansAtcc53993()
...
def AcidithiobacillusFerrooxidansAtcc53993(
    directed: bool = False,
    verbose: int = 2,
