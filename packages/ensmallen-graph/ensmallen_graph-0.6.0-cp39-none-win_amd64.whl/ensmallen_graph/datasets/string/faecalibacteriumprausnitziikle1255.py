...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import FaecalibacteriumPrausnitziiKle1255

    # Then load the graph
    graph = FaecalibacteriumPrausnitziiKle1255()
...
def FaecalibacteriumPrausnitziiKle1255(
    directed: bool = False,
    verbose: int = 2,
