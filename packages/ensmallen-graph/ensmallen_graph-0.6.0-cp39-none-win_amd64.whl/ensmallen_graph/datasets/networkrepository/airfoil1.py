"""
This file offers the methods to automatically retrieve the graph airfoil1.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Airfoil1
