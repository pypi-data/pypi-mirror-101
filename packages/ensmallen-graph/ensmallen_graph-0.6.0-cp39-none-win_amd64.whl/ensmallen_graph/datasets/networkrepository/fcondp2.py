"""
This file offers the methods to automatically retrieve the graph fcondp2.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Fcondp2
