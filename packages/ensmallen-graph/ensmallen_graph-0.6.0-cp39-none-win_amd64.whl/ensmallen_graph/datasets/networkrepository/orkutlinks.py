"""
This file offers the methods to automatically retrieve the graph orkut-links.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import OrkutLinks
