"""
This file offers the methods to automatically retrieve the graph ford2.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Ford2
