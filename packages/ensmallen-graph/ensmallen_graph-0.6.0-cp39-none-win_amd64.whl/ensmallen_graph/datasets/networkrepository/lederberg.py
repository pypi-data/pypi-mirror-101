"""
This file offers the methods to automatically retrieve the graph Lederberg.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Lederberg
