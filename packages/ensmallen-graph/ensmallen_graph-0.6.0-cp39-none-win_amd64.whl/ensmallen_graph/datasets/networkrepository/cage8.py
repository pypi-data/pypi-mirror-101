"""
This file offers the methods to automatically retrieve the graph cage8.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Cage8
