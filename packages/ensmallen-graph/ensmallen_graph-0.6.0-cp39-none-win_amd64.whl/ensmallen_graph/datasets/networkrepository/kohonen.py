"""
This file offers the methods to automatically retrieve the graph Kohonen.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Kohonen
