"""
This file offers the methods to automatically retrieve the graph dictionary28.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Dictionary28
