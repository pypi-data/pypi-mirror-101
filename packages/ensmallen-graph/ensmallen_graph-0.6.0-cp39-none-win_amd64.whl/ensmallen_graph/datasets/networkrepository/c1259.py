"""
This file offers the methods to automatically retrieve the graph C125-9.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import C1259
