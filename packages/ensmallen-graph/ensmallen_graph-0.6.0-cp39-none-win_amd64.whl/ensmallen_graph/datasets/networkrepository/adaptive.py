"""
This file offers the methods to automatically retrieve the graph adaptive.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Adaptive
