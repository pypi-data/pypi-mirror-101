"""
This file offers the methods to automatically retrieve the graph socfb-konect.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import SocfbKonect
