"""
This file offers the methods to automatically retrieve the graph sphere3.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Sphere3
