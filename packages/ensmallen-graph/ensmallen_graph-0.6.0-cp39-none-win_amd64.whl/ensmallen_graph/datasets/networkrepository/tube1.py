"""
This file offers the methods to automatically retrieve the graph tube1.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Tube1
