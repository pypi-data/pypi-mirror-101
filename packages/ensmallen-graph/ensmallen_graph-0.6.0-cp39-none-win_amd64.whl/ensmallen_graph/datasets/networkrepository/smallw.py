"""
This file offers the methods to automatically retrieve the graph SmallW.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Smallw
