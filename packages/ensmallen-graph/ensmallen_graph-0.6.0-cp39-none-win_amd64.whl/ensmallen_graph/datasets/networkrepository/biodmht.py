"""
This file offers the methods to automatically retrieve the graph bio-DM-HT.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import BioDmHt
