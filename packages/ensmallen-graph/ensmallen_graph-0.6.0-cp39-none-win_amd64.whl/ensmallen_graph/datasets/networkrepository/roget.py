"""
This file offers the methods to automatically retrieve the graph Roget.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Roget
