"""
This file offers the methods to automatically retrieve the graph copter1.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Copter1
