"""
This file offers the methods to automatically retrieve the graph sc-pwtk.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import ScPwtk
