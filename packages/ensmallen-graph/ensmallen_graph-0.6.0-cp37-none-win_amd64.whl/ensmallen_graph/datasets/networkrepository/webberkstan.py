"""
This file offers the methods to automatically retrieve the graph web-BerkStan.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import WebBerkstan
