"""
This file offers the methods to automatically retrieve the graph ego-gplus.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import EgoGplus
