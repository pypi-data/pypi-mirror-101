"""
This file offers the methods to automatically retrieve the graph IG5-14.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Ig514
