"""
This file offers the methods to automatically retrieve the graph football.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Football
