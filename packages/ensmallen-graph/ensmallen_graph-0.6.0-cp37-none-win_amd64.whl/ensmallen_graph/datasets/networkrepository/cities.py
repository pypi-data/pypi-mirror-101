"""
This file offers the methods to automatically retrieve the graph Cities.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Cities
