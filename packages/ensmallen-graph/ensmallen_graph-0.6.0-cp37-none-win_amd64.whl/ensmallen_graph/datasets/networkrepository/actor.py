"""
This file offers the methods to automatically retrieve the graph actor.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Actor
