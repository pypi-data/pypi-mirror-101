"""
This file offers the methods to automatically retrieve the graph connectus.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Connectus
