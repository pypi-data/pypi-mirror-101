"""
This file offers the methods to automatically retrieve the graph socfb-MIT8.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import SocfbMit8
