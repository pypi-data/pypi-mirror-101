"""
This file offers the methods to automatically retrieve the graph soc-youtube.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import SocYoutube
