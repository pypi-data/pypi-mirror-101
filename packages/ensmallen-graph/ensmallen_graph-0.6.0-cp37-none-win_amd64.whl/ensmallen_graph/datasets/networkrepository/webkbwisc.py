"""
This file offers the methods to automatically retrieve the graph webkb-wisc.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import WebkbWisc
