"""
This file offers the methods to automatically retrieve the graph usroads-48.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Usroads48
