"""
This file offers the methods to automatically retrieve the graph SciMet.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Scimet
