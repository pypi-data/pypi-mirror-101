"""
This file offers the methods to automatically retrieve the graph socfb-Rice31.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import SocfbRice31
