"""
This file offers the methods to automatically retrieve the graph polblogs.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Polblogs
