"""
This file offers the methods to automatically retrieve the graph hamming10-4.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Hamming104
