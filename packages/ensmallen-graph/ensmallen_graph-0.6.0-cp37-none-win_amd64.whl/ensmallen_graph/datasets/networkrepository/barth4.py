"""
This file offers the methods to automatically retrieve the graph barth4.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Barth4
