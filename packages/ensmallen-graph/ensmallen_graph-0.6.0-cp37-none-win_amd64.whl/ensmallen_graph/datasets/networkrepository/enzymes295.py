"""
This file offers the methods to automatically retrieve the graph ENZYMES295.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Enzymes295
