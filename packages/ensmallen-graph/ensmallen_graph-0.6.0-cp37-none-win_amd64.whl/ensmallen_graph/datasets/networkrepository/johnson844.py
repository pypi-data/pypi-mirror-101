"""
This file offers the methods to automatically retrieve the graph johnson8-4-4.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Johnson844
