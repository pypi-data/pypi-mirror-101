"""
This file offers the methods to automatically retrieve the graph ca-HepPh.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import CaHepph
