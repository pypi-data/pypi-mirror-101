"""
This file offers the methods to automatically retrieve the graph Trec9.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Trec9
