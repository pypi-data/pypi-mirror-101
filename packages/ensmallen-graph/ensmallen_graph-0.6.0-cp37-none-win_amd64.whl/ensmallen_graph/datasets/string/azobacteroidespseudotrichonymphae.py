...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import AzobacteroidesPseudotrichonymphae

    # Then load the graph
    graph = AzobacteroidesPseudotrichonymphae()
...
def AzobacteroidesPseudotrichonymphae(
    directed: bool = False,
    verbose: int = 2,
