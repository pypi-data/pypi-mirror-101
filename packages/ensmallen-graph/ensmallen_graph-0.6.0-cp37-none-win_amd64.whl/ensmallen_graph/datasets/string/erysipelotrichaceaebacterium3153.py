...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import ErysipelotrichaceaeBacterium3153

    # Then load the graph
    graph = ErysipelotrichaceaeBacterium3153()
...
def ErysipelotrichaceaeBacterium3153(
    directed: bool = False,
    verbose: int = 2,
