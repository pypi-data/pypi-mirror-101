...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import PeptostreptococcusAnaerobius653l

    # Then load the graph
    graph = PeptostreptococcusAnaerobius653l()
...
def PeptostreptococcusAnaerobius653l(
    directed: bool = False,
    verbose: int = 2,
