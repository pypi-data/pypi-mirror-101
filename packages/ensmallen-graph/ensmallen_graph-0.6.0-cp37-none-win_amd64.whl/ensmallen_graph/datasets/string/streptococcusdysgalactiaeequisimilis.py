...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import StreptococcusDysgalactiaeEquisimilis

    # Then load the graph
    graph = StreptococcusDysgalactiaeEquisimilis()
...
def StreptococcusDysgalactiaeEquisimilis(
    directed: bool = False,
    verbose: int = 2,
