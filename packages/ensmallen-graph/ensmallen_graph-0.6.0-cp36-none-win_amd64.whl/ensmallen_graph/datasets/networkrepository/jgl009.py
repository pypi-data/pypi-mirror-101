"""
This file offers the methods to automatically retrieve the graph jgl009.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Jgl009
