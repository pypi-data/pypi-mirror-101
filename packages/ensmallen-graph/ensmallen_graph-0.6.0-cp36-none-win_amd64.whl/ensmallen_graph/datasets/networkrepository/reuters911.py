"""
This file offers the methods to automatically retrieve the graph Reuters911.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Reuters911
