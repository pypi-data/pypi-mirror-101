...
Datetime: 2021-02-06 20:59:54.368092

The undirected graph livejournal-links has 5204176 nodes, of which 412
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import LivejournalLinks

    # Then load the graph
    graph = LivejournalLinks()
