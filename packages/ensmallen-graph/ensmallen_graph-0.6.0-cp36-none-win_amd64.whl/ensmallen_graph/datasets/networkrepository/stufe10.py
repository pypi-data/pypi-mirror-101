"""
This file offers the methods to automatically retrieve the graph stufe-10.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Stufe10
