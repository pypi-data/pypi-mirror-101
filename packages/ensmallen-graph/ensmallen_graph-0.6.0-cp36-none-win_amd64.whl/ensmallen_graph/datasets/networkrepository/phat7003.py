"""
This file offers the methods to automatically retrieve the graph p-hat700-3.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import PHat7003
