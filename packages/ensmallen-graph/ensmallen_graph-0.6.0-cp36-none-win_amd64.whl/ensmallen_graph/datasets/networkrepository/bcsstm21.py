"""
This file offers the methods to automatically retrieve the graph bcsstm21.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Bcsstm21
