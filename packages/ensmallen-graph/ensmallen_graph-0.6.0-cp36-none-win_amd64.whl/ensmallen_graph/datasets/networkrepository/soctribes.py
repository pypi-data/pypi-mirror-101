"""
This file offers the methods to automatically retrieve the graph soc-tribes.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import SocTribes
