"""
This file offers the methods to automatically retrieve the graph eco-stmarks.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import EcoStmarks
