"""
This file offers the methods to automatically retrieve the graph lesmis.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Lesmis
