"""
This file offers the methods to automatically retrieve the graph engine.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Engine
