"""
This file offers the methods to automatically retrieve the graph MANN-a27.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import MannA27
