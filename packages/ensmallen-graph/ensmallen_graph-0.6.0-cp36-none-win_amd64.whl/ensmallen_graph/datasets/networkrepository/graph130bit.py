"""
This file offers the methods to automatically retrieve the graph 130bit.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Graph130bit
