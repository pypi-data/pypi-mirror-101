"""
This file offers the methods to automatically retrieve the graph crplat2.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Crplat2
