"""
This file offers the methods to automatically retrieve the graph ca-CondMat.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import CaCondmat
