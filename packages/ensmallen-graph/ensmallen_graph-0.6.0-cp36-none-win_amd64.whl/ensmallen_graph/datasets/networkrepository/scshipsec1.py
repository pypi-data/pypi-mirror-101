"""
This file offers the methods to automatically retrieve the graph sc-shipsec1.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import ScShipsec1
