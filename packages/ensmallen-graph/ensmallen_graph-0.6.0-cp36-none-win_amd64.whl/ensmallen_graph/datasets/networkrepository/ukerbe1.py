"""
This file offers the methods to automatically retrieve the graph ukerbe1.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Ukerbe1
