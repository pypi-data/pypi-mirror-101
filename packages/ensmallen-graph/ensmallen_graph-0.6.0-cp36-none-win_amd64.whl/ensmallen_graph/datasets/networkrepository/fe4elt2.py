"""
This file offers the methods to automatically retrieve the graph fe-4elt2.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Fe4elt2
