"""
This file offers the methods to automatically retrieve the graph kleemin.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Kleemin
