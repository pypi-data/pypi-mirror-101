"""
This file offers the methods to automatically retrieve the graph stufe.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Stufe
