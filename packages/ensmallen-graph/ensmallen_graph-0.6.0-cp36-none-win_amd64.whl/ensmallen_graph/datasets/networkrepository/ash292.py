"""
This file offers the methods to automatically retrieve the graph ash292.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Ash292
