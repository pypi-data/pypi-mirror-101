"""
This file offers the methods to automatically retrieve the graph gearbox.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Gearbox
