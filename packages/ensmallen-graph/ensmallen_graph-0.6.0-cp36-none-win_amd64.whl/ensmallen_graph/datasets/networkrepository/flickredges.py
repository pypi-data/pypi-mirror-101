"""
This file offers the methods to automatically retrieve the graph flickrEdges.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Flickredges
