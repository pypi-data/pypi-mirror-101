"""
This file offers the methods to automatically retrieve the graph email-enron-only.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import EmailEnronOnly

    # Then load the graph
    graph = EmailEnronOnly()
