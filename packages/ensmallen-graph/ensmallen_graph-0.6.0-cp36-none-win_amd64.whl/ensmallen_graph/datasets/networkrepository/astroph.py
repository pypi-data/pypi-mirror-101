"""
This file offers the methods to automatically retrieve the graph astro-ph.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import AstroPh
