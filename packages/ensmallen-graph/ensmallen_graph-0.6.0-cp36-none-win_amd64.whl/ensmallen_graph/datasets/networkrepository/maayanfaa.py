"""
This file offers the methods to automatically retrieve the graph maayan-faa.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import MaayanFaa
