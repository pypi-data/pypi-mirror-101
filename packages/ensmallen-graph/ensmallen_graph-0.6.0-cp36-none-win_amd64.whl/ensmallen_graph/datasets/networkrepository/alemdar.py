"""
This file offers the methods to automatically retrieve the graph Alemdar.
...
.. code:: python
    ...
    from ensmallen_graph.datasets.networkrepository import Alemdar
