...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import BrevibacillusLaterosporusLmg15441

    # Then load the graph
    graph = BrevibacillusLaterosporusLmg15441()
...
def BrevibacillusLaterosporusLmg15441(
    directed: bool = False,
    verbose: int = 2,
