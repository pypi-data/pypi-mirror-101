...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import ParascardoviaDenticolensDsm10105

    # Then load the graph
    graph = ParascardoviaDenticolensDsm10105()
...
def ParascardoviaDenticolensDsm10105(
    directed: bool = False,
    verbose: int = 2,
