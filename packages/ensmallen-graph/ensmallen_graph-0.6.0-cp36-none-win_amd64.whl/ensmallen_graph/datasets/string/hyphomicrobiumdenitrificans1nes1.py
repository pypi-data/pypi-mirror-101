...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import HyphomicrobiumDenitrificans1nes1

    # Then load the graph
    graph = HyphomicrobiumDenitrificans1nes1()
...
def HyphomicrobiumDenitrificans1nes1(
    directed: bool = False,
    verbose: int = 2,
