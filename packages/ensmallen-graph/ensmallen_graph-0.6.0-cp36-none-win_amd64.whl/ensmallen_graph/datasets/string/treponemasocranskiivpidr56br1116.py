...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import TreponemaSocranskiiVpidr56br1116

    # Then load the graph
    graph = TreponemaSocranskiiVpidr56br1116()
...
def TreponemaSocranskiiVpidr56br1116(
    directed: bool = False,
    verbose: int = 2,
