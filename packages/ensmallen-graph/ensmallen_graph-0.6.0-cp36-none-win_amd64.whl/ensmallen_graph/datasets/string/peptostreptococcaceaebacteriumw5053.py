...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import PeptostreptococcaceaeBacteriumW5053

    # Then load the graph
    graph = PeptostreptococcaceaeBacteriumW5053()
...
def PeptostreptococcaceaeBacteriumW5053(
    directed: bool = False,
    verbose: int = 2,
