...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import SutterellaWadsworthensis2159bfaa

    # Then load the graph
    graph = SutterellaWadsworthensis2159bfaa()
...
def SutterellaWadsworthensis2159bfaa(
    directed: bool = False,
    verbose: int = 2,
