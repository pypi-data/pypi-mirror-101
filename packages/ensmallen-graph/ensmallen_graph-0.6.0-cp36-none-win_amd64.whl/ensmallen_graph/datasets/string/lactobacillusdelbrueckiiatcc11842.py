...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import LactobacillusDelbrueckiiAtcc11842

    # Then load the graph
    graph = LactobacillusDelbrueckiiAtcc11842()
...
def LactobacillusDelbrueckiiAtcc11842(
    directed: bool = False,
    verbose: int = 2,
