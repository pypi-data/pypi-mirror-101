...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import StenotrophomonasMaltophiliaK279a

    # Then load the graph
    graph = StenotrophomonasMaltophiliaK279a()
...
def StenotrophomonasMaltophiliaK279a(
    directed: bool = False,
    verbose: int = 2,
