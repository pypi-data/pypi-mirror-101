...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import BifidobacteriumBifidumNcimb41171

    # Then load the graph
    graph = BifidobacteriumBifidumNcimb41171()
...
def BifidobacteriumBifidumNcimb41171(
    directed: bool = False,
    verbose: int = 2,
