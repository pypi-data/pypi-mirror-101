...
.. code:: python
    ...
    from ensmallen_graph.datasets.string import ThermoanaerobacteriumXylanolyticum

    # Then load the graph
    graph = ThermoanaerobacteriumXylanolyticum()
...
def ThermoanaerobacteriumXylanolyticum(
    directed: bool = False,
    verbose: int = 2,
