...
from openmodule.config import validate_config_module, LazySettings, override_settings, _override_settings, settings, \
    override_context
...
from tests.resources import test_config
...
class ZmqConfigTest(ZMQTestMixin):
    ...
    def test_sub(self):
        self.assertIn("aaaaaaaaaa", self.zmq_config().BROKER_SUB)
