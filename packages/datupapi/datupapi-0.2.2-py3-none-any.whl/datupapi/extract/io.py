...
class IO(Config):
    ...
    def download_object(self, datalake_path=None, sep=',', index_col=None, squeeze=False, num_records=None, dayfirst=False, compression='infer', encoding='utf-8', low_memory=True, types=None):
        ...
        >>> df = download_csv(datalake_path='as-is/folder/file')
        >>> df
              var1    var2    var3
        idx0     1       2       3
        """
    ...
    def download_excel(self, q_name, sheet_name, datalake_path=None, index_col=None, squeeze=False, num_records=None, types=None, header_=None, skiprows_=None):
        """Return a dataframe from a csv file stored in the datalake
        ...
        try:
            ...
            df = pd.read_excel(file_path, sheet_name=sheet_name, index_col=index_col, squeeze=squeeze, engine='openpyxl', nrows=num_records, dtype=types, header=header_, skiprows=skiprows_)
