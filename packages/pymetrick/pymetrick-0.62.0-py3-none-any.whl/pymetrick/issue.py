...
class Simple_Order_PDF(FPDF):
    ...
    def config(self,*args,**kwargs):
        ...
        '''
        try:
            self.allowed_data = {'logo':'','letterhead':list(),'client':list(),'title':'','title_head':list(),'title_line':list(),'body_head':list(),'body_line':list(),'footer_line':list(),'total':list(),'terms_of_sale':'','authorization':'','order_code':'','payment_line':list()}
            for n in list(kwargs.keys()):
                if n in self.allowed_data:
                    self.allowed_data[n] = kwargs[n]
...
class Simple_Order_ESC():
    ...
    def config(self,*args,**kwargs):
        ...
        try:
            ...
            self.allowed_data = {'logo':'','letterhead':list(),'client':list(),'title':'','title_head':list(),'title_line':list(),'body_head':list(),'body_line':list(),'footer_line':list(),'total':list(),'terms_of_sale':'','authorization':'','order_code':'','payment_line':(),'cut':None,'cash_drawer':None}
            for n in list(kwargs.keys()):
                if n in self.allowed_data:
                    self.allowed_data[n] = kwargs[n]
