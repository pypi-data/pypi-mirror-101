...
class Rate(models.Model):
    ...
    def is_hourly_rate(self):
        return self.type.type in [RateType.Type.TOOL_USAGE, RateType.Type.AREA_USAGE, RateType.Type.STAFF_CHARGE, RateType.Type.TOOL_TRAINING_GROUP, RateType.Type.TOOL_TRAINING_INDIVIDUAL]
    ...
    def __str__(self):
        ...
        return f"{self.get_item()} {self.type} {category}"
