...
- classes (dict; optional)"""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, label=Component.UNDEFINED, value=Component.UNDEFINED, classes=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'label', 'value', 'classes']
        self._type = 'SelectFilter'
        self._namespace = 'select_filter'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'label', 'value', 'classes']
