...
def landmark_atlas_segmentation_filter_init_docstring():
    ...
    if is_template:
        landmark_atlas_segmentation_filter.__doc__ += itkHelpers.filter_args(filter_object)[0]
        landmark_atlas_segmentation_filter.__doc__ += "\n"
        landmark_atlas_segmentation_filter.__doc__ += itkHelpers.filter_args(filter_object)[1]
    else:
