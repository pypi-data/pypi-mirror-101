...
def landmark_atlas_segmentation_filter(*args: itkt.ImageLike,  input_labels: itkt.Image=..., atlas_labels: itkt.Image=..., input_landmarks=..., atlas_landmarks=...,**kwargs)-> itkt.ImageSourceReturn:
    """Functional interface for LandmarkAtlasSegmentationFilter"""
    import itk

    kwarg_typehints = { 'input_labels':input_labels,'atlas_labels':atlas_labels,'input_landmarks':input_landmarks,'atlas_landmarks':atlas_landmarks }
...
def landmark_atlas_segmentation_filter_init_docstring():
    ...
    filter_class = itk.HASI.LandmarkAtlasSegmentationFilter
    landmark_atlas_segmentation_filter.process_object = filter_class
