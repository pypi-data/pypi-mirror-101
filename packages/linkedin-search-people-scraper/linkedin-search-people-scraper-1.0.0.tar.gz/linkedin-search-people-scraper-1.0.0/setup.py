...
VERSION = '1.0.0'
PACKAGE_NAME = 'linkedin-search-people-scraper'
AUTHOR = 'DataKund'
...
DESCRIPTION = 'A python library to search keyword in linkedin people and scrape search results data from linkedin automatically.'
