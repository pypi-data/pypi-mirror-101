...
class struct_r_parse_ctype_t(Structure):
    pass
...
c__EA_RParseCTypeTypeKind = ctypes.c_uint32 # enum
...
c__EA_RParseCTypeTypeIdentifierKind = ctypes.c_uint32 # enum
...
class struct_r_parse_ctype_type_t(Structure):
    pass

class union_r_parse_ctype_type_t_0(Union):
    pass

class struct_r_parse_ctype_type_t_0_1(Structure):
    pass

struct_r_parse_ctype_type_t_0_1._pack_ = 1 # source:False
struct_r_parse_ctype_type_t_0_1._fields_ = [
    ('type', ctypes.POINTER(struct_r_parse_ctype_type_t)),
    ('is_const', ctypes.c_bool),
    ('PADDING_0', ctypes.c_ubyte * 7),
]

class struct_r_parse_ctype_type_t_0_2(Structure):
    pass

struct_r_parse_ctype_type_t_0_2._pack_ = 1 # source:False
struct_r_parse_ctype_type_t_0_2._fields_ = [
    ('type', ctypes.POINTER(struct_r_parse_ctype_type_t)),
    ('count', ctypes.c_uint64),
]

class struct_r_parse_ctype_type_t_0_0(Structure):
    pass

struct_r_parse_ctype_type_t_0_0._pack_ = 1 # source:False
struct_r_parse_ctype_type_t_0_0._fields_ = [
...
union_r_parse_ctype_type_t_0._pack_ = 1 # source:False
union_r_parse_ctype_type_t_0._fields_ = [
    ('identifier', struct_r_parse_ctype_type_t_0_0),
    ('pointer', struct_r_parse_ctype_type_t_0_1),
    ('array', struct_r_parse_ctype_type_t_0_2),
    ('PADDING_0', ctypes.c_ubyte * 8),
]

struct_r_parse_ctype_type_t._pack_ = 1 # source:False
struct_r_parse_ctype_type_t._fields_ = [
    ('kind', RParseCTypeTypeKind),
    ('PADDING_0', ctypes.c_ubyte * 4),
    ('r_parse_ctype_type_t_0', union_r_parse_ctype_type_t_0),
]

RParseCTypeType = struct_r_parse_ctype_type_t
r_parse_ctype_new = _libr_parse.r_parse_ctype_new
r_parse_ctype_new.restype = ctypes.POINTER(struct_r_parse_ctype_t)
r_parse_ctype_new.argtypes = []
r_parse_ctype_free = _libr_parse.r_parse_ctype_free
r_parse_ctype_free.restype = None
r_parse_ctype_free.argtypes = [ctypes.POINTER(struct_r_parse_ctype_t)]
r_parse_ctype_parse = _libr_parse.r_parse_ctype_parse
r_parse_ctype_parse.restype = ctypes.POINTER(struct_r_parse_ctype_type_t)
r_parse_ctype_parse.argtypes = [ctypes.POINTER(struct_r_parse_ctype_t), ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.POINTER(ctypes.c_char))]
r_parse_ctype_type_free = _libr_parse.r_parse_ctype_type_free
r_parse_ctype_type_free.restype = None
r_parse_ctype_type_free.argtypes = [ctypes.POINTER(struct_r_parse_ctype_type_t)]
...
__all__ = \
    ...
    'RParse', 'RParseCType', 'RParseCTypeType',
    ...
    'R_PARSE_CTYPE_TYPE_KIND_POINTER', 'c__EA_RAnalCPPABI',
    ...
    'c__EA_RNumCalcToken', 'c__EA_RParseCTypeTypeIdentifierKind',
    ...
    'r_parse_plugin_riscv_pseudo', 'r_parse_plugin_sh_pseudo',
    'r_parse_plugin_tms320_pseudo', 'r_parse_plugin_v850_pseudo',
    'r_parse_plugin_wasm_pseudo', 'r_parse_plugin_x86_pseudo',
    'r_parse_plugin_z80_pseudo', 'r_parse_set_user_ptr',
    'r_parse_subvar', 'r_parse_use', 'r_parse_version',
    ...
    'struct_sdb_kv', 'struct_sdb_t', 'union_r_parse_ctype_type_t_0']
