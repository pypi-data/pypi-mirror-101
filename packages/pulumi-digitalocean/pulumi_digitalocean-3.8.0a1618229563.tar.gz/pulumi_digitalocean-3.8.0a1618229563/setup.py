...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'digitalocean', '3.8.0-alpha.1618229563+8a2e90c6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource digitalocean 3.8.0-alpha.1618229563+8a2e90c6`
                """)
            else:
                raise
