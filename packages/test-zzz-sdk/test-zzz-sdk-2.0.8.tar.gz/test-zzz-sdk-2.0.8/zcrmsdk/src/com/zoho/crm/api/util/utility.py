...
class Utility(object):
    ...
    def set_handler_api_path(module_api_name, handler_instance):
        ...
        if module_api_name.lower() in api_path.lower():
            ...
            for i in range(len(api_path_split)):
                ...
                elif split_lower in Constants.DEFAULT_MODULENAME_VS_APINAME.get(
                        split_lower) and Constants.DEFAULT_MODULENAME_VS_APINAME.get(split_lower) is not None:
                    ...
                    for module in api_supported_modules:
                        if module.lower() not in record_field_details_json:
                            ...
                            field_details = Utility.get_fields_details(
                                api_supported_modules[module][Constants.API_NAME])
    ...
    def verify_module_api_name(module_api_name):
        if module_api_name is not None and Constants.DEFAULT_MODULENAME_VS_APINAME.get(
