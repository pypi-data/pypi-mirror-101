...
class PickListValue(object):
	...
	def get_display_value(self):
		...
		Returns:
			bool: A bool representing the display_value
		"""
	...
	def set_display_value(self, display_value):
		...
		Parameters:
			display_value (bool) : A bool representing the display_value
		"""

		if display_value is not None and not isinstance(display_value, bool):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: display_value EXPECTED TYPE: bool', None, None)
