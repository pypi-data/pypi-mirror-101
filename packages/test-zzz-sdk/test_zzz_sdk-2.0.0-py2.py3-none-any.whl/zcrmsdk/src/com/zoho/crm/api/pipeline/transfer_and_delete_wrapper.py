...
class TransferAndDeleteWrapper(object):
	...
	def get_pipeline(self):
		...
		Returns:
			TransferStructure: An instance of TransferStructure
		"""
	...
	def set_pipeline(self, pipeline):
		...
		Parameters:
			pipeline (TransferStructure) : An instance of TransferStructure
		"""

		try:
			from zcrmsdk.src.com.zoho.crm.api.pipeline.transfer_structure import TransferStructure
		except Exception:
			from .transfer_structure import TransferStructure

		if pipeline is not None and not isinstance(pipeline, TransferStructure):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: pipeline EXPECTED TYPE: TransferStructure', None, None)
