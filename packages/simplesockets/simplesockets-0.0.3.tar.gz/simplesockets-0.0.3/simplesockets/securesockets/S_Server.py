from _support_files import cipher
...
class Server_(TCPServer):
    ...
    def setup(self, filepath:str, ip=socket.gethostname(), port=25567, listen=5, recv_buffer=2048, handle_client=None,
              on_connect=None, on_disconnect=None, on_receive=None):
    ...
    def save_users(self, users, get:str=None): #json
        with open(self.filepath, 'r') as file:
    ...
    def check_user(self, username:str, pw:str, get:str=None): #pw not hashed already
        users = self.load_users(get)
    ...
    def send_data(self, target: bytes, type: bytes, data: bytes, username=None, key=None,
                  client_socket=None, encr_data=True) -> bool:
