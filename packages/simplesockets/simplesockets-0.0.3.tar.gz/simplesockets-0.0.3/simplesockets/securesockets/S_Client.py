...
class Client_(TCPClient):
    ...
    def setup(self, target_ip, target_port=25567, recv_buffer=2048, on_connect=None,
    ...
    def send_data(self, target: bytes, type: bytes, data: bytes, username=None, key=None) -> bool:
