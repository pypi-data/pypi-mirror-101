...
def RunRFTestSuite(project_dir, ts_name, ts_subfolders, browser_var, env_var, lang_var, tc_row_index_var):
    ...
    (paraemeters: browser_var, env_var, lang_var, tc_row_index_var)
    ...
    d = "_output.xml -l "
    e = "_log.html "
    f = "--variable browser:" + browser_var + " --variable environment_to_run_test:" + env_var + " --variable lang:" + lang_var + " --variable test_case_row_index:" + tc_row_index_var + " "
