...
sys.path.append('../')
# from client_.client_ui import Ui_MainClientWindow
from client_.add_contact import AddContactDialog
from client_.del_contact import DelContactDialog
...
# from client_.errors import ServerError
...
class ClientMainWindow(QMainWindow):
    def __init__(self, database, transport):
        ...
        self.ui = loadUi('client_/client.ui', self)
