...
class jd_airflow():
    ...
    def init_airflow3(self, conp):
        ...
        c.run(
            '/opt/python35/bin/python3 -m pip install  zlsrc lmfscrap lmf zltask zlgp zlapp zlgp3 zlzz zlgg3 py3Fdfs  -i http://lanmengfei:since2015@10.0.64.25/pypi/simple --trusted-host 10.0.64.25')
