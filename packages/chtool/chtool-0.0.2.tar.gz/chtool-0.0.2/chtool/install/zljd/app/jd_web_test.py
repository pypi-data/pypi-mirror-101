...
class jd_web_test:
    def __init__(self,local_file_download=False):
        self.pin=[
                    ['root@10.30.16.48:22','BST@webtest20200729','web1'],
                    ['root@10.30.16.49:22','BST@webtest20200729','web2'],
                    ['root@10.30.16.50:22','BST@webtest20200729','web3']
                    ]

        self.app5_1_pin=[
        ['root@10.30.16.51:22','BST@webtest20200729','app1_db1'],

        ['root@10.30.16.52:22','BST@webtest20200729','app5_db1master'],
        ['root@10.30.16.53:22','BST@webtest20200729','app5_db1seg1'],
        ['root@10.30.16.54:22','BST@webtest20200729','app5_db1seg2'],
        ['root@10.30.16.55:22','BST@webtest20200729','app5_db1seg3'],
        ['root@10.30.16.56:22','BST@webtest20200729','app5_db1seg4'],
        ]
        ...
        self.local_file_dir="D:\\jingdong_websystest_download"
    ...
    def init_host_cfg(self):
        ...
        ip=ip[ip.index('@')+1:ip.index(':')]
        self.redis_host=ip
        self.pg_master=self.app5_1_pin[0]
    ...
    def db_app1_prt3(self):
        ...
        try:
            ...
            c=Connection(conp[0],connect_kwargs={"password":conp[1]})
            cmd="export PGPASSWORD='since2015' &&  /opt/PostgreSQL/10/bin/pg_restore -d biaost -c -U postgres -v  %s"%self.pg_dmp_file_oss
            print(cmd)
            c.run(cmd,warn=True)
    ...
    def db_app5_prt3_tmp(self,pin):
        ...
        c=Connection(conp[0],connect_kwargs={"password":conp[1]})
        hba="""
        host  all  developer  10.0.64.58/8  md5
        host  all  app_reader 10.0.64.58/8 md5
        host  all  zl_reader  10.0.64.58/8  md5
...
class jd_web_test_exam(jd_web_test):
    def __init__(self,local_file_download=False):
        ...
        self.local_file_dir="D:\\jingdong_websystest_download1"
        self.refresh_para()
    ...
    def fdfs(self):
        ...
        pin=[]
        for w1,w2 in zip(self.app5_1_pin[1:],pin_ext):
            pin.append([*w1,w2])
        print(pin)
        m=fdfs(pin=pin)
