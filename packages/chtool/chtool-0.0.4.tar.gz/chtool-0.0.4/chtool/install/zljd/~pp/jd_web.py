...
class jd_web:
    def __init__(self):
        ...
        self.db_host="10.0.64.51"
        self.redis_host="10.0.64.49"
    ...
    def step_8(self):
        ...
        c.put(sdir,tdir)
        c.run("tar -xvf %s/fileroot.tar.gz -C /data/cloud-upload"%tdir,pty=True)
        ...
        c.put(sdir1,tdir)
        c.run("tar -xvf %s/images.tar.gz -C /data"%tdir,pty=True)
