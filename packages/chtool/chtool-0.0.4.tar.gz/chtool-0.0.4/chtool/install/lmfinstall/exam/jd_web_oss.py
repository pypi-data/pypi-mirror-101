...
class jd_web:
    ...
    def db_app1_prt3(self):
        ...
        try:
            ...
            c=Connection(conp[0],connect_kwargs={"password":conp[1]})
            cmd="export PGPASSWORD='since2015' &&  /opt/PostgreSQL/10/bin/pg_restore -d biaost -U postgres -v  %s"%self.pg_dmp_file_oss
            print(cmd)
            c.run(cmd,warn=True)
...
class jd_web_exam(jd_web):
    def __init__(self,local_file_download=False):
        ...
        self.pin= [
        ['root@10.0.64.47:22','BST@2020610','web1'],
        ['root@10.0.64.48:22','BST@2020610','web2'],
        ['root@10.0.64.49:22','BST@2020610','web3']
                    ]

        self.app5_1_pin=[
        ['root@10.0.64.51:22','BST@2020610','app1_db1'],

        ['root@10.0.64.52:22','BST@2020610','app5_db1master'],
        ['root@10.0.64.53:22','BST@2020610','app5_db1seg1'],
        ['root@10.0.64.54:22','BST@2020610','app5_db1seg2'],
        ['root@10.0.64.55:22','BST@2020610','app5_db1seg3'],
        ['root@10.0.64.56:22','BST@2020610','app5_db1seg4'],
        ]


        self.app5_2_pin=[
        ['root@10.0.64.57:22','BST@2020610','app1_db2'],

        ['root@10.0.64.58:22','BST@2020610','app5_db2master'],
        ['root@10.0.64.59:22','BST@2020610','app5_db2seg1'],
        ['root@10.0.64.60:22','BST@2020610','app5_db2seg2'],
        ['root@10.0.64.61:22','BST@2020610','app5_db2seg3'],
        ['root@10.0.64.11:22','BST@2020610','app5_db2seg4'],
        ]
        self.data_file_date=['20200629','20200629','20200629']
        self.web_file_date="20200629"
