...
def install_all(pin,python_file):
    arr=copy.deepcopy(pin)
...
def install_(c,**krg):
    ...
    # else:
        ...
        c.put(sdir,tdir)
    python_ver='python3%s'%re.findall('3.([0-9])',file_name)[0]
    c.run("yum install lrzsz libffi-devel  openssl-devel  zlib-devel  sqlite-devel gcc nfs-utils patch readline-devel python3-devel -y ")
