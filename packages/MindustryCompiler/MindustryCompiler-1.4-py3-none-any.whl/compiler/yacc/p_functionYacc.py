...
import compiler.yacc.grammar.functionArgsReturns
...
def p_returnedVars_one(p):
    '''returnedVars : ID'''
    compiler.yacc.grammar.functionArgsReturns.returnedVars_one(p)


def p_returnedVars_many(p):
    '''returnedVars : returnedVars Comma ID'''
    compiler.yacc.grammar.functionArgsReturns.returnedVars_many(p)


def p_args_empty(p):
    '''arguments : '''
    compiler.yacc.grammar.functionArgsReturns.args_empty(p)


def p_args_one(p):
    '''arguments : info'''
    compiler.yacc.grammar.functionArgsReturns.args_one(p)


def p_args_many(p):
    '''arguments : arguments Comma info'''
    compiler.yacc.grammar.functionArgsReturns.args_many(p)
