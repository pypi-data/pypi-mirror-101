...
@jsii.data_type(
    jsii_type="cdk-cloudfront-plus.SelectOriginByViwerCountryProps",
    jsii_struct_bases=[],
    name_mapping={"country_table": "countryTable"},
)
class SelectOriginByViwerCountryProps:
    def __init__(
        self,
        *,
        country_table: typing.Mapping[builtins.str, builtins.str],
    ...
    def __repr__(self) -> str:
        return "SelectOriginByViwerCountryProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class Custom(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(Custom, self, [scope, id, props])
...
class DefaultDirIndex(
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: builtins.str) -> None:
        ...
        :param id: -
        '''
        jsii.create(DefaultDirIndex, self, [scope, id])
...
class RedirectByGeolocation(
    ...
    def __init__(
        ...
        *,
        ...
        jsii.create(RedirectByGeolocation, self, [scope, id, props])


class RedirectCustomErrorPage(
    Custom,
    metaclass=jsii.JSIIMeta,
    jsii_type="cdk-cloudfront-plus.RedirectCustomErrorPage",
):
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: builtins.str) -> None:
        ...
        :param id: -
        '''
        jsii.create(RedirectCustomErrorPage, self, [scope, id])
...
class SelectOriginByViwerCountry(
    Custom,
    metaclass=jsii.JSIIMeta,
    jsii_type="cdk-cloudfront-plus.SelectOriginByViwerCountry",
):
    ...
    def __init__(
        ...
        *,
        ...
        :param country_table: The pre-defined country code table. Exampe: { 'US': 'amazon.com' }
        '''
        props = SelectOriginByViwerCountryProps(country_table=country_table)

        jsii.create(SelectOriginByViwerCountry, self, [scope, id, props])
...
class SimpleLambdaEdge(
    ...
    def __init__(self, scope: aws_cdk.core.Construct, id: builtins.str) -> None:
        ...
        :param id: -
        '''
        jsii.create(SimpleLambdaEdge, self, [scope, id])
...
__all__ = [
    ...
    "RedirectCustomErrorPage",
    "SecurtyHeaders",
    "SelectOriginByViwerCountry",
    "SelectOriginByViwerCountryProps",
    "ServerlessApp",
    "ServerlessAppProps",
    "SimpleLambdaEdge",
]
