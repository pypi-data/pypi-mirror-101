...
BLOXBERG_V1_CONTEXT = 'https://w3id.org/bloxberg/schema/research_object_certificate_v1'
BLOXBERG_V1_SCHEMA = 'https://w3id.org/bloxberg/schema/research_object_certificate_v1'
BLOXBERG_V1_CANONICAL_CONTEXT = 'https://w3id.org/bloxberg/schema/research_object_certificate_v1'
...
JSON_LD_CONTEXT_BLOXBERG = os.path.join(BASE_DIR, 'bloxberg/context.json')
CREDENTIAL_JSON_LD_CONTEXT_BLOXBERG = os.path.join(BASE_DIR, 'bloxberg/credential.json')
EXAMPLE_CREDENTIAL_JSON_LD_CONTEXT_BLOXBERG = os.path.join(BASE_DIR, 'bloxberg/exampleCredential.json')
MERKLE_PROOF_2019_JSON_LD_CONTEXT_BLOXBERG = os.path.join(BASE_DIR, 'bloxberg/merkleProof2019Context.json')
...
with open(JSON_LD_CONTEXT_BLOXBERG) as data_file:
    bc_context = json.load(data_file)
    PRELOADED_CONTEXTS[BLOXBERG_V1_CONTEXT] = bc_context
    #PRELOADED_CONTEXTS[BLOx] = bc_context
    PRELOADED_CONTEXTS[BLOCKCERTS_V3_ALPHA_CANONICAL_CONTEXT] = bc_context
