...
with open("__init__.py", "rt", encoding="utf8") as x:
    version = re.search(r'__version__ = "(.*?)"', x.read()).group(1)  # special hack

LOGS.info(f"py-Ultroid Version - {version}")
LOGS.info("Ultroid Version - 0.0.5")
