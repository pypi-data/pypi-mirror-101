...
def txt_entropy(txt, dim):
    ...
    return samp
#--- BRAIN VISION ----
def vhdr_lyapunv(vhdr,tmax,inter,electrode):
    div=tmax/inter
    sep_time=[]
...
def vhdr_hurst(vhdr,tmax,inter,electrodes):
    ...
    for electrode in electrodes:
        ...
        data.append(EEG)
    return data
def vhdr_corr_dim(vhdr,dim,tmax,inter,electrode):
    div=tmax/inter
    sep_time=[]
    for i in range(inter):
        sep_time.append([div*i,div*(i+1)])
    ...
    for electrode in electrodes:
        ...
        data.append(EEG)
    return data
def vhdr_entropy(vhdr,dim,tmax,inter,electrode):
    div=tmax/inter
    sep_time=[]
    for i in range(inter):
        sep_time.append([div*i,div*(i+1)])
    ...
    return data
# --- EDF ---
def edf_lyapunv(edf,tmax,inter,electrode):
    div=tmax/inter
    sep_time=[]
    for i in range(inter):
        sep_time.append([div*i,div*(i+1)])
...
def edf_hurst(edf,tmax,inter,electrodes):
    ...
    for electrode in electrodes:
        ...
        data.append(EEG)
    return data
def edf_corr_dim(edf,dim,tmax,inter,electrode):
    div=tmax/inter
    sep_time=[]
    for i in range(inter):
        sep_time.append([div*i,div*(i+1)])
    ...
    for electrode in electrodes:
        ...
        data.append(EEG)
    return data
def edf_entropy(edf,dim,tmax,inter,electrode):
    div=tmax/inter
    sep_time=[]
    for i in range(inter):
        sep_time.append([div*i,div*(i+1)])
    ...
    return data
# --- BDF ---
def bdf_lyapunv(bdf,tmax,inter,electrode):
    div=tmax/inter
    sep_time=[]
    for i in range(inter):
        sep_time.append([div*i,div*(i+1)])
...
def bdf_hurst(bdf,tmax,inter,electrodes):
    ...
    for electrode in electrodes:
        ...
        data.append(EEG)
    return data
def bdf_corr_dim(bdf,dim,tmax,inter,electrode):
    div=tmax/inter
    sep_time=[]
    for i in range(inter):
        sep_time.append([div*i,div*(i+1)])
    ...
    for electrode in electrodes:
        ...
        data.append(EEG)
    return data
def bdf_entropy(bdf,dim,tmax,inter,electrode):
    div=tmax/inter
    sep_time=[]
    for i in range(inter):
        sep_time.append([div*i,div*(i+1)])
