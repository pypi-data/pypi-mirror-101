Twitter-Auto-Post-Bot is a python library to post on twitter using browser automation. 
It currently runs only on windows.

### Example
In this example we first import library, then we login with cookies and then post on twitter.
```sh
from twitter_auto_post_bot import *
...
twitter.post(tweet='Hi everyonne!!! hope doing well')
```
...
```sh
pip install twitter-auto-post-bot
```
