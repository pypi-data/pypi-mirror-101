...
from pysyd import TODODIR, INFODIR
...
def main():
    ...
    parser.add_argument('-in', '--in', '-inpdir', '--inpdir', '-input', '--input',
                        dest='inpdir',
                        help='Path to input data',
                        default='%s/data/'%os.getcwd(),
    )
    ...
    parser.add_argument('-nt', '--nt', '-nthread', '--nthread', '-nthreads', '--nthreads',
                        dest='nthreads',
    ...
    parser.add_argument('-out', '--out', '-outdir', '--outdir', '-output', '--output',
                        ...
                        default='%s/results/'%os.getcwd(),
    )
    parser.add_argument('-par', '--par', '-parallel', '--parallel',
                        dest='parallel',
    ...
    parser.add_argument('-star', '--star', '-stars', '--stars',
                        dest='star',
