Linkedin-Auto-Follow-Company is a python library to follow a company on linkedin using browser automation. 
It currently runs only on windows.

### Example
In this example we first import library, then we login with cookies and then follow company.
```sh
from linkedin_auto_follow_company import *
...
```sh
pip install linkedin-auto-follow-company
```
...
### Follow Company
```sh
linkedin.follow_company(company_link='company_link')
```
